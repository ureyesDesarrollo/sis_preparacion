    ...
    <div class="demo">
      <div class="login">
        ...
        <div class="login__form">
          <div style="font-size: 13px; color: rgba(255, 255, 255, 0.8); font-weight: bold;">
            <p>Sistema de pelambre</p>
          </div>
          <form action="../seguridad/user_valida.php" method="post">
            <input type="hidden" name="url" value="../sis_preparacion/pelambre/index.php">
