...
WHERE ipe_etapa = '1' and ip_id = $int_valor ") or die(mysqli_error($cnx) . "Error: en consultar equipos");
...
WHERE ipe_etapa = '2' and ip_id = $int_valor  LIMIT 0,7") or die(mysqli_error($cnx) . "Error: en consultar equipos2");
...
WHERE ipe_etapa = '4'  and ip_id = $int_valor  order by ipe_ren") or die(mysqli_error($cnx) . "Error: en consultar equipos");
...
WHERE ipe_etapa = '5'  and ip_id = $int_valor  order by ipe_ren") or die(mysqli_error($cnx) . "Error: en consultar equipos");
...
<table style="border: 1px solid black;" class="table table-bordered">
    <thead>
        <tr>
            ...
            <td style="background-color: #E4E4E5; font-weight: bold;">Lote</td>
    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $reg_fase1['ipe_lote'] ?></td>
...
<table style="border: 1px solid black;" class="table table-bordered">
    <thead>
        <tr>
            ...
            <th style="background-color: #E4E4E5; font-weight: bold;">Lote</th>
...
<table style="border: 1px solid black;" class="table table-bordered">
    ...
    <tbody>
        <tr>
            ...
            <!--<td><?php //echo $inventario['ac_descripcion']; 
                    ?></td>-->
