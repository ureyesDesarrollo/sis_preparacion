...
<script>
	...
	/* si renglon 3 esta vacio mantener hora remojo bloqueada */
	/* if (hora_remojo === '' && (fe_ini3 === '' && fe_fin3 === '')) {
	...
	function procesarCampos(lote, fe_ini, fe_fin, obs, lote_siguiente, fe_ini_siguiente, fe_fin_siguiente, obs_siguiente) {
		// Bloquear campos del renglón siguiente si los del renglón actual están vacíos
		/* if (fe_ini === "" || fe_fin === "" || obs === "") { */
		if (lote === "" || fe_ini === "" || fe_fin === "") {
			lote_siguiente.prop('readonly', true);
	...
	// Ejecutamos la función para los campos del tercer renglón
	procesarCampos(
		//renglon actual
		$("#txt_lote3").val(),
		$("#txt_fe_inicio3").val(),
