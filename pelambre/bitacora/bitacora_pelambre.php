            ...
            columns: [{
                ...
                },
                {
                    render: function(data, type, row, meta) {
                        ...
                        return '<a style="margin-left:1.5rem" href="../formatos/pelambrado_consulta.php?inv_id=' + row.inv_id + '" target="_blank"><span class="glyphicon glyphicon-print"></span> </a>';
    ...
    <div class="row">
        <div class="col-sm-4 col-md-7 ">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#" style="font-size: 14px;color: #000">Bitacora Pelambre</a></li>
                </ol>
            </nav>
        </div>
