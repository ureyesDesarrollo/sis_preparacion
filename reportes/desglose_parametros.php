...
$cadena = mysqli_query(Conectarse(), "SELECT * FROM procesos_liberacion WHERE pro_id = '$proceso' ") or die(mysql_error()."Error: en consultar el procesos");
$registros = mysqli_fetch_assoc($cadena);

$cadenaD = mysqli_query(Conectarse(), "SELECT * FROM procesos_liberacion_b WHERE pro_id = '$proceso' ") or die(mysql_error()."Error: en consultar el procesos");
