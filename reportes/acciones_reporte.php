...
<div class="container">
	...
	<div class="col-md-5 col-sm-12">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Listado de Acciones</li>
	...
	<div class="col-sm-1 col-md-1">
		<a class="iconos" href="formatos/listado_acciones.php" target="_blank"><img src="../iconos/printer.png" alt="">
		Imprimir</a>
	</div>
	<div class="col-sm-1 col-md-1">
		<a class="iconos"  href="exportar/acciones.php" target="_blank"><img src="../iconos/excel.png" alt="">
		Exp.excel</a>
...
<?php include "acciones_listado.php";?>
