...
WHERE pm.pro_id ='$pro_id' order by pma_fe_entrada asc") or die(mysqli_error($cnx) . "Error: en consultar el tipo de material");
            ...
            <table class="table table-bordered"  style="font-size: 12px;">
                ...
                <tbody>
                    ...
                    do {
                        ...
                        $sql_prov = mysqli_query($cnx, "SELECT p.prv_nombre,i.inv_folio_interno, i.inv_folio_interno2,p.prv_tipo 
