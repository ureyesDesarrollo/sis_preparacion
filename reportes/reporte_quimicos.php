...
<div class="container">
	...
	<div class="col-md-5 col-sm-12">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Reporte químicos</li>
			</ol>
		</nav>
	</div>
	<div class="diviconos">
	...
	<div class="col-sm-1 col-md-1">
		<a class="iconos" href="formatos/listado_quimicos.php" target="_blank"><img src="../iconos/printer.png" alt="">
		Imprimir</a>
	</div>
	<!-- <div class="col-sm-1 col-md-1">
		<a class="iconos"  href="exportar/quimicos.php" target="_blank"><img src="../iconos/excel.png" alt="">
		Exp.excel</a>

	</div> -->

</div>
<?php include "listado_quimicos.php";?>
