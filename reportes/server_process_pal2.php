			...
			else if ( $aColumnas[$i] != ' ' )
			{
				...
				{	
					if($aRow[ $aColumnas[3] ] != '')
					{
						...
						$sQuerys3 = "SELECT m.mat_nombre FROM procesos_materiales as pm inner join procesos_paletos_d as ppd on(pm.pro_id = ppd.pro_id) inner join materiales as m on(m.mat_id=pm.mat_id) where ppd.prop_id = ".$aRow[ $aColumnas[0] ];
				...
				{
					if($aRow[ $aColumnas[6] ] == 1){ $row[] = "Si";}else{$row[] = "No";} 
				}
				else if($i == 7)
				{
