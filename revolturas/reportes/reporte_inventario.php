            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    data.forEach((tarima, index) => {
                        ...
                        $tbody.append(`
                    <tr">
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >${index + 1}</td>
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >P${pro_id}T${tarima.tar_folio}</td>
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >${tarima.tar_fecha}</td>
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >${tarima.tar_bloom ?? ''}</td>
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >${tarima.tar_viscosidad ?? ''}</td>
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >${tarima.tar_ph ?? ''}</td>
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >${tarima.tar_humedad ?? ''}</td>
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >${tarima.tar_cenizas ?? ''}</td>
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >${tarima.tar_trans ?? ''}</td>
                        <td style="background-color: ${color[tarima.tar_fino] || ''};" >${tarima.tar_color ?? ''}</td>
