...
$rendimiento = $kgProceso ? ($totalKgTarimas / $kgProceso) : 0;
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Calcular Rendimiento Proceso: <?= htmlspecialchars($pro_id) ?> / Tarima: <?= htmlspecialchars($tar_folio) ?></h5>
            ...
            <form id="form_tarima_rendi" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12" id="table_procesos">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <label for="" class="form-label">Total KG Proceso</label>
