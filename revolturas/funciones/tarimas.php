    ...
    $(document).ready(function() {
        ...
        $('#dataTableTarimas').DataTable({
            ...
            rowCallback: function(row, data, index) {
                if (data.tar_fino === 'T') {
                    $('td', row).css('background-color', '#a9e4c5');
                }
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (row.tar_rechazado === 'R') {
                            ...
                            return `<a href="#"><i class="btn-enviar fa-solid fa-warehouse" data-tar="${row.tar_id}" data-fino="${row.tar_fino}"></i></a>`;
                        }
        ...
        $('#dataTableTarimas').on('click', '.btn-enviar', function() {
            let tar_id = $(this).data('tar');
            let tar_fino = $(this).data('fino');
            enviar_almacen(tar_fino, tar_id);
        });
...
<div class="container-fluid">
    <div class="row mb-3 mt-3">
        ...
        <div>
            ...
            <div style="width: 20px; height: 20px; background-color: #a9e4c5; vertical-align: middle; display:inline-block; border: 1px solid #000;"></div>
            <span style="display: inline-block; margin-left: 10px; vertical-align: middle;"> Tamiz Nova</span>
        </div>
...
<script>
    ...
    function enviar_almacen(tar_fino, id) {
        let dataForm = {
            "tar_id": id,
            "tar_fino": tar_fino
        };
        ...
        if (dataForm.tar_fino === 'T') {
            mensaje = 'La tarima esta marcada como tamiz nova, se enviara a nova.';
        }
