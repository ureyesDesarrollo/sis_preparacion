    ...
    <style>
        ...
        @media print {
            ...
            .label-container {
                ...
                /* No rotamos en la impresi��n */
                font-size: 12pt;
                /* Tama�0�9o de fuente ajustable */
                border: none;
            ...
            @page {
                size: 16.5cm 10cm landscape;
                /* Solo definimos el tama�0�9o, sin orientaci��n */
                margin: 0;
                /* Sin m��rgenes */
            }
        }
    ...
    <div class="label-container">
        <?php for ($i = 0; $i < 2; $i++) { ?>
            <div class="label-group">
                ...
                <h4>Fecha creacion: <?= $datos_tarimas['tar_fecha']; ?></h4>
                <?php
