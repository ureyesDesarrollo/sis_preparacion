                ...
                if ($tarimaEnAlmacen) {
                    echo '<div class="d-flex justify-content-center align-items-center" style="height: 100vh; background-color: #f8f9fa;">
                            <div class="text-center p-4" style="background-color: #ffffff; border: 1px solid #dee2e6; border-radius: 8px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); max-width: 500px;">
								<h3 class="mb-3" style="color: #343a40;">La tarima ' . $tarima . ' con proceso ' . $proceso . ' esta en almacén.</h3>
                                 <a href="tarimas_detalle.php?tar_id=' . htmlspecialchars($tar_id) . '" target="_blank"
								class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Ver detalle de tarima">Ver detalle</a>
                            </div>
                        </div>';
                    exit;
                } else {
