...
/*cargar combos*/
  $(document).ready(function(){
	...
	//alert("entra");
	  $("#cbxEstado option:selected").each(function () {
		est_id = $(this).val();
...
<div class="container-fluid">
	...
	<div class="col-sm-1 col-md-1">
		<a class="iconos" href="formatos/listado_proveedores.php" target="_blank"><img src="../iconos/printer.png" alt="">
		Imprimir</a>
	</div>
	<div class="col-sm-1 col-md-1">
		<a class="iconos"  href="exportar/proveedores.php" target="_blank"><img src="../iconos/excel.png" alt="">
		Exp.excel</a>
		<!--<button type="submit" id="export_data" name="export_data" value="Export to excel" class="btn btn-info">Exportar a Excel</button>-->
	</div>
	<?php if(fnc_permiso($_SESSION['privilegio'], 7, 'upe_agregar' ) == 1){?>
	<div class="col-sm-1 col-md-1">
