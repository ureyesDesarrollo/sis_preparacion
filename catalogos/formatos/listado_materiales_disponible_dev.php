...
$cadena = mysqli_query($cnx, "SELECT inv_id, mat_nombre, inv_kg_totales, prv_nombre, p.prv_ncorto, inv_fecha  ,inv_no_ticket
	FROM inventario as i
	INNER JOIN materiales as m ON (i.mat_id = m.mat_id)
	INNER JOIN proveedores as p ON (i.prv_id = p.prv_id)
	WHERE inv_tomado = 0 AND inv_enviado = 0 and inv_kg_totales > 0
	...
	<div class="container">
		<center>
			<form id="formMatDisp2">
				<div class="tablecuerpo" style="margin-bottom: 60px">
					...
					<table class="table table-bordered" style="width: 100%;margin-top:2rem">
						<thead>
							<tr>
								<th colspan="8" style="text-align: center;">
									...
									<h4 style="display: inline;">Materiales diponible para devolver</h4>
								</th>
							</tr>
							<tr>
								...
								<th style="width:5%;text-align:right">Kilos</th>
						...
						<tbody>
							...
							$flt_kg  = 0;
							do {
								if (isset($registros['inv_no_ticket'])) {
							?>
									<tr>
										...
										<td style="text-align:right"><?php echo $registros['inv_kg_totales'] ?></td>
							...
							<tr style="border-bottom :2px solid#fff;">
								<td style="text-align: right;font-weight: bold;font-size: 18px;border-left: 2px solid#fff;border-bottom: 1px solid#fff" colspan="3">Existencia Total:</td>
								<td style="text-align: right;font-weight: bold;font-size: 18px;border-left :2px solid#fff;"><?php echo number_format($flt_kg, 2); ?>&nbsp;</td>
								<td align="right" colspan="2" style="border-left :2px solid#fff;">
								...
								<td colspan="2" style="text-align: right;border-left :2px solid#fff;border-right :2px solid#fff;"> <button class="btn btn-primary" type="submit"><img src="../../iconos/guardar.png" alt=""> Guardar</button></td>
							</tr>
						</tbody>
						<tfoot>
						</tfoot>
				...
				<?php
				$cadena = mysqli_query($cnx, "SELECT inv_id, mat_nombre, inv_kg_totales, prv_nombre,p.prv_ncorto, inv_fecha ,inv_no_ticket, inv_observaciones 
					FROM inventario as i
					INNER JOIN materiales as m ON (i.mat_id = m.mat_id)
					INNER JOIN proveedores as p ON (i.prv_id = p.prv_id)
					WHERE inv_tomado = 0 AND inv_enviado = 4 and inv_kg_totales > 0 and inv_fecha > '2023-01-01'
					ORDER BY m.mat_nombre ") or die(mysqli_error($cnx) . "Error: en consultar el material");
				$registros = mysqli_fetch_assoc($cadena);
				?>
				<div class="tablecuerpo" style="margin-bottom: 60px">
						...
						<thead>
							<tr>
								<th colspan="7" style="text-align: center;">
									<img src="../../imagenes/logo_progel_v3.png" style="width: 80px">
									<h4 style="display: inline;">Listado de materiales devueltos</h4>
								</th>
							</tr>
							<tr>
								<th>No. ticket</th>
