	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oPreviousSearch = {
				...
				var oPreviousSearch = document.createElement('style')
		oPreviousSearch .innerHTML = "input {border-radius:5px;height:35px}";
         document.body.appendChild(oPreviousSearch);
