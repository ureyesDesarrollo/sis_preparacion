...
WHERE inv_id = '$inv_id'") or die(mysqli_error($cnx) . "Error: en consultar pelambre");
    ...
    $inventario = mysqli_query($cnx, "SELECT i.inv_no_ticket, i.inv_kilos ,fnc_nombre_material (i.inv_id) as material,a.ac_descripcion FROM 
inventario as i
INNER JOIN almacen_cajones AS a on(i.ac_id = a.ac_id)
WHERE inv_id ='" . $reg_pelambre['inv_id'] . "'");
