...
<body>
    <div class="container-fluid">
        ...
        <?php if ($_SESSION['privilegio'] == 1 || $_SESSION['privilegio'] == 2 || $_SESSION['privilegio'] == 4) { ?>
            <div class="row mt-3 mb-3 justify-content-end">
                <div class="col-md-6 p-3 text-end">
                    <button id="btnCrearHojaViajera" class="btn btn-primary">Crear Hoja Viajera</button>
                </div>
            </div>
        <?php } ?>
    ...
    <div class="modal" id="modalCrearHojaViajera" tabindex="-1" role="dialog" aria-labelledby="modalCrearHojaViajeraLabel" aria-hidden="false"></div>

</body>
<script src="../assets/bootstrap/js/bootstrap.bundle.min.js"></script>
<script>
    $(document).ready(function() {
        $('#btnCrearHojaViajera').on('click', function() {
            abre_modal_hoja_viajera();
        });
    });

    function abre_modal_hoja_viajera() {
        $.ajax({
            type: 'POST',
            url: 'modal_hoja_viajera.php',
            success: function(result) {
                $("#modalCrearHojaViajera").html(result);
                $('#modalCrearHojaViajera').modal('show')
            }
        });
        return false;
    }
