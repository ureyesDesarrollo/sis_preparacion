...
$cad_materiales = mysqli_query($cnx, "select m.* 
								...
								where p.pep_id = ".$_POST['pep_id']." ") or die(mysql_error()."Error: en consultar los materiales");
...
<div class="modal-dialog modal-full-height modal-right modal-notify modal-primary modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
		...
		<h4>Materiales: <?php do { echo $reg_materiales['mat_nombre']." ";}while($reg_materiales = mysqli_fetch_assoc($cad_materiales));?></h4>
      </div>
    <!--Body-->
        ...
        <div class="table-responsive">
          <table class="table table-striped">
			...
			?>
			  ...
			  if($reg_parametros['valor'] < $reg_etapas['pep_inicio'] or $reg_parametros['valor'] > $reg_etapas['pep_fin'] )
			  {
