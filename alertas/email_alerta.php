...
$mail->SMTPAuth   = true;                                   //Enable SMTP authentication
$mail->Username   = "sistemapreparacion@progel.com.mx";                     //SMTP username
...
$asunto  = "Alerta - Sistema preparacion Progel #" . $clave;
...
$mensaje .= "<tr><th align='left'>Proceso:</th><td>" . $proceso . "&nbsp;&nbsp;</td><th align='left'>Etapa:</th><td>" . $reg_etapas['pep_nombre'] . "(" . $reg_etapas['pep_descripcion'] . ")&nbsp;&nbsp;</td></tr>";
