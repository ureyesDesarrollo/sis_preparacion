...
if (!isset($idx_pro)) {
	...
	if (isset($_GET['idx_pro'])) {
		...
		//Obtiene el proceso asignado desde equipos tipo almacen
		...
		WHERE e.ep_id = '" . $_GET['id_e'] . "' AND p.pro_estatus = 1 and e.pe_ban_activo = 1");
...
<body>
	...
	<div class="container">
		...
		<?php
		/* if (isset($_GET['idx_pro'])) {
			include "encabezado_consulta.php";
		} else { */
