      ...
      <form id="form_quimicos">
        ...
        <div class="modal-body" id="cargar_quimicos">
          ...
          if ($tot != 0) {
            ...
            do { ?>
              <div class="row">
                ...
                <div class="col-md-3">
                  <input readonly type="text" placeholder="Lote" class="form-control" maxlength="20" id="txt_lote_quim<?php echo $i ?>" name="txt_lote_quim<?php echo $i ?>" value="<?php echo $reg_quim['quim_lote'] ?>">
                </div>

                <div class="col-md-2">
                  <input readonly type="text" placeholder="Litro" class="form-control" onKeyPress="return isNumberKey(event, this);" maxlength="5" id="txt_litro_quim<?php echo $i ?>" name="txt_litro_quim<?php echo $i ?>" value="<?php echo $reg_quim['quim_litros'] ?>">
                </div>
              </div>
            <?php
          ...
          for ($i = 1; $i <= $res; $i++) { ?>
            <div class="row">
              ...
              <div class="col-md-3">
                <input type="text" placeholder="Lote" class="form-control" maxlength="20" id="txt_lote_quim<?php echo $i ?>" name="txt_lote_quim<?php echo $i ?>" value="<?php echo $reg_quim['quim_lote'] ?>">
              </div>

              <div class="col-md-2">
                <input type="text" placeholder="Litro" class="form-control" onKeyPress="return isNumberKey(event, this);" maxlength="5" id="txt_litro_quim<?php echo $i ?>" name="txt_litro_quim<?php echo $i ?>" value="<?php echo $reg_quim['quim_litros'] ?>">
              </div>
            </div>
          <?php }  ?>
        </div>
        <div class="modal-footer">
          ...
          <div class="form-group col-md-5">
            ...
            <?php
            if ($reg_aux['pro_id'] != '') { ?>
              <button type="submit" class="btn btn-primary"><img src="../iconos/guardar.png" alt=""> Guardar</button>
            <?php } else {
              echo "N/A Guardar";
            } ?>
