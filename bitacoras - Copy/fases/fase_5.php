...
<div class="divProcesos">
	<form autocomplete="off" id="formFase5" name="formFase5">
				...
				?>
						<tr>
							...
							<td align="center"><?php echo $i; ?><input type="hidden" class="form-control" id="<?php echo "txtRen" . $i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen" . $i ?>">
								<input type="hidden" class="form-control" id="<?php echo "hddRen" . $i ?>" name="<?php echo "hddRen" . $i ?>" value="<?php echo $reg_fad['pfd5_id']; ?>" />
							</td>
							...
							<td><input type="time" class="form-control" id="<?php echo "txtHraFinMov" . $i ?>" name="<?php echo "txtHraFinMov" . $i ?>" value="<?php if ($reg_fad['pfd5_hr_fin_mov'] == '') {
																																									...
																																									$str_prop = 'disabled';
																																										...
																																										echo " " . $strProp3;
																																										echo " " . $strProp4; ?>></td>
							<td><input type="text" maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php echo "txtPh" . $i ?>" name="<?php echo "txtPh" . $i ?>" value="<?php if ($reg_fad['pfd5_ph'] == '') {
																																																						echo "";
																																																						$str_prop = '';
																																																					} else {
							...
							<td align="center"><input <?php if ($fltVal >= $reg_fad['pfd5_ce'] and $reg_fad['pfd5_ce'] != '') { ?>style="background-color:#66FF66;" <?php } ?> type="text" class="form-control" maxlength="6" onKeyPress="return isNumberKey(event, this);" id="<?php echo "txtCe" . $i ?>" name="<?php echo "txtCe" . $i ?>" value="<?php if ($reg_fad['pfd5_ce'] == '') {
																																																																																							echo "";
																																																																																							$str_prop = '';
																																																																																						} else {
							...
							<td><input type="text" maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php echo "txtTemp" . $i ?>" name="<?php echo "txtTemp" . $i ?>" value="<?php if ($reg_fad['pfd5_temp'] == '') {
																																																							echo "";
																																																							$str_prop = '';
																																																						} else {
							...
							<td><input type="text" class="form-control" id="<?php echo "txtObs" . $i ?>" name="<?php echo "txtObs" . $i ?>" value="<?php if ($reg_fad['pfd5_observaciones'] == '') {
																																						echo "";
																																						$str_prop = '';
																																					} else {
