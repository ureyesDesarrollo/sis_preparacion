...
<script language="javascript">
	...
	function requerido_hrs_8b() {
		...
		if (fechaTerminacion.value !== '') {
			...
			document.getElementById('txtHrTerm_8b').setAttribute('required', 'required');
			...
			document.getElementById('txtHrTerm_8b').removeAttribute('required');
			document.getElementById('txtHrasTotales').removeAttribute('required');
		}
	}
</script>
<div class="divProcesos">
	<form autocomplete="off" id="formFase8b" name="formFase8b">
		...
		<div class="col-md-8">
			<div class="col-md-4">
				...
				<input onchange="requerido_hrs_8b()" type="date" class="form-control" id="txtFeTerm" placeholder="" name="txtFeTerm" value="<?php if ($reg_aux['proa_fe_fin'] == '') {
																																				echo "";
																																				$str_prop = '';
																																			} else {
			...
			<div class="col-md-2">
				...
				<input type="time" class="form-control" id="txtHrTerm_8b" placeholder="" name="txtHrTerm" value="<?php if ($reg_aux['proa_hr_fin'] == '') {
																														echo "";
																														$str_prop = '';
																													} else {
			...
			<div class="col-md-2">
				...
				<input type="text" id="txtHrTotales1" class="form-control" placeholder="Horas totales" name="txtHrTotales1" value="<?php if ($reg_fa['pfg8_hr_totales'] == '') {
																																		echo "";
																																		$str_prop = '';
			...
			<div class="col-md-11" style="border: 1px solid#e6e6e6;border-radius: 5px;background: #e6e6e6;margin-left: 20px;margin-top: 10px;margin-bottom: 10px">
				<div class="col-md-3 tiempos" style="margin-left: -25px;">
					...
					<input <?php echo $requerido ?> onKeyPress="return isNumberKey(event, this);" type="text" id="txtHrasTotales" type="text" id="txtHrasTotales" class="form-control" placeholder="" name="txtHrasTotales" value="<?php if ($reg_pro_con['hrs_totales_capturadas'] == '') {
		...
		<div class="col-md-4 divEtapas7_mod">
			...
			<div class="col-md-12 divEtapasInput7_mod">
				...
				for ($i = 1; $i <= 5; $i++) { ?>
					...
					<input maxlength="6" onKeyPress="return isNumberKey(event, this);" type="tex" class="form-control col-md-1" style="width: 100px" id="<?php echo "txtPhLib" . $i ?>" name="<?php echo "txtPhLib" . $i ?>" placeholder="(<?php echo "L" . $i ?>) Cocido ph" value="<?php if ($reg_lib['prol_cocido_ph1'] == '') {
																																																																							echo "";
																																																																							$str_prop = '';
																																																																						} else {
		...
		<div class="row footerdivProcesos" style="margin-bottom: 10px;">
			...
			<div class="form-group col-md-4">
				<div class="alert alert-info hide" id="alerta-errorFase8bOpe" style="height: 40px;text-align: left;z-index: 10;font-size: 10px;margin-bottom: -10px">
