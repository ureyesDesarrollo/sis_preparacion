...
$tbHtml7c.= '
    ...
    <tr>
      <td><table width="84%" border="1" style="background: #FCEFF2;font-size: 12px;width: 93%">
        <tr>
    ...
    <tr>
      <td><table width="93%" border="1">
        ...
        <tr>
          ...
          <td>'.fnc_formato_val($regfg['pfg7_temp2']) .'</td>
          <td>'.fnc_formato_val($regfg['pfg7_norm']) .'</td>
          </tr>
      </table></td>
    </tr>
...
$tbHtml7c.= '
            <tr>
              ...
              <td style="background:#FF0000">'.$regfd['pfd7_ph'].'</td>
              <td>'.$regfd['pfd7_ce'].'</td>
              <td>'.$regfd['pfd7_norm'].'</td>
...
$tbHtml7c.= '
      ...
      <tr>
        <td><table border="1" width="1108">
          <tr style="font-weight: bold;">
            ...
            <td width="203" rowspan="2" style="background: #e6e6e6">('.fnc_hora_de(19).' a '.fnc_hora_a(19).' horas)</td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="825" border="1" style="margin-top: 10px">
          ...
          <tr>
            ...
            <td>'.$regfd2['pfd7_ph'].'</td>
            <td>'.$regfd2['pfd7_temp'].'</td>
            <td>'.$regfd2['pfd7_norm'].'</td>
      ...
      <tr>
        <td><table width="820" border="1">
          ...
          <tr>
            <td width="134">'.fnc_formato_val($regfg['pfg7_cocido_ph']).'</td>
            <td width="134">'.fnc_formato_val($regfg['pfg7_cocido_ce']).'</td>
            <td width="141">'.fnc_formato_val($regfg['pfg7_agua_ph']).'</td>
            <td width="122">'.fnc_formato_val($regfg['pfg7_agua_ce']).'</td>
            <td width="113">'.fnc_formato_val($regfg['pfg7_hr_ini_co']).'</td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><table border="1" width="824">
          <tr style="font-weight: bold;">
            ...
            <td width="159" rowspan="2" style="background: #e6e6e6">('.fnc_hora_de(19).' a '.fnc_hora_a(19).' horas)</td>
            <td width="159" rowspan="5">&nbsp;</td>
            <td width="159" rowspan="5" ><table width="270" border="1">
              <tr>
                <td width="44" rowspan="5" style="font-size:50px">7c</td>
                <td colspan="2" style="background: #e6e6e6;font-weight: bold;">LIBERACION CE A '.fnc_rango_de(19).'  a '.fnc_rango_a(19) .' hora) MAX</td>
              </tr>
              <tr>
                <td width="115">Cocido ph (1.7-2.1)</td>
                <td width="75">'.$regProLib['prol_ph'] .'</td>
              </tr>
              <tr>
                <td>Horas totales</td>
          ...
          <tr>
            ...
            <tr>
              <td colspan="5">Para pasar de lavados de 1er ácido a 2do ácido el tiempo debe ser de (3 a 5 horas). El agua de este procesos se manda a depositos de agua acida</td>
            </tr>
        </table></td>
      </tr>
    </table>
