      ...
      <td>
        <table border="1" width="100%">
          <tr style="font-weight: bold;">
            ...
            <td style="font-weight: bold;background: #e6e6e6">Extractivilidad</td>
            ...
            <td colspan="4" style="background: #e6e6e6;font-weight: bold;">Liberación CE a 4.0 MAX</td>
          </tr>
          <tr>
            ...
            <td><?php echo $regf1g['pfg1_extractivilidad'] ?></td>
