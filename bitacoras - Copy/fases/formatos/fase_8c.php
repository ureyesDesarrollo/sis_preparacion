...
$sqlProAux = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '26'") or die(mysqli_error($cnx) . "Error: en consultar procesos auxiliar");
$regProAux = mysqli_fetch_assoc($sqlProAux);


$sqlProLib = mysqli_query($cnx, "SELECT * FROM procesos_liberacion_b WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '26'") or die(mysqli_error($cnx) . "Error: en consultar procesos de liberacion");
      ...
      <td colspan="2">
        <table width="100%" border="1" style="margin-top: 10px">
          <tr style="font-weight: bold;background: #e6e6e6">
            ...
            <td rowspan="2">Para hacer los lavados finales deben tardar de (<span style="background: #e6e6e6"><?php echo fnc_hora_de(26) ?> a <?php echo fnc_hora_a(26) ?></span> horas)</td>
    ...
    <tr>
      <td width="63%" valign="top">
        <table border="1" width="699">
          <tr style="font-weight: bold;">
            ...
            <td width="143" rowspan="2" style="background: #e6e6e6">(<?php echo fnc_hora_de(26) ?> a <?php echo fnc_hora_a(26) ?> horas)</td>
          </tr>
          <tr>
      ...
      <td width="37%" rowspan="3" valign="top">
        <table width="384" border="1">
          <tr>
            <td width="36" rowspan="14" style="font-size:50px">8c</td>
            <td colspan="4" style="background: #e6e6e6;font-weight: bold;">LIBERACION PH LIBERACIÓN (PH <?php echo fnc_rango_de(26) ?> a <?php echo fnc_rango_a(26) ?>)</td>
          </tr>
          <tr>
      ...
      <td valign="top">
        <table border="1" width="701">
          <tr style="font-weight: bold;">
            ...
            <td width="124" rowspan="2" style="background: #e6e6e6">(<?php echo fnc_hora_de(26) ?> a <?php echo fnc_hora_a(26) ?> horas)</td>
          </tr>
          <tr>
            <td><?php echo $regfg['pfg8_hr_totales'] ?></td>
            <td><?php echo fnc_nom_usu($usu_aux) ?></td>
        ...
        <table border="1" width="700">
          <tr style="font-weight: bold;">
            ...
            <td width="226" rowspan="2" style="background: #e6e6e6">(<?php echo fnc_hora_de(26) ?> a <?php echo fnc_hora_a(26) ?> horas)</td>
          </tr>
          <tr>
    ...
    <tr <?php echo $oculta_opciones ?>>
      ...
      <td style="padding-left:290px">
        <?php if ($_SESSION['privilegio'] == 4) {
          $cad = mysqli_query($cnx, "SELECT pl_id FROM procesos WHERE pro_id = '$idx_pro' ") or die(mysqli_error($cnx) . "Error: en consultar");
