		...
		<div class="row" style="margin-top: 2rem;">
			...
			<div class="form-row">
				<div class="form-group col-md-2">
					...
					<input maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" type="text" id="txtHrTotales1" class="form-control" placeholder="Horas totales" name="txtHrTotales1" value="<?php if ($reg_fa['pfg7_hr_totales'] == '') {
																																																			echo "";
																																																			$str_prop = '';
																																																		} else {
