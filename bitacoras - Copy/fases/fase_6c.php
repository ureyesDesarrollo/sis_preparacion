...
<script>
	...
	$(document).ready(function() {
		$("#formFase6c").submit(function() {
			...
			$.ajax({
				url: "fases/fase_6c_insertar.php",
				type: 'POST',
				data: formData,
...
<div class="divProcesos">
	<form autocomplete="off" id="formFase6c" name="formFase6c">
		...
		<table border="0" cellspacing="5" cellpadding="5">
			...
			?>
					<tr>
						...
						<td><input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php echo "txtTemp" . $i ?>" name="<?php echo "txtTemp" . $i ?>" value="<?php if ($reg_fad['pfd6_temp'] == '') {
																																																		echo "";
																																																		$str_prop = '';
																																																	} else {
						...
						<td><input type="time" class="form-control" id="<?php echo "txtHraFinMov" . $i ?>" name="<?php echo "txtHraFinMov" . $i ?>" value="<?php if ($reg_fad['pfd6_hr_fin_mov'] == '') {
																																								...
																																								echo " " . $strProp3;
																																								echo " " . $strProp4; ?>></td>
						<td><input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php echo "txtCe" . $i ?>" name="<?php echo "txtCe" . $i ?>" value="<?php if ($reg_fad['pfd6_ce'] == '') {
																																																	echo "";
																																																	$str_prop = '';
																																																} else {
						...
						<td>
							<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 180px" name="cbxAgua<?php echo $i  ?>" <?php if ($reg_fad['taa_id'] == '') {
																																				echo "";
																																				$str_prop = '';
																																			} else {
																																				$str_prop = 'disabled';
