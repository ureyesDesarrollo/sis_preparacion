...
<div class="divProcesos">
	<form autocomplete="off" id="formFase5d" name="formFase5d">
		...
		<div class="row" style="margin-bottom: 20px">
			...
			<div class="col-md-1 tiempos">
				<input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="txtTermina" name="txtTermina"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" placeholder="Termina" value="<?php if ($reg_fa['pfg5_termina'] == '') {
																																																																					echo "";
																																																																					$str_prop = '';
																																																																				} else {
