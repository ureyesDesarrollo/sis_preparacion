...
<script>
	...
	$(document).ready(function() {
		$("#formFase4E").submit(function() {
			...
			$.ajax({
				url: "fases/editar/fase_4_actualizar.php",
				type: 'POST',
				data: formData,
			...
			<form autocomplete="off" id="formFase4E" name="formFase4E">
				...
				<div class="row" style="margin-bottom: 10px">
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtEnzima" name="txtEnzima" placeholder="ENZIMA" value="<?php if ($reg_fa['pfg4_enzima'] == '') {
																																															echo "";
																																															$str_prop = 'disabled';
																																														} else {
					...
					<table border="0" cellspacing="0" cellpadding="0">
						...
						?>
							<tr>
								...
								<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPhBF" . $i ?>" name="<?php echo "txtPhBF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd4_ph_b'] == '') {
																																																									echo "";
																																																									$str_prop = 'disabled';
																																																								} else {
				...
				<div class="col-md-12">
					<div class="form-row">
						<div class="form-group col-md-2">
							...
							<input maxlength="6" type="text" class="form-control" id="txtCocido" placeholder="Cocido" name="txtCocido" value="<?php if ($reg_fa['pfg4_cocido_ph'] == '') {
																																					echo "";
																																					$str_prop = 'disabled';
																																				} else {
					...
					<div class="form-row">
						<div class="form-group col-md-2">
							...
							<input maxlength="6" onKeyPress="return isNumberKey(event, this);" type="text" class="form-control" id="txtCeG" placeholder="Ce" name="txtCeG" value="<?php if ($reg_fa['pfg4_ce'] == '') {
																																														echo "";
																																														$str_prop = 'disabled';
																																													} else {
																																														echo $reg_fa['pfg4_ce'];
