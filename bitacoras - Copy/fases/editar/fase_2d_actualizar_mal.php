...
for ($i = 1; $i <= 12; $i++) {
	...
	if ($txtHoraD != '' and $txtPhD != '' and $txtSosaD != '' and $txt_tempd != '') //  
	{
		mysqli_query($cnx, "UPDATE procesos_fase_2b_d SET pfd2_hr = '$txtHoraD', pfd2_ph = '$txtPhD', pfd2_sosa = '$txtSosaD', pfd2_temp = '$txt_tempd' WHERE pfg2_id = '$hdd_pfg' AND pfd2_ren = '$txtRen' ") or die(mysqli_error($cnx) . " Error al actualizar el renglon " . $i);
	}
}
