...
<script>
	$(document).ready(function() {
		$("#formFase2ee").submit(function() {
			var formData = $(this).serialize();
			$.ajax({
				url: "fases/editar/fase_2e_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {

					data = JSON.parse(result);
					alertas("#alerta-errorFase2eeOpe", 'Listo!', data["mensaje"], 1, true, 5000);
					$('#formFase2ee').each(function() {
						this.reset();
					});
...
<div class="modal-dialog modal-lg" role="document" style="width: 80%">
	<div class="modal-content">
		<div class="divProcesos1">
			<form autocomplete="off" id="formFase2ee" name="formFase2ee">
				...
				<div class="row footerdivProcesos" style="margin-bottom: 10px">
					...
					<div class="form-group col-md-3">
						<div class="alert alert-info hide" id="alerta-errorFase2eeOpe" style="height: 40px;width: 300px;text-align: left;z-index: 10;font-size: 10px;">
