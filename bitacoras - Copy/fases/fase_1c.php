...
<script>
	...
	$(document).ready(function() {
		$("#formFase1c").submit(function() {
			var formData = $(this).serialize();
			$.ajax({
				url: "fases/fase_1c_insertar.php",
				type: 'POST',
				data: formData,
				success: function(result) {

					data = JSON.parse(result);
					alertas("#alerta-errorFase1cOpe", 'Listo!', data["mensaje"], 1, true, 5000);
					$('#formFase1c').each(function() {
						this.reset();
					});
	...
	function AbreModalE1c(proceso, etapa) {
		var datos = {
			"pro_id": proceso,
			"pe_id": etapa
		}
		$.ajax({
			type: 'post',
			url: 'fases/editar/fase_1c.php',
			data: datos,
			success: function(result) {
				$("#modalEditar1c").html(result);
				$('#modalEditar1c').modal('show')
			}
		});
		return false;
	}
...
<div class="divProcesos">
	<form autocomplete="off" id="formFase1c" name="formFase1c">
		...
		<div class="row" style="margin-bottom: 10px">
			<label class="col-md-1" style="width: 200px;">Fecha que inician lavados</label>
			...
			<label class="col-md-1" style="width: 200px">Hora que inician lavados</label>
			<div class="col-md-2 tiempos">
		...
		<div class="row" style="margin-bottom: 10px">
			...
			<label class="col-md-1" style="width: 140px">Litros peroxido</label>
			<div class="col-md-2 tiempos">
				<input type="text" maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="txt_peroxido" name="txt_peroxido" placeholder="Litros peróxido" value="<?php if ($reg_fa1['pfg1_peroxido'] == '') {
																																																		echo "";
																																																		$str_prop = '';
																																																	} else {
		...
		<div class="row">
			...
			<div class="form-group col-md-2">
				<label for="inputPassword4">Hora termina lavados</label>
			...
			<div class="form-group col-md-2">
				...
				<input onKeyPress="return isNumberKey(event, this);" type="text" class="form-control" id="txt_redox" placeholder="Redox" name="txt_redox" value="<?php if ($reg_fa1['pfg1_redox'] == '') {
																																										echo "";
																																										$str_prop = '';
																																									} else {
			...
			<div class="form-group col-md-2">
				<label for="horas">(<?php echo fnc_hora_de(31) ?> a <?php echo fnc_hora_a(31) ?> horas totales)</label>
			</div>
		...
		<div class="row" <?php echo $oculta_opciones ?> style="margin-right: 0px">
			<div class="col-md-8">
				<div class="alert alert-info hide" id="alerta-errorFase1cOpe" style="height: 40px;width: 270px;text-align: left;z-index: 10;font-size: 10px;margin-bottom: -10px">
			...
			<div class="col-md-4" style="margin-top:1rem;margin-bottom:1rem;text-align:right">
				...
				<?php if ($_SESSION['privilegio'] == 4) {	?>
					...
					<button type="button" class="btn btn-success" id="editar" onClick="javascript:AbreModalE1c(<?php echo $reg_pro['pro_id'] ?>, 1);"> <img src="../iconos/edit.png" alt="">Editar
					</button>
	...
	<div class="modal" id="modalEditar1c" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"></div>
