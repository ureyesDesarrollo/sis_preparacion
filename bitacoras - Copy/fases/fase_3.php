...
<script>
	...
	function agregarCampoFase3() {
		...
		document.getElementById('camposFase3').appendChild(div);
		document.getElementById('camposFase3').appendChild(div);
	}
...
<div class="divProcesos">
	<form autocomplete="off" id="formFase3" name="formFase3">
		...
		<div class="row" style="margin-bottom: 10px">
			...
			<div class="col-md-2" style="height: 30px; border-radius: 5px; border:1px solid #e6e6e6; margin-bottom: 3px; font-weight:bold; background-color:#CCCCCC;width: 230px">
				<label>BUSCAR CE A 4.0 MAXIMO</label>
			</div>
		</div>
		<!---->
				...
				?>
						<tr>
							...
							<td><input type="hidden" class="form-control" id="<?php echo "txtRen" . $i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen" . $i ?>">
								...
								<!--<input type="text" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php /*echo "txtLavTipAgua".$i ?>" name="<?php echo "txtLavTipAgua".$i ?>"  value="<?php if($reg_fad1['pfd3_tipo_ag'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_tipo_ag']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4*/; ?> size="5">-->
							...
							<td><input type="text" maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php echo "txtTemp" . $i ?>" name="<?php echo "txtTemp" . $i ?>" value="<?php if ($reg_fad1['pfd3_temp'] == '') {
																																																							echo "";
																																																							$str_prop = '';
																																																						} else {
																																																							echo $reg_fad1['pfd3_temp'];
																																																							$str_prop = 'disabled';
																																																						} ?>" <?php echo $str_prop;
																																																								echo " " . $strProp2;
																																																								echo " " . $strProp3;
																																																								echo " " . $strProp4; ?> size="5" placeholder="Temp"></td>
							<td><input type="time" class="form-control" id="<?php echo "txtHraIni" . $i ?>" name="<?php echo "txtHraIni" . $i ?>" value="<?php if ($reg_fad1['pfd3_hr_ini'] == '') {
																																								echo "";
																																								$str_prop = '';
																																							} else {
																																								echo $reg_fad1['pfd3_hr_ini'];
																																								$str_prop = 'disabled';
																																							} ?>" <?php echo $str_prop;
																																									echo " " . $strProp2;
																																									echo " " . $strProp3;
																																									echo " " . $strProp4; ?>></td>
							<td><input type="time" class="form-control" id="<?php echo "txtHraFin" . $i ?>" name="<?php echo "txtHraFin" . $i ?>" value="<?php if ($reg_fad1['pfd3_hr_fin'] == '') {
																																								echo "";
																																								$str_prop = '';
																																							} else {
																																								echo $reg_fad1['pfd3_hr_fin'];
																																								$str_prop = 'disabled';
																																							} ?>" <?php echo $str_prop;
																																									echo " " . $strProp2;
																																									echo " " . $strProp3;
																																									echo " " . $strProp4; ?>></td>
							<td><input type="time" class="form-control" id="<?php echo "txtHraIniMov" . $i ?>" name="<?php echo "txtHraIniMov" . $i ?>" value="<?php if ($reg_fad1['pfd3_hr_ini_mov'] == '') {
																																									echo "";
																																									$str_prop = '';
																																								} else {
																																									echo $reg_fad1['pfd3_hr_ini_mov'];
																																									$str_prop = 'disabled';
																																								} ?>" <?php echo $str_prop;
																																										echo " " . $strProp2;
																																										echo " " . $strProp3;
																																										echo " " . $strProp4; ?>></td>
							<td><input type="time" class="form-control" id="<?php echo "txtHraFinMov" . $i ?>" name="<?php echo "txtHraFinMov" . $i ?>" value="<?php if ($reg_fad1['pfd3_hr_fin_mov'] == '') {
																																									echo "";
																																									$str_prop = '';
																																								} else {
																																									echo $reg_fad1['pfd3_hr_fin_mov'];
																																									$str_prop = 'disabled';
																																								} ?>" <?php echo $str_prop;
																																										echo " " . $strProp2;
																																										echo " " . $strProp3;
																																										echo " " . $strProp4; ?>></td>
							<td><input type="text" maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php echo "txtPh" . $i ?>" name="<?php echo "txtPh" . $i ?>" value="<?php if ($reg_fad1['pfd3_ph'] == '') {
																																																						echo "";
																																																						$str_prop = '';
																																																					} else {
																																																						echo $reg_fad1['pfd3_ph'];
																																																						$str_prop = 'disabled';
																																																					} ?>" <?php echo $str_prop;
																																																							echo " " . $strProp2;
																																																							echo " " . $strProp3;
																																																							echo " " . $strProp4; ?> size="5" placeholder="Ph"></td>
							<td><input type="text" maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php echo "txtCe" . $i ?>" name="<?php echo "txtCe" . $i ?>" value="<?php if ($reg_fad1['pfd3_ce'] == '') {
																																																						echo "";
																																																						$str_prop = '';
																																																					} else {
																																																						echo $reg_fad1['pfd3_ce'];
																																																						$str_prop = 'disabled';
																																																					} ?>" <?php echo $str_prop;
																																																							echo " " . $strProp2;
																																																							echo " " . $strProp3;
																																																							echo " " . $strProp4; ?> size="5" <?php if ($fltVal >= $reg_fad1['pfd3_ce'] and $reg_fad1['pfd3_ce'] != '') { ?>style="background-color:#66FF66;" <?php } ?> placeholder="Ce"></td>
							<td><input type="text" maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php echo "txtPpm" . $i ?>" name="<?php echo "txtPpm" . $i ?>" value="<?php if ($reg_fad1['pfd3_ppm'] == '') {
																																																						echo "";
																																																						$str_prop = '';
																																																					} else {
																																																						echo $reg_fad1['pfd3_ppm'];
																																																						$str_prop = 'disabled';
																																																					} ?>" <?php echo $str_prop;
																																																							echo " " . $strProp2;
																																																							echo " " . $strProp3;
							...
							<td><input type="text" maxlength="100" class="form-control" id="<?php echo "txtObs" . $i ?>" name="<?php echo "txtObs" . $i ?>" value="<?php if ($reg_fad1['pfd3_observaciones'] == '') {
																																										echo "";
																																										$str_prop = '';
																																									} else {
																																										echo $reg_fad1['pfd3_observaciones'];
																																										$str_prop = 'disabled';
																																									} ?>" <?php echo $str_prop;
																																											echo " " . $strProp2;
																																											echo " " . $strProp3;
																																											echo " " . $strProp4; ?> size="5" placeholder="Observación"></td>
						</tr>
				<?php
						$valUltRen = $i;
					} //termina if
		...
		<div class="row">
			...
			<div class="col-md-3 divEtapas3">
				...
				<div class="col-md-2 divEtapasInput">
					...
					<input onKeyPress="return isNumberKey(event, this);" type="text" maxlength="6" id="txtHrTotales" class="form-control" placeholder="Horas totales" name="txtHrTotales" value="<?php if ($reg_lib['prol_hr_totales'] == '') {
																																																		echo "";
																																																		$str_prop = '';
																																																	} else {
