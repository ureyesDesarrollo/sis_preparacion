...
// Elimina espacios al final y luego la última coma
  ...
  <div class="modal-content">
    <form id="formModalP" name="formModalP">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="color:#4AB5B9; font-size:18px; font-weight:bold;">Agregar Equipo "Libre - Ocupado"</h5>
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <?php
            $cad_pro =  mysqli_query($cnx, "SELECT pro_total_kg from procesos where pro_id = '" . $_POST['pro_id'] . "' ");
            $reg_pro =  mysqli_fetch_array($cad_pro);

            $cad_eq =  mysqli_query($cnx, "SELECT ep_id, ep_descripcion,ep_carga_max from equipos_preparacion where ep_id = '" . $_POST['equipo'] . "' ");
          ...
          <!-- <div class="col-md-4">
            ...
            <input id="txt_capacidad_anterior" class="form-control" name="txt_capacidad_anterior" value="<?php echo $reg_eq['ep_carga_max'] ?>" readonly>
          </div> -->
          <div class="col-md-4">
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <select id="cbxEquipo" class="form-control" name="cbxEquipo" onchange="obtener_capacidad();" required>
              ...
              $cadena =  mysqli_query($cnx, "SELECT * from equipos_preparacion where le_id IN (9,11) and estatus = 'A' and ep_tipo <> 'R' and ep_tipo <> 'X' and ep_id <> '" . $_POST['equipo'] . "' order by ep_descripcion asc ");
        ...
        <div class="modal-footer" style="margin-top: 8%;">
          <!--mensajes-->
          <div class="alert alert-info hide" id="alerta-errorAgregarR" style="height: 40px;text-align: left;position: fixed;float: left;z-index: 10">
...
<script>
      ...
      $.ajax({
        ...
        error: function(jqXHR, textStatus, errorThrown) {
          ...
          if (textStatus === "timeout") {
            ...
            // Manejar error 404 (recurso no encontrado)
            alertas("#alerta-errorAgregarR", 'Error!', 'El recurso solicitado no se encontró en el servidor.', 4, true, '600000');
          } else if (jqXHR.status === 500) {
            // Manejar error 500 (error interno del servidor)
            alertas("#alerta-errorAgregarR", 'Error!', 'interno del servidor. Por favor, inténtalo más tarde.', 4, true, '600000');
          } else {
            // Manejar otros errores
            alertas("#alerta-errorAgregarR", 'Error!', 'Inesperado. Por favor, contacta al soporte técnico.', 4, true, '600000');
          }
        }
  ...
  /*   function bloque_boton() {
      ...
      setTimeout(function() {
        formModalP.btn_enviar_equipo.disabled = true;
        formModalP.btn_enviar_equipo.value = "Guardar";
      }, 2000);
  ...
  // Obtén el botón por su ID o cualquier otro selector
