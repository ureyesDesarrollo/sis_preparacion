...
<script>
	...
	$(document).ready(function() {
		$("#formFase6d").submit(function() {
			...
			$.ajax({
				url: "fases/fase_6d_insertar.php",
				type: 'POST',
				data: formData,
...
<div class="divProcesos">
	<form autocomplete="off" id="formFase6d" name="formFase6d">
			...
			?>
					<tr>
						...
						<td><input type="hidden" class="form-control" id="<?php echo "txtRen" . $i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen" . $i ?>">
							...
							<select id="cbxTipAg<?php echo $i  ?>" class="form-control" style="width: 170px" name="cbxTipAg<?php echo $i  ?>" <?php if ($reg_fad['tpa_id'] == '') {
																																					echo "";
																																					$str_prop = '';
																																				} else {
																																					$str_prop = 'disabled';
						...
						<td align="center">
							<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 170px" name="cbxAgua<?php echo $i  ?>" <?php if ($reg_fad['taa_id'] == '') {
																																				echo "";
																																				$str_prop = '';
																																			} else {
																																				$str_prop = 'disabled';
		...
		<div class="row">
			...
			<div class="form-row">
				...
				<div class="col-md-2">
					...
					<input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if ($reg_fa['pfg6_horas_reales'] == '') {
																																															echo "";
																																															$str_prop = '';
																																														} else {
		...
		<div class="row footerdivProcesos" style="margin-bottom: 10px;">
			...
			<!--<div class="col-md-2">
				...
				<input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="inputPassword4" placeholder="">
			</div>-->
