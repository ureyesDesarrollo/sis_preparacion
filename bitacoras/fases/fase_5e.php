...
<script>
	...
	$(document).ready(function() {
		$("#formFase5e").submit(function() {
			...
			$.ajax({
				url: "fases/fase_5e_insertar.php",
				type: 'POST',
				data: formData,
...
<div class="divProcesos">
	<form autocomplete="off" id="formFase5e" name="formFase5e">
		...
		<div class="row" style="margin-bottom: 20px">
			...
			<div class="col-md-2">
				<!--<input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="txtAcidoF" name="txtAcidoF" placeholder="ACIDO" value="<?php  //if($reg_fa['pfg4_acido_fuerte'] == ''){echo ""; $str_prop = '';}else{echo $reg_fa['pfg4_acido_fuerte']; $str_prop = 'disabled';} 
					...
					<table border="0" cellspacing="0" cellpadding="0">
						...
						?>
							<tr>
								...
								<!--<td><input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="<?php /*echo "txtPhBF".$i ?>" name="<?php echo "txtPhBF".$i ?>" size="5" value="<?php if($reg_fad['pfd5_ph'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd5_ph']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4;*/ ?>></td>-->
		...
		<div class="row">
			...
			<div class="form-row">
				<div class="form-group col-md-2">
					...
					<input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="txtCeG" placeholder="Ce" name="txtCeG" value="<?php if ($reg_fa['pfg5_ce'] == '') {
																																										echo "";
																																										$str_prop = '';
																																									} else {
																																										echo $reg_fa['pfg5_ce'];
			...
			<div class="form-row">
				<div class="form-group col-md-3">
					...
					<label for="inputPassword4">(<?php echo fnc_hora_de(13) ?> HORAS MOV. CONT.)</label>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if ($reg_fa['pfg5_hr_reales'] == '') {
																																														echo "";
																																														$str_prop = '';
																																													} else {
