...
if ($txtFeIni != ''  and $txtHrIni != '' and $txt_temp != '' and $txt_ph != '' and $txtEnzima != '') {
	...
	mysqli_query($cnx, "INSERT INTO procesos_fase_2b_g(pro_id, pe_id, pfg2_temp_ag, pfg2_enzima,pfg2_ph1, usu_id) VALUES('$hdd_pro_id', '$hdd_pe_id', '$txt_temp', '$txtEnzima','$txt_ph', '" . $_SESSION['idUsu'] . "' ) ") or die(mysqli_error($cnx) . " Error al insertar 2");
