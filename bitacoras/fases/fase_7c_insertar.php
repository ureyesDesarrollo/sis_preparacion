 ...
 */
    ...
    if ($strMsj != '') {
        ...
        if ($txtFeTerm != '') {
            ...
            if ($txtHrTotales != ''  and $txtExtr2doAcido != '' and $reg_usu['up_id'] == '6') {
                mysqli_query($cnx, "INSERT INTO procesos_liberacion (usu_id, pro_id, pe_id, prol_hr_totales, prol_ph,prol_extrac2doacido) VALUES('" . $_SESSION['idUsu'] . "', '$hdd_pro_id', '$hdd_pe_id', '$txtHrTotales', '0', '$txtExtr2doAcido') ") or die(mysqli_error($cnx) . " Error al insertar L");
