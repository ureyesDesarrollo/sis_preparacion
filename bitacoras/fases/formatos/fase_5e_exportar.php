...
$sqlfg = mysqli_query($cnx, "SELECT * FROM procesos_fase_5b_g as pfg INNER JOIN procesos as p  on(pfg.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro' AND pfg.pe_id = 25") or die(mysql_error()."Error: en consultar procesos_fase_5b_g ");
...
$tbHtml5e.= '
    ...
    <tr>
      <td><table border="1" style="background: #FCEFF2;font-size: 12px;width: 100%">
        <tr>
          <td height="45" colspan="8"><div>PRIMER ÁCIDO. Este proceso se puede hacer con agua de depositos de agua acida (Recuperada de 2do ácido)</div>
            <div></div></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td><table width="100%" border="1">
        ...
        <tr>
          ...
          <td>'. fnc_formato_val($regfg['pfg5_temp2']).'</td>
        </tr>
      </table></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><table width="661" border="1" style="margin-top: 10px">
...
$tbHtml5e.= '
        <tr>
          ...
          <td>'. fnc_formato_val($regfd['pfd5_acido']).'</td>
 ...
 $tbHtml5e.= '     </table></td>
      ...
      <tr>
        <td><label for="inputPassword3">Mantener PH</label>'.fnc_rango_de(25).' - '.fnc_rango_a(25) .'</td>
      </tr>
      <tr>
        <td><table border="1" width="666">
          <tr style="font-weight: bold;">
            ...
            <td width="126" rowspan="7">&nbsp;</td>
            <td width="126" rowspan="7"><p>';
              ...
              <table width="366" border="1">
                <tr>
                  ...
                  <td colspan="2" style="background: #e6e6e6;font-weight: bold;"><p><br />
                    Nota: La adición de ácido se agrega por los dos lados del lavador y mantener el PH'.fnc_rango_de(25).' - '.fnc_rango_a(25).' durante todo el proceso de 1er ácido</p></td>
                </tr>
                <tr>
          ...
          <tr>
            <td>'. $regfg['pfg5_ph_agua'].'</td>
            <td>'. $regfg['pfg5_ce_agua'].'</td>
          ...
          <tr style="font-weight: bold;">
            ...
            <td width="126" rowspan="2" style="background: #e6e6e6">('. fnc_hora_de(25).' a '. fnc_hora_a(25).' horas)</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="4"> Para pasar de 1er ácido a los lavados de 1er ácido del tiempo debe ser de (1 A 3 HRS). El agua de este proceso se manda a agua semilimpia (PILA 2)</td>
          </tr>
        </table></td>
      </tr>
    </table>
