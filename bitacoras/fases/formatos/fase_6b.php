...
$sqlfg = mysqli_query($cnx, "SELECT * FROM procesos_fase_6b_g as pfg INNER JOIN procesos as p  on(pfg.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro' AND pfg.pe_id = 15") or die(mysqli_error($cnx) . "Error: en consultar procesos_fase_6b_g ");
...
$sqlProAux = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '15'") or die(mysqli_error($cnx) . "Error: en consultar procesos auxiliar");
$regProAux = mysqli_fetch_assoc($sqlProAux);


$sqlProLib = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '15'") or die(mysqli_error($cnx) . "Error: en consultar procesos de liberacion");
    ...
    <tr>
      <td colspan="2">
        <table border="1" style="background: #FCEFF2;font-size: 12px;width: 100%">
          <tr>
            <td height="45" colspan="10">LAVADOS 1er ACIDO</td>
          </tr>
        </table>
      </td>
    </tr>
      ...
      <td colspan="2">
        <table width="100%" border="1">
          <tr>
            ...
            <td width="20%" style="font-weight: bold;background: #e6e6e6">Temp agua inicial</td>
