...
$sqlProAux = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '21'") or die(mysqli_error($cnx) . "Error: en consultar procesos auxiliar");
$regProAux = mysqli_fetch_assoc($sqlProAux);


$sqlProLib = mysqli_query($cnx, "SELECT * FROM procesos_liberacion_b WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '21'") or die(mysqli_error($cnx) . "Error: en consultar procesos de liberacion");
...
<div class="divProcesos">
  <table width="100%" style="margin:20px 0px 20px 0px">
    <tr>
      <td colspan="2">
        <table class="tablaMov" width="97%" border="1" style="background: #FCEFF2;font-size: 12px;">
          <tr>
    ...
    <tr>
      <td colspan="2">
        <table class="tablaMov" width="97%" border="1">
          <tr>
    ...
    <tr>
      ...
      <td width="37%" rowspan="3" valign="top">
        <table class="liberacion" width="384" border="1">
          <tr>
