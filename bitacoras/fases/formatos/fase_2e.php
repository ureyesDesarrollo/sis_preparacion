...
$sqlf2g = mysqli_query($cnx, "SELECT * FROM procesos_fase_2_g as pf2g INNER JOIN procesos as p  on(pf2g.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro' AND pf2g.pe_id = '28'") or die(mysqli_error($cnx) . "Error: en consultar procesos_fase_2c_g ");
$regf2g = mysqli_fetch_assoc($sqlf2g);

$sqlProAux2 = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regf2g[pro_id]' AND pe_id = '28'") or die(mysqli_error($cnx) . "Error: en consultar procesos auxiliar");
$regProAux2 = mysqli_fetch_assoc($sqlProAux2);


$sqlProLib2 = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regf2g[pro_id]'  AND pe_id = '28'") or die(mysqli_error($cnx) . "Error: en consultar procesos de liberacion");
      ...
      <td>
        <table border="1" width="100%">
          ...
          <tr style="font-weight: bold;">
            ...
            <td rowspan="5" width="30" style="font-size:50px">2e</td>
