        ...
        <table border="1">
          <tr>
            ...
            <td colspan="2" style="background: #e6e6e6;font-weight: bold;">
              <p><br />
                Nota: La adición de ácido se agrega por los dos lados del lavador y mantener el PH <?php echo fnc_rango_de(12) ?> - <?php echo fnc_rango_a(12) ?> durante todo el proceso de 1er ácido</p>
            </td>
          </tr>
          <tr>
