...
extract($_POST);
$sqlf2bg = mysqli_query($cnx, "SELECT * FROM procesos_fase_2b_g as pf2bg INNER JOIN procesos as p  on(pf2bg.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro' AND pe_id = '30'") or die(mysqli_error($cnx) . "Error: en consultar procesos_fase_2b_g ");
$regf2bg = mysqli_fetch_assoc($sqlf2bg);

$sqlProAux2b = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regf2bg[pro_id]'  AND pe_id = '30'") or die(mysqli_error($cnx) . "Error: en consultar procesos auxiliar");
$regProAux2b = mysqli_fetch_assoc($sqlProAux2b);


$sqlProLib2b = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regf2bg[pro_id]'  AND pe_id = '30'") or die(mysqli_error($cnx) . "Error: en consultar procesos de liberacion");
          ...
          <tr>
            <td>
              <table border="1" style="width: 400px;">
                <tr>
                  <td rowspan="4" style="font-size:50px;border-bottom:1px solid#000"> 2d</td>
          ...
          <tr>
            <td>
              <table border="1" style="width: 400px;">
                ...
                ?>
                <tr>
                  <td colspan="2" style="font-weight: bold;background: #e6e6e6;text-align:center">(<?php echo fnc_hora_de(30) ?> a <?php echo fnc_hora_a(30) ?> Horas)</td>
                </tr>
                <tr>
