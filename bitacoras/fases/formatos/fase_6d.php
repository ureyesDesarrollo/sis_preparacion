...
$sqlfg = mysqli_query($cnx, "SELECT * FROM procesos_fase_6b_g as pfg INNER JOIN procesos as p  on(pfg.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro' AND pfg.pe_id = 25") or die(mysqli_error($cnx) . "Error: en consultar procesos_fase_6b_g ");
...
$sqlProAux = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '25'") or die(mysqli_error($cnx) . "Error: en consultar procesos auxiliar");
$regProAux = mysqli_fetch_assoc($sqlProAux);


$sqlProLib = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '25'") or die(mysqli_error($cnx) . "Error: en consultar procesos de liberacion");
    ...
    <tr>
      <td width="70%" valign="top">
        <table border="1" style="margin-top: 10px;width:98%">
          ...
          <?php
          $sqlfd = mysqli_query($cnx, "SELECT * FROM procesos_fase_6b_d as pfd inner join tipos_agua as ta on(pfd.tpa_id= ta.tpa_id) WHERE pfg6_id = '$regfg[pfg6_id]'") or die(mysqli_error($cnx) . "Error: en consultar procesos_fase_6b_d");
      ...
      <td width="39%" rowspan="3" valign="top">
        <p>
          <?php
        ...
        <table border="1">
          <tr>
            ...
            <td colspan="2" style="background: #e6e6e6;font-weight: bold;">LIBERACION CE A <?php echo fnc_rango_de(25) ?> a <?php echo fnc_rango_a(25) ?> hora) MAX</td>
          </tr>
          <tr>
      ...
      <td valign="top">
        <table border="1" width="98%" >
          <tr style="font-weight: bold;">
            ...
            <td width="190" rowspan="2" style="background: #e6e6e6">(<?php echo fnc_hora_de(25) ?> a <?php echo fnc_hora_a(25) ?> horas)</td>
          ...
          <tr>
            ...
            <td><?php echo $regfg['pfg6_horas_reales'] ?></td>
          ...
          <tr>
            <td colspan="10">Para pasar de lavados de 1er ácido a 2do ácido el tiempo debe ser de (1 A 3). En agua de este proceso se manda a agua recuperada semilimpia (PILA 2)</td>
          </tr>
        </table>
      </td>
    </tr>
