 ...
 <table width="100%" style="margin:20px 0px 20px 0px;background:#F5F4F4" >
      <tr>
        <td><table border="1" style="background: #FCEFF2;font-size: 12px;width: 100%">
          <tr>
            <td height="45" colspan="10">BLANQUEO. Este proceso se puede hacer con aguar recuperada limpia (pila 1)</td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><table border="1">
          <tr style="font-weight: bold;background: #e6e6e6">
            ...
            <td style="font-size: small; text-align: center;">Peroxido</td>
           ...
           $sqlf2d = mysqli_query($cnx, "SELECT * FROM procesos_fase_2_d WHERE pfg2_id = '$regf2g[pfg2_id]'") or die(mysql_error()."Error: en consultar el tipo de material 2");
...
do{
  ...
  $tbHtml2.= '<tr style="font-weight: bold;">
          ...
          <td  style="border:1px solid#fff;background: #e6e6e6">'.fnc_hora_de(10).' a '.fnc_hora_a(10).' horas</td>
          <td rowspan="7" style="border-bottom:1px solid#fff;border-top:1px solid#fff"></td>
          <td rowspan="7" style="font-size:50px">2</td>
        ...
        <tr>
          ...
          <td colspan="2">'.$regProLib2['prol_ce'] .'</td>
        </tr>
        <tr>
          <td colspan="3"></td>
          <td style="border:1px solid#fff"></td>
         ...
         <tr>
          ...
          <td style="border:1px solid#fff"></td>
          <td>Peroxido </td>
          <td colspan="2">'.$regProLib2['prol_peroxido'] .'</td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="3">'.$regProAux2['proa_observaciones'].'</td>
          <td style="border:1px solid#fff"></td>
        </tr>
      </table></td>
    </tr>
