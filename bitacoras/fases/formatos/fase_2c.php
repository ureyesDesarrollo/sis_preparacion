...
$sqlf2g = mysqli_query($cnx, "SELECT * FROM procesos_fase_2_g as pf2g INNER JOIN procesos as p  on(pf2g.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro' AND pe_id = '4'") or die(mysqli_error($cnx) . "Error: en consultar procesos_fase_2c_g ");
$regf2g = mysqli_fetch_assoc($sqlf2g);

$sqlProAux2 = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regf2g[pro_id]' AND pe_id = '4'") or die(mysqli_error($cnx) . "Error: en consultar procesos auxiliar");
$regProAux2 = mysqli_fetch_assoc($sqlProAux2);


$sqlProLib2 = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regf2g[pro_id]'  AND pe_id = '4'") or die(mysqli_error($cnx) . "Error: en consultar procesos de liberacion");
      ...
      <td>
        <table width="100%" border="1">
          ...
          do {
            ...
            if ($regf2d['pfd2_ren'] == '1') {
              $etiqueta = "MIN 2000 PPM";
            } else if ($regf2d['pfd2_ren'] == '4') {
              $etiqueta = "MIN 700 PPM";
            } else if ($regf2d['pfd2_ren'] == '6') {
          ...
          ?>
            <tr>
              ...
              <td><?php echo $regf2d['pfd2_sosa'] ?></td>
              <td><?php echo $regf2d['pfd2_temp'] ?></td>
              <td style="background: #FF6493"><?php echo fnc_formato_vacio($regf2d['pfd2_redox']) ?></td>
              <td style="font-weight: bold;"><?php echo $etiqueta ?></td>
