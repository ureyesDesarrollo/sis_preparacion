...
$tbHtml5b.= '
            <tr>
              ...
              <td>'.$regfd['pfd5_observaciones'].'</td>
...
$tbHtml5b.= '        </table>
      ...
      <tr>
        <td><table border="1" width="1234">
          <tr style="font-weight: bold;">
            <td width="296" style="background: #e6e6e6">Fecha termina</td>
            <td width="174" style="background: #e6e6e6">Hora termina </td>
            <td width="181" style="background: #e6e6e6">Usuario</td>
            <td width="120" rowspan="2" style="background: #e6e6e6">('. fnc_hora_de(11).' a '. fnc_hora_a(11).' horas)</td>
            <td width="132" rowspan="4">&nbsp;</td>
            <td width="99" rowspan="4"><p>&nbsp;</p>
              ';
      ...
      $tbHtml5b.= '
                <table width="280" border="1">
                  <tr>
                    ...
                    <td colspan="2" style="background: #e6e6e6;font-weight: bold;">LIBERACION CE A '. fnc_rango_de(11).' a '. fnc_rango_a(11).' hora) MAX</td>
                  </tr>
                  <tr>
