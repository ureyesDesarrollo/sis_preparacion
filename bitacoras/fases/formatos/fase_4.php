...
$sqlfg = mysqli_query($cnx, "SELECT * FROM procesos_fase_4_g as pfg INNER JOIN procesos as p  on(pfg.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro' AND pfg.pe_id = 7") or die(mysql_error() . "Error: en consultar procesos_fase_4_g ");
...
$sqlProAux = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '7'") or die(mysql_error() . "Error: en consultar procesos auxiliar");
$regProAux = mysqli_fetch_assoc($sqlProAux);


$sqlProLib = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '7'") or die(mysql_error() . "Error: en consultar procesos de liberacion");
  ...
  <table width="100%" style="margin:20px 0px 20px 0px">
    ...
    <tr>
      <td colspan="3">
        <table width="100%" border="1">
          <tr>
            <td width="16%" style="font-weight: bold;background: #e6e6e6"><span>Fecha de inicio</span></td>
            ...
            <td width="14%" style="font-weight: bold;background: #e6e6e6">Enzima</td>
            <td width="21%" style="font-weight: bold;background: #e6e6e6">Operador</td>
          </tr>
          <tr>
            ...
            <td><?php echo $regfg['pfg4_enzima'] ?></td>
            <td><?php echo fnc_nom_usu($regfg['usu_id']) ?></td>
          </tr>
          <tr>
            <td style="font-weight: bold;background: #e6e6e6">Temp</td>
            <td width="14%" colspan="" style="font-weight: bold;background: #e6e6e6">Acido</td>
            <td width="16%" style="font-weight: bold;background: #e6e6e6">Sol acida fuerte</td>
            <td colspan="2" style="font-weight: bold;background: #e6e6e6">Termina </td>
            <td style="font-weight: bold;background: #e6e6e6">Temp</td>
          </tr>
          <tr>
            ...
            <td colspan="2"><?php echo fnc_formato_val($regfg['pfg4_termina']) ?></td>
    ...
    <tr>
      <td width="54%" valign="top">
        <table width="100%" border="1" style="margin-top: 10px;height:100%">
          <tr style="font-weight: bold;background: #e6e6e6">
            ...
            <td width="30%" style="font-size: small; text-align: center;">Ph lado A</td>
            <td width="40%" style="font-size: small; text-align: center;">Ph lado B</td>
            <td width="40%" style="font-size: small; text-align: center;">Temp</td>
            <td width="40%" style="font-size: small; text-align: center;">PPM</td>
          ...
          ?>
            <tr>
              ...
              <td><?php echo fnc_formato_val($regfd['pfd4_ph_b']) ?></td>
              <td><?php echo fnc_formato_val($regfd['pfd4_temp']) ?></td>
              <td><?php echo fnc_formato_val($regfd['pfd4_ppm']) ?></td>
      ...
      <td rowspan="3" valign="top">
        <table border="1" style="margin-top:10px">
          <tr>
            <td>MANTENER PH 3 - 3.5 (2 a 4 hrs. mov.cont)</td>
          </tr>
        </table>
      </td>
      <td width="35%" rowspan="3" valign="top">
        ...
        <table width="403" border="1" style="height:100%">
          <tr>
            <td width="44" rowspan="5" style="font-size:50px">4</td>
          ...
          <tr>
            <td width="152">Adelgazamiento</td>
            <td width="185"><?php echo $regProLib['prol_adelgasamiento'] ?></td>
          </tr>
          <tr>
            <td>Ph promedio</td>
