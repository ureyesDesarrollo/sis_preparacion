...
<div class="divProcesos">
  <table width="100%" style="margin:20px 0px 20px 0px">
    ...
    <tr>
      ...
      <td width="10%" rowspan="3" valign="top"><label for="inputPassword3">Mantener PH</label>
        ...
        <table border="1">
          <tr>
            ...
            <td colspan="2" style="background: #e6e6e6;font-weight: bold;">
              <p><br />
                Nota: La adición de ácido se agrega por los dos lados del lavador y mantener el PH <?php echo fnc_rango_de(24) ?> - <?php echo fnc_rango_a(24) ?> durante todo el proceso de 1er ácido</p>
            </td>
          </tr>
          <tr>
