    ...
    <table width="100%" style="margin:20px 0px 20px 0px">
      <tr>
        <td><table border="1" style="background: #FCEFF2;font-size: 12px;width: 100%">
          <tr>
            <td height="45" colspan="10"> Lavados inicales. Nota: Si se junta agua recuperada con baja conductividad (Ce) con un cuero muy sucio, agregar más ácido limpio por cada lavado (20 -30 lts)
</td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td><table width="100%" border="1">
          <tr>
            <td width="15%" style="font-weight: bold;background: #e6e6e6">Fecha inicia lavados</td>
            <td width="15%" style="font-weight: bold;background: #e6e6e6">Hora inicio</td>
            <td width="15%" style="font-weight: bold;background: #e6e6e6">Ph agua inicio</td>
            <td width="15%" style="font-weight: bold;background: #e6e6e6">Ce agua inicio</td>
            <td width="30%" style="border-top: 1px solid#fff;border-bottom: 1px solid#fff;"></td>
            <td width="20%" rowspan="2" style="background: #e6e6e6;font-weight: bold;">Bajar CE A 3.0</td>
          </tr>
          <tr>
    ...
    <tr>
      <td><table border="1" width="100%">
        <tr style="font-weight: bold;">
          ...
          <td  style="border:1px solid#fff;background: #e6e6e6"><?php echo fnc_hora_de(22) ?> a <?php echo fnc_hora_a(22) ?></td>
          <td width="7%" style="border-bottom:1px solid#fff;border-top:1px solid#fff"></td>
          <td rowspan="4" width="30" style="font-size:50px">1b</td>
