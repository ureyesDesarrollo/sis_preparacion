...
$sqlProAux = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '13'") or die(mysql_error()."Error: en consultar procesos auxiliar");
$regProAux = mysqli_fetch_assoc($sqlProAux);


$sqlProLib = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '13'") or die(mysql_error()."Error: en consultar procesos de liberacion");
  ...
  <table width="100%" style="margin:20px 0px 20px 0px;background:#F5F4F4">
    ...
    <tr>
      <td colspan="3"><table width="100%" border="1">
        ...
        <tr>
          <td>'.fnc_formato_val($regfg['pfg5_temp']).'</td>
    ...
    <tr>
      <td width="58%"><table width="661" border="1" style="margin-top: 10px">
...
$tbHtml5d.= '</td>
      ...
      <tr>
        <td rowspan="3"><table border="1" width="882">
          <tr style="font-weight: bold;">
            ...
            <td width="126" rowspan="7"><p>
              <label for="inputPassword3">Mantener PH</label>
              '.fnc_rango_de(13).' - '.fnc_rango_a(13) .'</p>
              <table width="366" border="1">
              <tr>
                <td width="75" rowspan="6" style="font-size:50px">5d</td>
                <td colspan="2" style="background: #e6e6e6;font-weight: bold;"><p><br />
                  Nota: La adición de ácido se agrega por los dos lados del lavador y mantener el PH '.fnc_rango_de(13).' - '.fnc_rango_a(13).' durante todo el proceso de 1er ácido</p></td>
              </tr>
              <tr>
          ...
          <tr style="font-weight: bold;">
            ...
            <td width="126" rowspan="2" style="background: #e6e6e6">('.fnc_hora_de(13).' a '.fnc_hora_a(13).' horas)</td>
          </tr>
          <tr>
