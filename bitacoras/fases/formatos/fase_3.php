...
$sqlProAux3 = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$idx_pro'  AND pe_id = '5'") or die(mysqli_error($cnx) . "Error: en consultar procesos auxiliar");
    ...
    <tr>
      <td>
        <table border="1" style="background: #FCEFF2;font-size: 12px;width: 100%">
          <tr>
            <td height="45" colspan="10"> LAVADOS DE BLANQUEO
            </td>
          </tr>
        </table>
      </td>
      ...
      <td>
        <table width="100%" border="1">
          <tr>
            ...
            <td width="14%" style="font-weight: bold;background: #e6e6e6">BUSCAR CE A 4.0 MAXIMO
            </td>
          </tr>
        </table>
      </td>
      ...
      <td>
        <table width="100%" border="1">
          ...
          do {
            ...
            $tagua = mysqli_query($cnx, "SELECT * FROM tipos_agua  WHERE tpa_id  = '$regf3d[tpa_id]'") or die(mysqli_error($cnx) . "Error: en consultar el tipo de material");
      ...
      <td>
        <table border="1" width="100%">
          ...
          <tr style="font-weight: bold;">
            ...
            <td colspan="3" style="background: #e6e6e6;font-weight: bold;">LIBERACION CE A <?php echo fnc_rango_a(5) ?> MAX</td>
          </tr>
          <tr>
