...
$tbHtml6b.= '
<table width="107%" style="margin:20px 0px 20px 0px;background:#F5F4F4">
    <tr>
      <td><table border="1" style="background: #FCEFF2;font-size: 12px;width: 100%">
        <tr>
          <td height="45" colspan="9">LAVADOS 1er ACIDO. Este proceso se puede hacer con agua limpia. Lavados finales a partir del 2do lavado de paleto a paleto.</td>
        </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <tr>
        <td><table border="1" width="830">
          <tr style="font-weight: bold;">
            ...
            <td width="190" rowspan="2" style="background: #e6e6e6">('.fnc_hora_de(15).' a '.fnc_hora_a(15).' horas)</td>
...
$tbHtml6b.= '
              <table width="280" border="1">
                <tr>
                  ...
                  <td colspan="2" style="background: #e6e6e6;font-weight: bold;">LIBERACION CE A '.fnc_rango_de(15).' a '.fnc_rango_a(15).' hora) MAX</td>
                </tr>
                <tr>
          ...
          <tr>
            ...
            <tr>
              <td colspan="5">El agua de este proceso se manda a agua recuperada semilimpia (Pila 1)</td>
            </tr>
         </table></td>
    </tr>
    </table>
