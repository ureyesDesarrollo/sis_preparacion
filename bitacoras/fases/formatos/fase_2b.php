      ...
      <td colspan="2">
        <table width="100%" border="1">
          <tr>
            ...
            <td width="12%" style="font-weight: bold;background: #e6e6e6">Ajuste con sosa</td>
            <td width="9%" style="font-weight: bold;background: #e6e6e6"><span>Fecha de inicio</span></td>
            <td width="17%" style="font-weight: bold;background: #e6e6e6">Hora de incio</td>
          ...
          <tr>
            ...
            <td><?php echo $regf2bg['pfg2_ajustesosa'] ?></td>
