...
<div class="divProcesos">
	...
	<form autocomplete="off" id="formFase4e" name="formFase4e">
		...
		<div class="row">
			...
			<div class="col-md-3 divEtapas">
				...
				<div class="col-md-2 divEtapasInput">
					...
					<input type="text"  maxlength="6" onKeyPress="return isNumberKey(event, this);" id="txtCeLib" class="form-control" placeholder="Ce liberacion" name="txtCeLib" value="<?php if ($reg_lib['prol_ce'] == '') {
																																												echo "";
																																												$str_prop = '';
																																											} else {
		...
		<div class="row footerdivProcesos" style="margin-bottom: 10px;">
			...
			<?php if ($_SESSION['privilegio'] == 4) {	?>
				...
				<div class="col-md-1">
					<!--Nota: si no ocupa es-->
					<button type="button" class="btn btn-success" id="paleto" onClick="javascript:abre_modal_equipos(<?php echo $reg_pro['pro_id'] ?>,<?php echo $id_e ?>);"> <img src="../iconos/procesos2.png" alt="">Paleto
					</button>
				</div>
				<div class="col-md-1">
