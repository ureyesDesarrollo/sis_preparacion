...
<script>
	...
	$(document).ready(function() {
		$("#formFase4b").submit(function() {
			...
			$.ajax({
				url: "fases/fase_4b_insertar.php",
				type: 'POST',
				data: formData,
				success: function(result) {
...
<div class="divProcesos">
	<form autocomplete="off" id="formFase4b" name="formFase4b">
		...
		<div class="row" style="margin-bottom: 30px">
			...
			<div class="col-md-1">
				<input type="text"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);"   class="form-control" id="txtTermina" name="txtTermina"  maxlength="6" onKeyPress="return isNumberKeyFloat(event, this);" placeholder="TERMINA" value="<?php if ($reg_fa['pfg4_termina'] == '') {
																																												echo "";
																																												$str_prop = '';
																																											} else {
