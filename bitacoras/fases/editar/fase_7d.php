...
<script language="javascript">
	$(document).ready(function() {
		$("#formFase7dE").submit(function() {

			var formData = $(this).serialize();
			$.ajax({
				url: "fases/editar/fase_7d_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {

					data = JSON.parse(result);
					alertas("#alerta-errorFase7dEOpe", 'Listo!', data["mensaje"], 1, true, 5000);
					$('#formFase7dE').each(function() {
						this.reset();
					});
	...
	function confirmEnviar5() {
		...
		formFase7dE.btn.disabled = true;
		formFase7dE.btn.value = "Enviando...";

		setTimeout(function() {
			formFase7dE.btn.disabled = true;
			formFase7dE.btn.value = "Guardar";
		}, 2000);
...
<div class="modal-dialog modal-lg" role="document" style="width: 1100px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form autocomplete="off" id="formFase7dE" name="formFase7b">
				...
				<div class="row footerdivProcesos" style="margin-bottom: 10px">
					...
					<div class="form-group col-md-4">
						<div class="alert alert-info hide" id="alerta-errorFase7dEOpe" style="height: 40px; width: 270px; text-align: left; z-index: 10; font-size: 10px;">
