...
<script>
	...
	$(document).ready(function() {
		$("#formFase1bE").submit(function() {
			...
			$.ajax({
				url: "fases/editar/fase_1b_actualizar.php",
				type: 'POST',
				data: formData,
...
<div class="modal-dialog modal-lg" role="document" style="width: 1210px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form autocomplete="off" id="formFase1bE" name="formFase1bE">
				...
				<div class="col-md-2 tiempos">
					<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtTemp" name="txtTemp" placeholder="TEMP" value="<?php /*if($reg_fa1['pfg1_temp_ag'] == ''){echo ""; $str_prop = '';}else{echo $reg_fa1['pfg1_temp_ag']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;*/ ?> required>
				</div>-->
					...
					<table border="0" cellspacing="5" cellpadding="5">
						...
						?>
								<tr>
									...
									<td align="center"><input  maxlength="6" onKeyPress="return isNumberKey(event, this);" <?php if ($fltVal >= $reg_fad1['pfd1_ce'] and $reg_fad1['pfd1_ce'] != '') { ?>style="background-color:#66FF66;" <?php } ?> type="text" class="form-control" id="<?php echo "txtCe" . $i ?>" name="<?php echo "txtCe" . $i ?>" value="<?php if ($reg_fad1['pfd1_ce'] == '') {
																																																																																						echo "";
																																																																																						$str_prop = 'disabled';
																																																																																					} else {
									...
									<td align="center">
										<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 150px" name="cbxAgua<?php echo $i  ?>" <?php if ($reg_fad1['tpa_id'] == '') {
																																							echo "";
																																							$str_prop = 'disabled';
																																						} else {
																																							$str_prop = '';
