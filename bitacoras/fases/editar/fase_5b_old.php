...
$cad_fa = mysqli_query($cnx, "SELECT * FROM procesos_fase_5_g WHERE pro_id = '$reg_pro[pro_id]' and pe_id = 11");
...
<script>
	...
	function agregarCampo5() {
		...
		document.getElementById('campos5').appendChild(div);
		document.getElementById('campos5').appendChild(div);
	}
	...
	function confirmEnviar5() {
		...
		formFase5bE.btn.disabled = true;
		formFase5bE.btn.value = "Enviando...";

		setTimeout(function() {
			formFase5bE.btn.disabled = true;
			formFase5bE.btn.value = "Guardar";
		}, 2000);
		...
		<div class="divProcesos1">
			<form autocomplete="off" id="formFase5bE" name="formFase5bE">
				...
				<div class="row" style="margin-bottom: 10px">
					...
					<div class="col-md-2 tiempos">
						<select id="cbxTipAg" class="form-control" style="width: 250px" name="cbxTipAg" <?php if ($reg_fa['tpa_id'] == '') {
																											echo "";
																											$str_prop = 'disabled';
																										} else {
																											$str_prop = '';
				...
				<div>
					<table border="0" cellspacing="5" cellpadding="5">
						...
						for ($i = 1; $i <= 10; $i++) {
							...
							if ($i == 2 and $reg_fad['pfd5_ce'] == '') {
								$strVal = '';
							}/*else{$strVal = 'NO';}*/

							$fltVal = fnc_parametro_max(10, 'C');

							$bolVal = fnc_valida_renglon($i, $reg_pro['pro_id'], 11);
						...
						?>
								<tr>
									...
									<td><input type="time" class="form-control" id="<?php echo "txtHraIni" . $i ?>" name="<?php echo "txtHraIni" . $i ?>" value="<?php if ($reg_fad['pfd5_hr_ini'] == '') {
																																										echo date("H:i");
																																										$str_prop = 'disabled';
																																									} else {
																																										echo $reg_fad['pfd5_hr_ini'];
																																										$str_prop = '';
																																									} ?>" <?php echo $str_prop;
																																											echo " " . $strProp2;
																																											echo " " . $strProp3;
																																											echo " " . $strProp4; ?>></td>
									<td><input type="time" class="form-control" id="<?php echo "txtHraFin" . $i ?>" name="<?php echo "txtHraFin" . $i ?>" value="<?php if ($reg_fad['pfd5_hr_fin'] == '') {
																																										echo date("H:i");
																																										$str_prop = 'disabled';
																																									} else {
																																										echo $reg_fad['pfd5_hr_fin'];
																																										$str_prop = '';
																																									} ?>" <?php echo $str_prop;
																																											echo " " . $strProp2;
																																											echo " " . $strProp3;
																																											echo " " . $strProp4; ?>></td>
									<td><input type="time" class="form-control" id="<?php echo "txtHraIniMov" . $i ?>" name="<?php echo "txtHraIniMov" . $i ?>" value="<?php if ($reg_fad['pfd5_hr_ini_mov'] == '') {
																																											echo date("H:i");
																																											$str_prop = 'disabled';
																																										} else {
																																											echo $reg_fad['pfd5_hr_ini_mov'];
																																											$str_prop = '';
																																										} ?>" <?php echo " " . $str_prop;
																																												echo " " . $strProp2;
																																												echo " " . $strProp3;
																																												echo " " . $strProp4; ?>></td>
									<td><input type="time" class="form-control" id="<?php echo "txtHraFinMov" . $i ?>" name="<?php echo "txtHraFinMov" . $i ?>" value="<?php if ($reg_fad['pfd5_hr_fin_mov'] == '') {
																																											echo date("H:i");
																																											$str_prop = 'disabled';
																																										} else {
																																											echo $reg_fad['pfd5_hr_fin_mov'];
																																											$str_prop = '';
																																										} ?>" <?php echo " " . $str_prop;
																																												echo " " . $strProp2;
																																												echo " " . $strProp3;
																																												echo " " . $strProp4; ?>></td>
									<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPh" . $i ?>" name="<?php echo "txtPh" . $i ?>" value="<?php if ($reg_fad['pfd5_ph'] == '') {
																																																							echo "";
																																																							$str_prop = 'disabled';
																																																						} else {
									...
									<td align="center"><input maxlength="6" onKeyPress="return isNumberKey(event, this);" <?php if ($fltVal >= $reg_fad['pfd5_ce'] and $reg_fad['pfd5_ce'] != '') { ?>style="background-color:#66FF66;" <?php } ?> type="text" class="form-control" id="<?php echo "txtCe" . $i ?>" name="<?php echo "txtCe" . $i ?>" value="<?php if ($reg_fad['pfd5_ce'] == '') {
																																																																																									echo "";
																																																																																									$str_prop = 'disabled';
																																																																																								} else {
																																																																																									echo $reg_fad['pfd5_ce'];
																																																																																									$str_prop = '';
																																																																																								} ?>" <?php echo $str_prop;
																																																																																										echo " " . $strProp2;
																																																																																										echo " " . $strProp3;
																																																																																										echo " " . $strProp4; ?> size="5" style="width:50px;" placeholder="Ce"></td>
									<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtTemp" . $i ?>" name="<?php echo "txtTemp" . $i ?>" value="<?php if ($reg_fad['pfd5_temp'] == '') {
																																																								echo "";
																																																								$str_prop = 'disabled';
																																																							} else {
									...
									<td><input type="text" class="form-control" maxlength="100" id="<?php echo "txtObs" . $i ?>" name="<?php echo "txtObs" . $i ?>" value="<?php if ($reg_fad['pfd5_observaciones'] == '') {
																																												echo "";
																																												$str_prop = 'disabled';
																																											} else {
																																												echo $reg_fad['pfd5_observaciones'];
																																												$str_prop = '';
																																											} ?>" <?php echo $str_prop;
																																													echo " " . $strProp2;
																																													echo " " . $strProp3;
...
if($i == 2 and $reg_fad['pfd4_ce'] == ''){$strVal = '';}
  ...
  ?>
	...
	<div class="row" id="campos5"></div><?php */ ?>
			...
			<div class="form-group col-md-2">
				...
				<select id="cbxTipAg" class="form-control" style="width: 250px" name="cbxTipAg" <?php if ($reg_fa['taa_id'] == '') {
																									echo "";
																									$str_prop = 'disabled';
																								} else {
																									$str_prop = '';
		...
		<div class="col-md-1">
			<button type="button" class="btn btn-success" id="permitir" onClick="javascript:AbreModalAgregarR(<?php echo $reg_pro['pro_id'] ?>, 11, <?php echo $valUltRen ?>);"> <img src="../../iconos/add.png" alt="">Renglon
			</button>
		</div>
	<?php }*/ ?>
