...
mysqli_query($cnx, "UPDATE procesos_fase_5b_g SET pfg5_temp_ag = '$txtTemp', pfg5_temp = '$txtTemp2', pfg5_acido = '$txtAcido', pfg5_termina = '$txtTermina', pfg5_temp2 = '$txtTemp3' $str_cad $str_cad2 $str_cad3 $str_cad4 WHERE pro_id = '$hdd_pro_id' AND pe_id = '$hdd_pe_id' ") or die(mysqli_error($cnx)." Error al actualizar 2");
