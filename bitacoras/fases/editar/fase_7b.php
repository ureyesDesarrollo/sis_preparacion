...
<script language="javascript">
	$(document).ready(function() {
		$("#formFase7bE").submit(function() {
			...
			$.ajax({
				url: "fases/editar/fase_7b_actualizar.php",
				type: 'POST',
				data: formData,
...
<div class="modal-dialog modal-lg" role="document" style="width: 1100px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form autocomplete="off" id="formFase7bE" name="formFase7b">
				...
				<div class="row">
					...
					<div class="col-md-2 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtTemp" name="txtTemp" placeholder="TEMP" value="<?php if ($reg_fa['pfg7_temp_ag'] == '') {
																																														echo "";
																																														$str_prop = 'disabled';
																																													} else {
					...
					<div class="col-md-1">
						<select type="text" id="cbxDiluido" class="form-control" placeholder="Ácido fuerte" name="cbxDiluido" <?php if ($reg_fa['pfg7_acido_diluido'] == '') {
																																	echo "";
																																	$str_prop = 'disabled';
																																} else {
																																	$str_prop = '';
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtTemp2" name="txtTemp2" placeholder="TEMP" value="<?php if ($reg_fa['pfg7_temp'] == '') {
																																														echo "";
																																														$str_prop = 'disabled';
																																													} else {
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtAcido" name="txtAcido" placeholder="Acido" value="<?php if ($reg_fa['pfg7_acido'] == '') {
																																															echo "";
																																															$str_prop = 'disabled';
																																														} else {
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtNorm" name="txtNorm" placeholder="Norm" value="<?php if ($reg_fa['pfg7_norm'] == '') {
																																														echo "";
																																														$str_prop = 'disabled';
																																													} else {
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtPh" name="txtPh" placeholder="PH" value="<?php if ($reg_fa['pfg7_ph'] == '') {
																																												echo "";
																																												$str_prop = 'disabled';
																																											} else {
																																												echo $reg_fa['pfg7_ph'];
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtCe" name="txtCe" placeholder="Ce" value="<?php if ($reg_fa['pfg7_ce'] == '') {
																																												echo "";
																																												$str_prop = 'disabled';
																																											} else {
																																												echo $reg_fa['pfg7_ce'];
						...
						<table border="0" cellspacing="5" cellpadding="5">
							...
							?>
								<tr>
									...
									<td>
										<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtNormF" . $i ?>" name="<?php echo "txtNormF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd7_norm'] == '') {
																																																										echo "";
																																																										$str_prop = 'disabled';
																																																									} else {
									...
									<td align="center" bgcolor="#FF0000">
										<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPhF" . $i ?>" name="<?php echo "txtPhF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd7_ph'] == '') {
																																																									echo "";
																																																									$str_prop = 'disabled';
																																																								} else {
									...
									<td>
										<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtCeF" . $i ?>" name="<?php echo "txtCeF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd7_ce'] == '') {
																																																									echo "";
																																																									$str_prop = 'disabled';
																																																								} else {
									...
									<td>
										<?php
										if ($i != 2 && $i != 5) { ?>
											<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtTempF" . $i ?>" name="<?php echo "txtTempF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd7_temp'] == '') {
																																																											echo "";
																																																											$str_prop = 'disabled';
																																																										} else {
									...
									<td>
										<?php
										if ($i == 2 || $i == 5) { ?>
											<input style="display: inline;width:50px" type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtAcidoF" . $i ?>" name="<?php echo "txtAcidoF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd7_acido'] == '') {
																																																																					echo "";
																																																																					$str_prop = 'disabled';
																																																																				} else {
				...
				<div class="row" style="margin-top: 2rem;">
					...
					<!-- <div class="form-row">
				<div class="form-group col-md-2">
					<label for="inputPassword4">Total (<?php echo fnc_hora_de(18) ?>-<?php echo fnc_hora_a(18) ?>) hrs</label>
				</div>
			</div> -->
				</div>
				<!---->
						...
						<table border="0" cellspacing="5" cellpadding="5">
							...
							?>
								<tr>
									...
									<td>
										<?php if ($i == 1 || $i == 2) { ?>
											<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" name="txtNormD<?php echo $i; ?>" id="txtNormD<?php echo $i; ?>" class="form-control" placeholder="NORM" value="<?php if ($reg_fad['pfd7_norm'] == '') {
																																																												echo "";
																																																												$str_prop = 'disabled';
																																																											} else {
																																																												echo $reg_fad['pfd7_norm'];
									...
									<td>
										<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" name="txtPhD<?php echo $i; ?>" id="txtPhD<?php echo $i; ?>" class="form-control" placeholder="PH" value="<?php if ($reg_fad['pfd7_ph'] == '') {
																																																									echo "";
																																																									$str_prop = 'disabled';
																																																								} else {
																																																									echo $reg_fad['pfd7_ph'];
									...
									<td>
										<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" name="txtCeD<?php echo $i; ?>" id="txtCeD<?php echo $i; ?>" class="form-control" placeholder="CE" value="<?php if ($reg_fad['pfd7_ce'] == '') {
																																																									echo "";
																																																									$str_prop = 'disabled';
																																																								} else {
																																																									echo $reg_fad['pfd7_ce'];
									...
									<td>
										<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" name="txtTempD<?php echo $i; ?>" id="txtTempD<?php echo $i; ?>" class="form-control" placeholder="TEMP" value="<?php if ($reg_fad['pfd7_temp'] == '') {
																																																											echo "";
																																																											$str_prop = 'disabled';
																																																										} else {
																																																											echo $reg_fad['pfd7_temp'];
				...
				<div class="row">
					...
					<div class="form-row">
						<div class="form-group col-md-2">
							<label for="inputPassword4">2 A 4 horas (8 - 12 Horas) totales</label>
						</div>
					</div>
