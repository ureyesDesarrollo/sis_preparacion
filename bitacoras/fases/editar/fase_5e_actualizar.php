...
if($txtCocido != '')
{
	$str_cad = ",pfg5_cocido_ph = '$txtCocido' ";
}
if($cbxAgua != '')
{
	$str_cad2 = ",taa_id = '$cbxAgua' ";
}
if($txtCeAgua != '')
{
	$str_cad3 = ", pfg5_ce_agua = '$txtCeAgua' ";
}
if($txtPhAgua != '')
{
	$str_cad4 = ", pfg5_ph_agua = '$txtPhAgua' ";
}
if($txtCeG != '')
{
	$str_cad5 = ", pfg5_ce = '$txtCeG' ";
}
if($txtHrsReales != '')
{
	$str_cad6 = ", pfg5_hr_reales = '$txtHrsReales' ";
}

mysqli_query($cnx, "UPDATE procesos_fase_5b_g SET pfg5_temp_ag = '$txtTemp', pfg5_temp = '$txtTemp2', pfg5_acido = '$txtAcido', pfg5_termina = '$txtTermina', pfg5_temp2 = '$txtTemp3', pfg5_acido_fuerte = '$cbxAcidoF' $str_cad $str_cad2 $str_cad3 $str_cad4 $str_cad5 $str_cad6 WHERE pro_id = '$hdd_pro_id' AND pe_id = '$hdd_pe_id' ") or die(mysqli_error($cnx)." Error al actualizar 2");
...
for($i = 1; $i <= 8; $i++)
{
	...
	{
		mysqli_query($cnx, "UPDATE procesos_fase_5b_d SET pfd5_acido = '$txtAcidoF', pfd5_ph = '$txtPhF', pfd5_temp = '$txtTempF' WHERE pfg5_id = '$hdd_pfg' AND pfd5_ren = '$txtRen' ") or die(mysqli_error($cnx)." Error al actualizar el renglon ".$i);
	}
}
