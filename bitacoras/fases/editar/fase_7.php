...
<script>
	$(document).ready(function() {
		$("#formFase7E").submit(function() {
			...
			$.ajax({
				url: "fases/editar/fase_7_actualizar.php",
				type: 'POST',
				data: formData,
...
<div class="modal-dialog modal-lg" role="document" style="width: 1210px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form autocomplete="off" id="formFase7E" name="formFase7E">
					...
					?>
							<tr>
								...
								<td>
									...
									<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtMov" . $i ?>" name="<?php echo "txtMov" . $i ?>" value="<?php if ($reg_fad['pfd7_mov'] == '') {
																																																						echo "";
																																																						$str_prop = 'disabled';
																																																					} else {
								...
								<?php //if($i <= 3){ 
								?>
								<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" name="txtPh<?php echo $i; ?>" id="txtPh<?php echo $i; ?>" class="form-control" placeholder="PH" value="<?php if ($reg_fad['pfd7_ph'] == '') {
																																																								echo "";
																																																								$str_prop = 'disabled';
																																																							} else {
								...
								<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" name="txtCe<?php echo $i; ?>" id="txtCe<?php echo $i; ?>" class="form-control" placeholder="CE" value="<?php if ($reg_fad['pfd7_ce'] == '') {
																																																								echo "";
																																																								$str_prop = 'disabled';
																																																							} else {
								...
								<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" name="txtTemp<?php echo $i; ?>" id="txtTemp<?php echo $i; ?>" class="form-control" placeholder="TEMP" value="<?php if ($reg_fad['pfd7_temp'] == '') {
																																																									echo "";
																																																									$str_prop = 'disabled';
																																																								} else {
								...
								<td><input type="text" class="form-control" maxlength="100" id="<?php echo "txtObs" . $i ?>" name="<?php echo "txtObs" . $i ?>" value="<?php if ($reg_fad['pfd7_observaciones'] == '') {
																																											echo "";
																																											$str_prop = 'disabled';
																																										} else {
...
<?php }*/ ?>
				...
				<div class="col-md-12">
					...
					<div class="col-md-1 tiempos" style="margin-left: 20px;width: 130px">
						...
						<input type="text" id="txtHrTotales1" class="form-control" placeholder="Horas totales" name="txtHrTotales1" value="<?php if ($reg_fa['pfg7_hr_totales'] == '0') {
																																				echo "";
																																				$str_prop = 'disabled';
																																			} else {
				...
				<div class="col-md-8" style="border: 1px solid#e6e6e6;border-radius: 5px;background: #e6e6e6;margin-left: 20px;margin-top: 10px;margin-bottom: 10px">
					<div class="col-md-4 tiempos" style="margin-left: -25px;">
						...
						<input type="text" id="txtHrasTotales" class="form-control" placeholder="Horas totales" name="txtHrasTotales" value="<?php if ($reg_pro_con['hrs_totales_capturadas'] == '') {
					...
					<div class="col-md-3">
						...
						<input type="text" id="txtHrsMuerto" class="form-control" onKeyPress="return isNumberKeyFloat(event, this);" placeholder="Horas totales" name="txtHrsMuerto" value="<?php
