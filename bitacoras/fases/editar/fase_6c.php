...
/*	a = 6;
	...
	{	
		$("#formFase6cE").submit(function(){

			var formData = $(this).serialize();
			$.ajax({
				url: "fases/editar/fase_6c_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {

					data = JSON.parse(result);
					alertas("#alerta-errorFase6cEOpe", 'Listo!', data["mensaje"], 1, true, 5000);
					$('#formFase6cE').each (function(){this.reset();}); 
...
function confirmEnviar5() {
	...
	formFase6cE.btn.disabled = true; 
	formFase6cE.btn.value = "Enviando...";

	setTimeout(function(){
		formFase6cE.btn.disabled = true;
		formFase6cE.btn.value = "Guardar";
	},2000);
...
function AbreModalAgregarR(proceso, etapa, uren){
	...
	<div class="modal-dialog modal-lg" role="document" style="width: 1100px">
		<div class="modal-content">
			<div class="divProcesos1">
				<form autocomplete="off" id="formFase6cE" name="formFase6cE">
					...
					<div class="row" style="margin-bottom: 10px">
						...
						<div class="col-md-2 tiempos">
							<select id="cbxTipAg" class="form-control" style="width: 250px" name="cbxTipAg" <?php if($reg_fa['tpa_id'] == ''){echo ""; $str_prop = 'disabled';}else{ $str_prop = '';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
							...
							if($i <= 4 or $bolVal == 'Si' ){
								...
								<tr>
									...
									<td>
										...
										<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);"  class="form-control" id="<?php echo "txtTemp".$i ?>" name="<?php echo "txtTemp".$i ?>" value="<?php if($reg_fad['pfd6_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_temp']; $str_prop = '';} ?>" <?php echo $str_prop;  echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> size="5" placeholder="Temp"></td>
										<td><input type="time" class="form-control" id="<?php echo "txtHraIni".$i ?>" name="<?php echo "txtHraIni".$i ?>" value="<?php if($reg_fad['pfd6_hr_ini'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad['pfd6_hr_ini']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> ></td>
										<td><input type="time" class="form-control" id="<?php echo "txtHraFin".$i ?>" name="<?php echo "txtHraFin".$i ?>" value="<?php if($reg_fad['pfd6_hr_fin'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad['pfd6_hr_fin']; $str_prop = '';} ?>" <?php echo $str_prop;  echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4;?>></td>
										<td><input type="time" class="form-control" id="<?php echo "txtHraIniMov".$i ?>" name="<?php echo "txtHraIniMov".$i ?>" value="<?php if($reg_fad['pfd6_hr_ini_mov'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad['pfd6_hr_ini_mov']; $str_prop = '';} ?>" <?php echo " ".$str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?>></td>
										<td><input type="time" class="form-control" id="<?php echo "txtHraFinMov".$i ?>" name="<?php echo "txtHraFinMov".$i ?>" value="<?php if($reg_fad['pfd6_hr_fin_mov'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad['pfd6_hr_fin_mov']; $str_prop = '';} ?>" <?php echo " ".$str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?>></td>
										<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);"  class="form-control" id="<?php echo "txtCe".$i ?>" name="<?php echo "txtCe".$i ?>" value="<?php if($reg_fad['pfd6_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" <?php if($fltVal >= $reg_fad['pfd6_ce'] and $reg_fad['pfd6_ce'] != ''){?>style="background-color:#66FF66;"<?php }?> placeholder="Ce"></td>
										<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);"  class="form-control" id="<?php echo "txtPh".$i ?>" name="<?php echo "txtPh".$i ?>" value="<?php if($reg_fad['pfd6_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="pH"></td>
										<td>
				...
				//mysqli_free_result($registros);
										...
										<td><input type="text" class="form-control" maxlength="100" id="<?php echo "txtObs".$i ?>" name="<?php echo "txtObs".$i ?>" value="<?php if($reg_fad['pfd6_observaciones'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_observaciones']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="Observaciones"></td>
									</tr>
									<?php 
									$valUltRen = $i;
  }//termina if
	...
	<div class="row">
		...
		<div class="form-row">
			<!--<div class="form-group col-md-1">
				...
				<!--<input type="text" class="form-control" id="txtAguaA" name="txtAguaA" placeholder="" value="<?php if($reg_fa['pfg6_agua_a'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_agua_a']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>-->
	...
	<div class="row footerdivProcesos" style="margin-bottom: 10px;">
		...
		<div class="form-group col-md-7">
			<div class="alert alert-info hide" id="alerta-errorFase6cEOpe" style="height: 40px;width: 270px;text-align: left;z-index: 10;font-size: 10px;margin-bottom: -10px">
