...
<script>
	...
	$(document).ready(function() {
		$("#formFase4dE").submit(function() {
			...
			$.ajax({
				url: "fases/editar/fase_4d_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {
...
<div class="modal-dialog modal-lg" role="document" style="width: 1230px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form autocomplete="off" id="formFase4dE" name="formFase4dE">
				...
				<table border="0" cellspacing="5" cellpadding="5">
					...
					?>
							<tr>
								...
								<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtTemp" . $i ?>" name="<?php echo "txtTemp" . $i ?>" value="<?php if ($reg_fad['pfd4_temp'] == '') {
																																																							echo "";
																																																							$str_prop = 'disabled';
																																																						} else {
								...
								<td><input type="time" class="form-control" id="<?php echo "txtHraFinMov" . $i ?>" name="<?php echo "txtHraFinMov" . $i ?>" value="<?php if ($reg_fad['pfd4_hr_fin_mov'] == '') {
																																										...
																																										echo " " . $strProp3;
																																										echo " " . $strProp4; ?>></td>
								<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtCe" . $i ?>" name="<?php echo "txtCe" . $i ?>" value="<?php if ($reg_fad['pfd4_ce'] == '') {
																																																						echo "";
																																																						$str_prop = 'disabled';
																																																					} else {
								...
								<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPh" . $i ?>" name="<?php echo "txtPh" . $i ?>" value="<?php if ($reg_fad['pfd4_ph'] == '') {
																																																						echo "";
																																																						$str_prop = 'disabled';
																																																					} else {
								...
								<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPpm" . $i ?>" name="<?php echo "txtPpm" . $i ?>" value="<?php if ($reg_fad['pfd4_ppm'] == '') {
																																																						echo "";
																																																						$str_prop = 'disabled';
																																																					} else {
																																																						...
																																																						echo " " . $strProp2;
																																																						echo " " . $strProp3;
																																																						echo " " . $strProp4; ?> size="3" placeholder="PPM"></td>
								<td align="center">
									<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 150px" name="cbxAgua<?php echo $i  ?>" <?php if ($reg_fad['tpa_id'] == '') {
																																						echo "";
																																						$str_prop = 'disabled';
																																					} else {
																																						$str_prop = '';
								...
								<td><input type="text" class="form-control" maxlength="100" id="<?php echo "txtObs" . $i ?>" name="<?php echo "txtObs" . $i ?>" value="<?php if ($reg_fad['pfd4_observaciones'] == '') {
																																											echo "";
																																											$str_prop = 'disabled';
																																										} else {
				...
				<div class="row">
					...
					<div class="form-row">
						<div class="form-group col-md-2">
							...
							<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if ($reg_fa['pfg4_horas_reales'] == '') {
																																																			echo "";
																																																			$str_prop = 'disabled';
																																																		} else {
