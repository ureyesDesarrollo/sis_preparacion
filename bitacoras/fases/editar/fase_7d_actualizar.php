...
for ($i = 1; $i <= 8; $i++) {
	...
	{*/
	mysqli_query($cnx, "UPDATE procesos_fase_7b_d SET pfd7_acido = '$acido_ren', pfd7_ph = '$txtPhF', pfd7_ce = '$txtCeF', pfd7_temp = '$txtTempF', pfd7_norm = '$txtNormF' WHERE pfg7_id = '$hdd_pfg' AND pfd7_ren = '$txtRen' ") or die(mysqli_error($cnx) . " Error al actualizar el renglon " . $i);
	//}
}
