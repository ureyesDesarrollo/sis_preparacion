...
<script>
	...
	$(document).ready(function() {
		$("#formFase5eE").submit(function() {
			...
			$.ajax({
				url: "fases/editar/fase_5e_actualizar.php",
				type: 'POST',
				data: formData,
...
<div class="modal-dialog modal-lg" role="document" style="width: 1100px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form autocomplete="off" id="formFase5eE" name="formFase5eE">
				...
				<div class="row" style="margin-bottom: 20px">
					...
					<div class="col-md-2 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtTemp" name="txtTemp" placeholder="TEMP" value="<?php if ($reg_fa['pfg5_temp_ag'] == '') {
																																										echo "";
																																										$str_prop = 'disabled';
																																									} else {
				...
				<div class="row" style="margin-bottom: 20px">
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtTemp2" name="txtTemp2" placeholder="TEMP" value="<?php if ($reg_fa['pfg5_temp'] == '') {
																																											echo "";
																																											$str_prop = 'disabled';
																																										} else {
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtAcido" name="txtAcido" placeholder="Acido" value="<?php if ($reg_fa['pfg5_acido'] == '') {
																																											echo "";
																																											$str_prop = 'disabled';
																																										} else {
					...
					<div class="col-md-2">
						...
						<select type="text" id="cbxAcidoF" class="form-control" placeholder="Acido" name="cbxAcidoF" <?php if ($reg_fa['pfg5_acido_fuerte'] == '') {
																															echo "";
																															$str_prop = 'disabled';
																														} else {
																															$str_prop = '';
																																																								...
																																																								echo " " . $strProp2;
																																																								echo " " . $strProp3; ?> required>
							<?php if ($reg_fa['pfg5_acido_fuerte'] != '') {
								echo "<option value='$reg_fa[pfg5_acido_fuerte]'>$reg_fa[pfg5_acido_fuerte]</option>";
							} ?>
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtTermina" name="txtTermina" placeholder="Termina" value="<?php if ($reg_fa['pfg5_termina'] == '') {
																																													echo "";
																																													$str_prop = 'disabled';
																																												} else {
					...
					<label class="col-md-1">Temp</label>
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtTemp3" name="txtTemp3" placeholder="TEMP" value="<?php if ($reg_fa['pfg5_temp2'] == '') {
																																											echo "";
																																											$str_prop = 'disabled';
																																										} else {
							...
							<table border="0" cellspacing="0" cellpadding="0">
								...
								?>
									<tr>
										...
										<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtAcidoF" . $i ?>" name="<?php echo "txtAcidoF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd5_acido'] == '') {
																																																							echo "";
																																																							$str_prop = 'disabled';
																																																						} else {
										...
										<td>LTS</td>
										<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPhF" . $i ?>" name="<?php echo "txtPhF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd5_ph'] == '') {
																																																						echo "";
																																																						$str_prop = 'disabled';
																																																					} else {
										...
										<!--<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php /*echo "txtPhBF".$i ?>" name="<?php echo "txtPhBF".$i ?>" size="5" value="<?php if($reg_fad['pfd5_ph'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd5_ph']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4;*/ ?>></td>-->
										<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtTempF" . $i ?>" name="<?php echo "txtTempF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd5_temp'] == '') {
																																																							echo "";
																																																							$str_prop = 'disabled';
																																																						} else {
		...
		<div class="form-row">
				...
				<div class="row">
					<div class="form-row">
						<div class="form-group col-md-2">
							...
							<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtPhAgua" name="txtPhAgua" placeholder="Ph Agua" value="<?php if ($reg_fa['pfg5_ph_agua'] == '') {
																																													echo "";
																																													$str_prop = 'disabled';
																																												} else {
					...
					<div class="form-row">
						<div class="form-group col-md-2">
							...
							<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtCeAgua" name="txtCeAgua" placeholder="Ce Agua" value="<?php if ($reg_fa['pfg5_ce_agua'] == '') {
																																													echo "";
																																													$str_prop = 'disabled';
																																												} else {
					...
					<div class="form-row">
						<div class="form-group col-md-3">
							...
							<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtCocido" placeholder="Cocido" name="txtCocido" value="<?php if ($reg_fa['pfg5_cocido_ph'] == '') {
																																													echo "";
																																													$str_prop = 'disabled';
																																												} else {
					...
					<div class="form-row">
						<div class="form-group col-md-2">
							...
							<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtCeG" placeholder="Ce" name="txtCeG" value="<?php if ($reg_fa['pfg5_ce'] == '') {
																																										echo "";
																																										$str_prop = 'disabled';
																																									} else {
																																										echo $reg_fa['pfg5_ce'];
			...
			<div class="form-group col-md-2">
				...
				<select type="text" class="form-control" id="inputPassword4" placeholder=""><option value=""></option></select> 
					...
					<div class="col-md-2">
						...
						<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if ($reg_fa['pfg5_hr_reales'] == '') {
																																														echo "";
																																														$str_prop = 'disabled';
																																													} else {
																																														echo $reg_fa['pfg5_hr_reales'];
																																														$str_prop = '';
																																													} ?>" <?php echo $str_prop;
																																																																															echo " " . $strProp6;
																																																																															echo " " . $strProp3 . " " . $strProp4; ?>>
			...
			<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="inputPassword4" placeholder="">
		</div>-->
