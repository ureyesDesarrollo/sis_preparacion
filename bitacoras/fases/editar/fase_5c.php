...
<div class="modal-dialog modal-lg" role="document" style="width: 1100px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form autocomplete="off" id="formFase5cE" name="formFase5cE">
							...
							<table border="0" cellspacing="0" cellpadding="0">
								...
								?>
									<tr>
										...
										<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPhBF" . $i ?>" name="<?php echo "txtPhBF" . $i ?>" size="5" value="<?php if ($reg_fad['pfd5_ph'] == '') {
																																																							echo "";
																																																							$str_prop = 'disabled';
																																																						} else {
																																																							echo $reg_fad['pfd5_ph'];
				...
				<?php } ?>
					...
					<div class="col-md-3 divEtapas" style="height: 250px;">
						...
						<div class="col-md-2 divEtapasInput" style="width: 200px">
							...
							<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" id="txtPhLib" class="form-control" placeholder="Ph promedio" name="txtPhLib" value="<?php if ($reg_lib['prol_ph'] == '') {
																																														echo "";
																																														$str_prop = 'disabled';
																																													} else {
