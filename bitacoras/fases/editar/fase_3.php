...
/*	a = 3;
		...
		$(document).ready(function()
	{
		$("#formFase3E").submit(function(){
			...
			$.ajax({
				url: "fases/editar/fase_3_actualizar.php",
				type: 'POST',
				data: formData,
...
<form autocomplete="off" id="formFase3E" name="formFase3E">
	...
	<div class="row" style="margin-bottom: 10px">
			...
			<div class="col-md-2 tiempos">
				<input type="text"  maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtEnzima" name="txtEnzima" required="" placeholder="ENZIMA" value="<?php 
...
if($i <= 3 or $bolVal == 'Si' ){
  ...
  <tr>
    ...
    <td><input type="text"  maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtTemp".$i ?>" name="<?php echo "txtTemp".$i ?>" value="<?php if($reg_fad1['pfd3_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad1['pfd3_temp']; $str_prop = '';} ?>" <?php echo $str_prop;  echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> size="5"placeholder="Temp"></td>
    ...
    <td><input type="text"  maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPh".$i ?>" name="<?php echo "txtPh".$i ?>" value="<?php if($reg_fad1['pfd3_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad1['pfd3_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="Ph"></td>
	...
	<td><input type="text"  maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPpm".$i ?>" name="<?php echo "txtPpm".$i ?>" value="<?php if($reg_fad1['pfd3_ppm'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad1['pfd3_ppm']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="3" placeholder="PPM"></td>
	<!--<td>
	...
	<td><input type="text" class="form-control" maxlength="100" id="<?php echo "txtObs".$i ?>" name="<?php echo "txtObs".$i ?>" value="<?php if($reg_fad1['pfd3_observaciones'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad1['pfd3_observaciones']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="Observaciones"></td>
  </tr>
  <?php 
  $valUltRen = $i;
  }//termina if
