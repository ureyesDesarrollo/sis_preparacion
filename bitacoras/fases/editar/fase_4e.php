...
if($i <= 4 or $bolVal == 'Si' ){
  ...
  <tr>
	...
	<td><input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtPpm".$i ?>" name="<?php echo "txtPpm".$i ?>" value="<?php if($reg_fad['pfd4_ppm'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd4_ppm']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="3" placeholder="PPM"></td>
	<td align="center">
	...
	<div class="row">
		...
		<!--<div class="col-md-4 tiempos">
			...
			<div class="form-group col-md-2">
				...
				<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if($reg_fa['pfg4_horas_reales'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg4_horas_reales']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
