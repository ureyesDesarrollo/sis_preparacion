...
if ($txtFeTermS != '') {
	$str_cad = ", pfg6_fe_fin = '$txtFeTermS'";
}
if ($txtHrsReales != '') {
	$str_cad2 = ", pfg6_hr_totales = '$txtHrsReales'";
}
if ($txtCe2F != '') {
	$str_cad3 = ""; //", pfg6_ce2 = '$txtCe2F'";
}
if ($txtPh3F != '') {
	$str_cad4 = ""; //", pfg6_ph3 = '$txtPh3F'";
}
if ($txtCe3F != '') {
	$str_cad5 = ""; //", pfg6_ce3 = '$txtCe3F'";
}
/*if ($cbxAgua != '') {
	$str_cad6 = ", taa_id = '$cbxAgua'";
}*/

mysqli_query($cnx, "UPDATE procesos_fase_6_g SET pfg6_temp_ag = '$txtTemp',pfg6_acido_diluido = '$cbxDiluido', pfg6_temp = '$txtTemp2', pfg6_acido = '$txtAcido', pfg6_temp2 = '$txtTemp3', pfg6_norm = '$txtNorm', pfg6_ph = '$txtPh', pfg6_ph2 = '$txtPh2F', pfg6_ce2='$txtCe2F',pfg6_ph3='$txtPh3F',pfg6_ce3='$txtCe3F' $str_cad $str_cad2 $str_cad3 $str_cad4 $str_cad5 WHERE pro_id = '$hdd_pro_id' ") or die(mysqli_error($cnx) . " Error al actualizar 2"); //$str_cad6 ,pfg6_hr_cocido = '$txtHrIniCo'
