...
<script>
	$(document).ready(function() {
		$("#formFase2bE").submit(function() {
			...
			$.ajax({
				url: "fases/editar/fase_2d_actualizar.php",
				type: 'POST',
				data: formData,
			...
			<form autocomplete="off" id="formFase2bE" name="formFase2bE">
				...
				<div class="row" style="margin-bottom: 20px">
					...
					<div class="col-md-2">
						...
						<input style="display: inline;width:70px" type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtEnzima" placeholder="Kg" name="txtEnzima" value="<?php if ($reg_fa['pfg2_enzima'] == '') {
																																																							echo "";
																																																							$str_prop = 'disabled';
																																																						} else {
					...
					<div class="col-md-2">
						...
						<input style="display: inline;width:70px" type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txt_ph" placeholder="PH" name="txt_ph" value="<?php if ($reg_fa['pfg2_ph1'] == '') {
																																																						echo "";
																																																						$str_prop = 'disabled';
																																																					} else {
					...
					<div class="col-md-1 tiempos">
						<input type="text" maxlength="6" placeholder="Temp" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txt_temp" placeholder="" name="txt_temp" value="<?php if ($reg_fa['pfg2_temp_ag'] == '') {
																																																		echo "";
																																																		$str_prop = 'disabled';
																																																	} else {
								...
								<tr>
									...
									<td style="padding-right:1.5rem">
										<?php if ($i != 2 && $i != 4 && $i != 6 && $i != 10 && $i != 14 && $i != 18 && $i != 22 && $i != 26) { ?>
											<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="<?php echo "txtSosaD" . $i ?>" name="<?php echo "txtSosaD" . $i ?>" value="<?php if ($reg_fad['pfd2_sosa'] == '') {
																																																									echo "";
																																																									$str_prop = 'disabled';
																																																								} else {
									...
									<td style="padding-right:1.5rem">
										<?php if ($i != 2 && $i != 4 && $i != 6 && $i != 10 && $i != 14 && $i != 18 && $i != 22 && $i != 26) { ?>
											<input type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txt_tempd<?php echo $i; ?>" name="txt_tempd<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_temp'] == '') {
																																																										echo "";
																																																										$str_prop = 'disabled';
																																																									} else {
					...
					<div class="col-md-4" style="border-radius: 5px;border: 1px solid #e6e6e6;height: 110px;width:350px;padding:0px">
						...
						<div class="row">
							...
							<div class="col-md-9" style="padding:0px">
								<label class="etiquetaEtapa" style="background:#e6e6e6;width:257px">Liberación de la extractibilidad entre 80-85%<?php /* echo fnc_rango_de(30) ?> - <?php echo fnc_rango_a(30) */ ?></label>
								<input style="width:15rem;display: inline;" type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" id="txt_extractibilidad" class="form-control" placeholder="Extractibiliad" name="txt_extractibilidad" value="<?php if ($reg_lib['prol_hr_totales'] == '') {
																																																																		echo "";
																																																																		$str_prop = 'disabled';
																																																																	} else {
																																																																		...
																																																																		$str_prop = '';
																																																																				...
																																																																				echo " " . $strProp2; ?>>
								<br>
								<input style="width:15rem;display: inline;" type="text" maxlength="6" onKeyPress="return isNumberKey(event, this);" id="txtHrTotales" class="form-control" placeholder="Horas totales" name="txtHrTotales" value="<?php if ($reg_lib['prol_hr_totales'] == '') {
																																																														echo "";
																																																														$str_prop = 'disabled';
																																																													} else {
																																																														echo $reg_lib['prol_hr_totales'];
																																																														$str_prop = '';
																																																																...
																																																																echo " " . $strProp1;
																																																																echo " " . $strProp2; ?>>
								<input style="width:15rem" type="text" onKeyPress="return isNumberKey(event, this);" id="inputPassword" class="form-control" placeholder="Nombre LCP" value="<?php echo fnc_nom_usu($_SESSION['idUsu']); ?>" readonly="">
						...
						<div class="row">
							...
							<div class="form-group col-md-12">
								...
								<input type="text" onKeyPress="return isNumberKey(event, this);" class="form-control" id="txtHrasTot" name="txtHrasTot" placeholder="" value="<?php if ($reg_fa['pfg2_hr_totales'] == '') {
																																													echo "";
																																													$str_prop = 'disabled';
																																												} else {
