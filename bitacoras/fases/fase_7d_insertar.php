...
if ($txtFeIni != '' and $txtHrIni != '' and $txtTemp != '') {
	...
	mysqli_query($cnx, "INSERT INTO procesos_fase_7b_g(pro_id, pe_id, pfg7_temp_ag, pfg7_acido_diluido,pfg7_temp,  pfg7_acido, pfg7_norm, pfg7_ph, pfg7_ce, usu_id) VALUES('$hdd_pro_id', '$hdd_pe_id', '$txtTemp', '0','$txtTemp2', '$txtAcido', '$txtNorm',  '$txtPh', '$txtCe', '" . $_SESSION['idUsu'] . "' ) ") or die(mysqli_error($cnx) . " Error al insertar 2");
