...
function sumCantidad(param) 
{
	...
	{ 
        ...
        function sumCantidadD(param) 
        {
        	...
        	{ 
        		...
        		var kilos = val.split(' ');
				//document.write(kilos[0]); //porción3
	...
	function confirmEnviar() {
		...
		function agregarRenglon(){
			...
			'<select class="form-control" id="cbxMaterial'+a+'" name="cbxMaterial'+a+'" style="width:150px;" onchange="obtenerInv('+a+')">'+
			...
			'<div class="col-sm-3 col-md-2" style="width:130px;margin-left:5px">'+
			'<select class="form-control" id="cbxKilosID'+a+'" name="cbxKilosID'+a+'" onchange="sumCantidadD('+a+');obtenerFecha('+a+')">'+
			'<option value="">Seleccionar</option>'+
			'</select>'+
			...
			'<div class="form-group col-md-1" style="width: 70px;margin-left:10px">'+
	...
	<form id="formEncabezado1">
		...
		<div class="form-row">
			<div class="form-group col-md-2">
				...
				<?php for($i = 1; $i <= 5; $i++){ ?>
					<select id="<?php echo "cbxMaterial".$i ?>" class="form-control" style="width: 150px" name="<?php echo "cbxMaterial".$i ?>" onchange="obtenerInv(<?php echo $i; ?>)">
						<option value="">Seleccionar</option>
						<?php
						$html = ''; 
			...
			<div class="form-group col-md-1" style="width: 140px">
				...
				<?php for($i = 1; $i <= 5; $i++){ ?>
					<select id="<?php echo "cbxKilosID".$i ?>" class="form-control" style="width: 100px" name="<?php echo "cbxKilosID".$i ?>" onchange="sumCantidadD(<?php echo $i ?>);obtenerFecha(<?php echo $i; ?>);obtenerFecha_entrada_maquila(<?php echo $i; ?>);">
						<option value="">Seleccionar</option>
					</select>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group col-md-2">
					...
					<input style="width:98px" type="text" class="form-control" id="txtTotKilos" name="txtTotKilos" readonly="">
