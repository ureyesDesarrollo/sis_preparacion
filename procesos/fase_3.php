...
$cad_pro = mysqli_query($cnx, "SELECT p.pro_id  
	...
	$cad_fa = mysqli_query($cnx, "SELECT * FROM procesos_fase_3_g WHERE pro_id = '$reg_pro[pro_id]'");
...
<script>
	...
	function AbreModalE3(proceso, etapa){
		var datos={
			"pro_id": proceso,
			"pe_id": etapa
		}
		$.ajax({
			type:'post',
			url: 'editar/fase_3.php',
			data: datos,
			success: function(result){
				$("#modalEditar3").html(result);
	...
	//agregado 16-10-21
	//abre modal quimicos etapa 2c
function quimicos_3(proceso, etapa){
		var datos={
			"pro_id": proceso,
			"pe_id": etapa
		}
...
<div class="divProcesos">
	<form id="formFase3" name="formFase3">
		...
		<div class="row" style="margin-bottom: 10px">
			<label class="col-md-1" style="width: 150px;">Fecha que inicia</label>
			<div class="col-md-2 tiempos">
				<input type="date" class="form-control" id="txtFeIni" name="txtFeIni" placeholder="__________" value="<?php if($reg_aux['proa_fe_ini'] == ''){ echo date("Y-m-d"); $str_prop = '';}else{echo $reg_aux['proa_fe_ini']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?>>
			</div>
			
			<label class="col-md-1" style="width: 110px">Hora inicio</label>
			<div class="col-md-2 tiempos">
				<input type="time" class="form-control" id="txtHrIni" name="txtHrIni" placeholder="__________" value="<?php if($reg_aux['proa_hr_ini'] == ''){echo date("H:i"); $str_prop = '';}else{echo $reg_aux['proa_hr_ini']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> >
			</div>
			
			<label class="col-md-1" style="width: 150px">Enzima liquida</label>
			<div class="col-md-2 tiempos">
				<input type="text" class="form-control" id="txtEnzima" name="txtEnzima" required="" placeholder="ENZIMA" 
				value="<?php 
				
				if($reg_fa['pfg3_enzima'] == ''){
					if($reg_aux['proa_fe_ini'] != '' and $reg_aux['proa_hr_ini'] != '' ) {
						echo "0"; $str_prop = 'disabled';
					}
					}else{
						echo $reg_fa['pfg3_enzima']; $str_prop = 'disabled';
					} 
					
					?>" 
					<?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
				</div>
			...
			<div class="row">
						...
						if($i <= 3 or $bolVal == 'Si' ){
							...
							<tr>
								...
								<td><input type="hidden" class="form-control" id="<?php echo "txtRen".$i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen".$i ?>">
									<input type="hidden" class="form-control" id="<?php echo "hddRen".$i ?>" name="<?php echo "hddRen".$i ?>" value="<?php echo $reg_fad1['pfd3_id'];?>" />
									...
									<select id="cbxTipAg<?php echo $i  ?>" class="form-control" style="width: 150px" name="cbxTipAg<?php echo $i  ?>" <?php if($reg_fad1['tpa_id'] == ''){echo ""; $str_prop = '';}else{ $str_prop = 'disabled';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>>
				...
				//mysqli_free_result($registros);
									...
									<td><input type="text" class="form-control" id="<?php echo "txtTemp".$i ?>" name="<?php echo "txtTemp".$i ?>" value="<?php if($reg_fad1['pfd3_temp'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_temp']; $str_prop = 'disabled';} ?>" <?php echo $str_prop;  echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> size="5"placeholder="Temp"></td>
									<td><input type="time" class="form-control" id="<?php echo "txtHraIni".$i ?>" name="<?php echo "txtHraIni".$i ?>" value="<?php if($reg_fad1['pfd3_hr_ini'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_hr_ini']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> ></td>
									<td><input type="time" class="form-control" id="<?php echo "txtHraFin".$i ?>" name="<?php echo "txtHraFin".$i ?>" value="<?php if($reg_fad1['pfd3_hr_fin'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_hr_fin']; $str_prop = 'disabled';} ?>" <?php echo $str_prop;  echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4;?>></td>
									<td><input type="time" class="form-control" id="<?php echo "txtHraIniMov".$i ?>" name="<?php echo "txtHraIniMov".$i ?>" value="<?php if($reg_fad1['pfd3_hr_ini_mov'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_hr_ini_mov']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?>></td>
									<td><input type="time" class="form-control" id="<?php echo "txtHraFinMov".$i ?>" name="<?php echo "txtHraFinMov".$i ?>" value="<?php if($reg_fad1['pfd3_hr_fin_mov'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_hr_fin_mov']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?>></td>
									<td><input type="text" class="form-control" id="<?php echo "txtPh".$i ?>" name="<?php echo "txtPh".$i ?>" value="<?php if($reg_fad1['pfd3_ph'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_ph']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="Ph"></td>
									<td><input type="text" class="form-control" id="<?php echo "txtCe".$i ?>" name="<?php echo "txtCe".$i ?>" value="<?php if($reg_fad1['pfd3_ce'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_ce']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" <?php if($fltVal >= $reg_fad1['pfd3_ce'] and $reg_fad1['pfd3_ce'] != ''){?>style="background-color:#66FF66;"<?php }?> placeholder="Ce"></td>
									<td><input type="text" class="form-control" id="<?php echo "txtPpm".$i ?>" name="<?php echo "txtPpm".$i ?>" value="<?php if($reg_fad1['pfd3_ppm'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_ppm']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="PPM"></td>
									<td>
										<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 110px" name="cbxAgua<?php echo $i  ?>" <?php if($reg_fad1['taa_id'] == ''){echo ""; $str_prop = '';}else{ $str_prop = 'disabled';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3." ".$strProp4; ?> >
											<option value="">Seleccionar</option>
											<?php 
									...
									<td><input style="width: 75px" type="text" class="form-control" id="<?php echo "txtObs".$i ?>" name="<?php echo "txtObs".$i ?>" value="<?php if($reg_fad1['pfd3_observaciones'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd3_observaciones']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="Observación"></td>
								</tr>
								<?php 
								$valUltRen = $i;
  }//termina if
	...
	<div class="form-row">
		...
		<div class="footerdivProcesos row" style="margin-bottom: 10px">
			...
			<div class="col-md-7">
				<div class="alert alert-info hide" id="alerta-errorFase3Ope" style="height: 40px;width: 270px;text-align: left;z-index: 10;font-size: 10px;margin-bottom: -10px">
					<button type="button" class="close" id="cerrar_alerta" aria-label="Close">&times;</button>
					<strong>Titulo</strong> &nbsp;&nbsp;
					<span> Mensaje </span>
				</div>
			</div>
			<div class="col-md-5" style="text-align: right;margin-left:  -40px">
			<?php if($_SESSION['privilegio'] == 4){	?>
					...
					<button type="button" class="btn btn-success" id="editar" onClick="javascript:AbreModalE3(<?php echo $reg_pro['pro_id'] ?>, 5);"> <img src="../iconos/edit.png" alt="">Editar
					</button>
			...
			<?php } ?>
				...
				if($_SESSION['privilegio'] == 6 or $_SESSION['privilegio'] == 4)
				{
					...
					<button type="button" class="btn btn-info"  onClick="javascript:quimicos_3(<?php echo $reg_pro['pro_id'] ?>,<?php echo $reg_et['pe_id'] ?> );"><img src="../iconos/matraz.png" alt="">Químicos</button>
					<button type="submit" class="btn btn-primary" id="btn"><img src="../iconos/guardar.png" alt="">Guardar</button>	
				<?php }?>	
			</div>
		</div>
	...
	<div class="modal" id="modalEditar3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"></div>
