...
$cad_aux = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$reg_pro[pro_id]' and pe_id = 16");
$reg_aux = mysqli_fetch_array($cad_aux);

$cad_fa = mysqli_query($cnx, "SELECT * FROM procesos_fase_6b_g WHERE pro_id = '$reg_pro[pro_id]' and pe_id = 16");
$reg_fa = mysqli_fetch_array($cad_fa);

$cad_lib = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$reg_pro[pro_id]' and pe_id = 16");
...
{	
	$("#formFase6c").submit(function(){

		var formData = $(this).serialize();
		$.ajax({
			url: "fase_6c_insertar.php",
			type: 'POST',
			data: formData,
			success: function(result) {

				data = JSON.parse(result);
				alertas("#alerta-errorFase6cOpe", 'Listo!', data["mensaje"], 1, true, 5000);
				$('#formFase6c').each (function(){this.reset();}); 
	...
	var datos={
		...
		$.ajax({
			...
			//data: {nombre:n},
			success: function(result){
				$("#modalRenglon6c").html(result);
				$('#modalRenglon6c').modal('show')
			}	
		});
		return false;
	}
	...
	var datos={
		...
		$.ajax({
			...
			//data: {nombre:n},
			success: function(result){
				$("#modalPaleto6c").html(result);
				$('#modalPaleto6c').modal('show')
			}	
		});
		return false;
	}
	
	function AbreModalE6c(proceso, etapa){
	var datos={
		"pro_id": proceso,
		"pe_id": etapa
	}
		$.ajax({
			type:'post',
			url: 'editar/fase_6c.php',
			data: datos,
			success: function(result){
				$("#modalEditar6c").html(result);
				$('#modalEditar6c').modal('show')
			}	
		});
		return false;
	}
...
<form id="formFase6c" name="formFase6c">
	<input name="hdd_pro_id" type="hidden" value="<?php echo $reg_pro['pro_id'] ?>" id="hdd_pro_id"/>
	<input name="hdd_pe_id" type="hidden" value="16" id="hdd_pe_id"/>
	...
	<div class="row" style="margin-bottom: 10px">
		...
		<label class="col-md-1" style="width: 130px">Tipo de agua</label>
		<div class="col-md-2 tiempos">
...
if($i == 2 and $reg_fad['pfd6_ce'] == ''){$strVal = '';}/*else{$strVal = 'NO';}*/

$fltVal = fnc_parametro_max(16, 'C');

$bolVal = fnc_valida_renglon($i, $reg_pro['pro_id'], 16);
...
if($i <= 4 or $bolVal == 'Si' ){
  ...
  <tr>
	...
	<input type="hidden" class="form-control" id="<?php echo "hddRen".$i ?>" name="<?php echo "hddRen".$i ?>" value="<?php echo $reg_fad['pfd6_id'];?>" /></td>
   <td><select id="cbxTipAg<?php echo $i  ?>" class="form-control" style="width: 140px" name="cbxTipAg<?php echo $i  ?>" <?php if($reg_fad['tpa_id'] == ''){echo ""; $str_prop = '';}else{ $str_prop = 'disabled';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>>
    ...
    <td><input type="text" class="form-control" id="<?php echo "txtTemp".$i ?>" name="<?php echo "txtTemp".$i ?>" value="<?php if($reg_fad['pfd6_temp'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd6_temp']; $str_prop = 'disabled';} ?>" <?php echo $str_prop;  echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> size="5" placeholder="Temp"></td>
    <td><input type="time" class="form-control" id="<?php echo "txtHraIni".$i ?>" name="<?php echo "txtHraIni".$i ?>" value="<?php if($reg_fad['pfd6_hr_ini'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd6_hr_ini']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> ></td>
    <td><input type="time" class="form-control" id="<?php echo "txtHraFin".$i ?>" name="<?php echo "txtHraFin".$i ?>" value="<?php if($reg_fad['pfd6_hr_fin'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd6_hr_fin']; $str_prop = 'disabled';} ?>" <?php echo $str_prop;  echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4;?>></td>
    <td><input type="time" class="form-control" id="<?php echo "txtHraIniMov".$i ?>" name="<?php echo "txtHraIniMov".$i ?>" value="<?php if($reg_fad['pfd6_hr_ini_mov'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd6_hr_ini_mov']; $str_prop = 'disabled';} ?>" <?php echo " ".$str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?>></td>
    <td><input type="time" class="form-control" id="<?php echo "txtHraFinMov".$i ?>" name="<?php echo "txtHraFinMov".$i ?>" value="<?php if($reg_fad['pfd6_hr_fin_mov'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd6_hr_fin_mov']; $str_prop = 'disabled';} ?>" <?php echo " ".$str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?>></td>
	<td><input type="text" class="form-control" id="<?php echo "txtCe".$i ?>" name="<?php echo "txtCe".$i ?>" value="<?php if($reg_fad['pfd6_ce'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd6_ce']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" <?php if($fltVal >= $reg_fad['pfd6_ce'] and $reg_fad['pfd6_ce'] != ''){?>style="background-color:#66FF66;"<?php }?> placeholder="Ce"></td>
    <td><input type="text" class="form-control" id="<?php echo "txtPh".$i ?>" name="<?php echo "txtPh".$i ?>" value="<?php if($reg_fad['pfd6_ph'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd6_ph']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="pH"></td>
    <td>
  ...
  <td><input type="text" class="form-control" id="<?php echo "txtObs".$i ?>" name="<?php echo "txtObs".$i ?>" value="<?php if($reg_fad['pfd6_observaciones'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd6_observaciones']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="Observaciones"></td>
  </tr>
  <?php 
  $valUltRen = $i;
  }//termina if
	...
	<!--<div class="row">
		<div class="form-row">
			<div class="form-group col-md-1" style="width: 85px">
				<label for="inputPassword3" style="color: #fff">.............</label>
				<label for="inputPassword3" style="margin-bottom: 10px">1er Lav</label>
				<label for="inputPassword3" style="margin-bottom: 10px">2do Lav</label>
				<label for="inputPassword3" style="margin-bottom: 10px">3er Lav</label>
				<label for="inputPassword3" style="margin-bottom: 10px">4to Lav</label>
			</div>
		</div>
		<div class="form-row">
		...
		<div class="form-row">
			<div class="form-group col-md-1" style="width: 160px">
				...
				<?php for($i = 1; $i <=4; $i++){ ?>
					<input type="text" class="form-control" id="<?php echo "txtHraFin".$i ?>">
				<?php }?>
			</div>
		</div>
		...
		<div class="form-row">
			<div class="form-group col-md-1" style="width: 180px">
				...
				<?php for($i = 1; $i <=4; $i++){ ?>
					<input type="text" class="form-control" id="<?php echo "txtHraIniMov".$i ?>">
				<?php }?>
			</div>
		</div>
		...
		<div class="form-row">
			<div class="form-group col-md-1" style="width: 190px">
				...
				<?php for($i = 1; $i <=4; $i++){ ?>
					<input type="text" class="form-control" id="<?php echo "txtHraFinMov".$i ?>">
				<?php }?>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-1">
				...
				<?php for($i = 1; $i <=4; $i++){ ?>
					<input type="text" class="form-control" id="<?php echo "txtCe".$i ?>">
				<?php }?>
			</div>
		</div>
		<div class="form-row">
	...
	<div class="row">
		...
		<div class="form-row">
			<!--<div class="form-group col-md-1">
				<label for="inputPassword4">Agua a<?php //echo $reg_fa['taa_id']." ".$reg_fa['pfg6_id']; ?></label>-->
				<!--<input type="text" class="form-control" id="txtAguaA" name="txtAguaA" placeholder="" value="<?php if($reg_fa['pfg6_agua_a'] == ''){ echo ""; $str_prop = '';}else{echo $reg_fa['pfg6_agua_a']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>-->
	...
	<div class="row" style="margin-bottom: 10px">
	<i><label style="margin-left:20px;color: red"> * Los campos "Tipo Agua" y "TEMP" deben ser capturados juntos</label></i>
</div>
<!--barra botones-->
	<div class="row footerdivProcesos" style="margin-bottom: 10px;">
		...
		<div class="form-group col-md-7">
			<div class="alert alert-info hide" id="alerta-errorFase6cOpe" style="height: 40px;width: 350px;text-align: left;z-index: 10;font-size: 10px;margin-bottom: -10px">
		...
		<?php if($_SESSION['privilegio'] == 4){	?>
				...
				<div class="col-md-1">
					<button type="button" class="btn btn-success" id="editar" onClick="javascript:AbreModalE6c(<?php echo $reg_pro['pro_id'] ?>, 16);"> 
				<img src="../iconos/edit.png" alt="">Editar
			</button>
				</div>
				<div class="col-md-2" style="width: 110px">
					<button type="button" class="btn btn-success" id="permitir" onClick="javascript:AbreModalAgregarR(<?php echo $reg_pro['pro_id'] ?>, 16, <?php echo $valUltRen ?>);"> <img src="../iconos/add.png" alt="">Renglon
					</button>
				</div>
			<?php } ?>
...
<div class="modal" id="modalRenglon6c" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"></div>

<div class="modal" id="modalPaleto6c" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"></div>

<div class="modal" id="modalEditar6c" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"></div>
