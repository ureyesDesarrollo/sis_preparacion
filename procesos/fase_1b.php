...
<div class="divProcesos">
	<form id="formFase1b" name="formFase1b">
		...
		<div class="row" style="margin-bottom: 10px">
			...
			<div class="col-md-2 tiempos">
				<input type="text" class="form-control" id="txtAgIni" name="txtAgIni" placeholder="Ph agua inicio" value="<?php if ($reg_fa1['pfg1_ph_agua'] == '') {
																																echo "";
																																$str_prop = '';
																															} else {
			...
			<div class="col-md-2 tiempos">
				<input type="text" class="form-control" id="txtCeIni" name="txtCeIni" placeholder="Ce agua de inicio" value="<?php if ($reg_fa1['pfg1_ce_agua'] == '') {
																																	echo "";
																																	$str_prop = '';
																																} else {
