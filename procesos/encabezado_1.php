...
<form id="formEncabezado1">
	...
	<div class="row">
		<div class="form-group col-xs-3 col-sm-4 col-md-3">
		...
		<div class="form-group col-xs-2 col-sm-2 col-md-3">
			...
			<select id="cbxLavador" class="form-control" name="cbxLavador" required>
				<option value="">Seleccionar</option>
				<?php
				$html = '';
				...
				do {
					$html .= "<option value='" . $registros['pl_id'] . "'>" . $registros['pl_descripcion'] . "</option>";
				} while ($registros =  mysqli_fetch_array($cadena));
		...
		<div class="form-group col-xs-5 col-sm-6 col-md-6">
			...
			<?php for ($i = 1; $i <= 5; $i++) { ?>
				<select id="<?php echo "cbxKilosID" . $i ?>" class="form-control" name="<?php echo "cbxKilosID" . $i ?>" onchange="sumCantidadD(<?php echo $i ?>);obtenerFecha(<?php echo $i; ?>);">
					...
					$registros =  mysqli_fetch_array($cadena_mat);
					do {
						$html .= "<option value='" . $registros['inv_od'] . "'>" . $registros['mat_nombre'] . "</option>";
					} while ($registros =  mysqli_fetch_array($cadena_mat));
					echo $html;
