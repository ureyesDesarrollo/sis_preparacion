...
<div class="divProcesos">
	<form id="formFase2c" name="formFase2c">
		...
		<div class="row" style="margin-bottom: 10px">
			...
			<div class="col-md-2 tiempos">
				<input onkeypress="return isNumberKey(event, this);" type="text" class="form-control" id="txtTemp" placeholder="" name="txtTemp" value="<?php if ($reg_fa['pfg2_temp_ag'] == '') {
																																							echo "";
																																							$str_prop = '';
																																						} else {
		...
		<div class="row" style="margin-bottom: 30px">
			...
			<div class="col-md-1">
				<input onkeypress="return isNumberKey(event, this);" type="text" class="form-control" id="txtPhAnt" placeholder="" name="txtPhAnt" value="<?php if ($reg_fa['pfg2_ph_ant'] == '') {
																																								echo "";
																																								$str_prop = '';
																																							} else {
			...
			<div class="col-md-1">
				<input onkeypress="return isNumberKey(event, this);" type="text" class="form-control" id="txtCe" placeholder="" name="txtCe" value="<?php if ($reg_fa['pfg2_ce'] == '') {
																																						echo "";
																																						$str_prop = '';
																																					} else {
																																						echo $reg_fa['pfg2_ce'];
			...
			<div class="col-md-1">
				<input onkeypress="return isNumberKey(event, this);" type="text" class="form-control" id="txtAjSosa" placeholder="" name="txtAjSosa" value="<?php if ($reg_fa['pfg2_temp_ag'] == '') {
																																								echo "";
																																								$str_prop = '';
																																							} else {
																																								echo $reg_fa['pfg2_temp_ag'];
			...
			<div class="col-md-1">
				<input onkeypress="return isNumberKey(event, this);" type="text" class="form-control" id="txtPhAj" placeholder="" name="txtPhAj" value="<?php if ($reg_fa['pfg2_ph_aju'] == '') {
																																							echo "";
																																							$str_prop = '';
																																						} else {
			...
			<div class="col-md-1">
				<input onkeypress="return isNumberKey(event, this);" type="text" class="form-control" id="txtPeroxido" placeholder="" name="txtPeroxido" value="<?php if ($reg_fa['pfg2_peroxido'] == '') {
																																									echo "";
																																									$str_prop = '';
																																								} else {
						...
						<tr>
							...
							<td><input type="text" class="form-control" id="txtSosa<?php echo $i; ?>" placeholder="Sosa" name="txtSosa<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_sosa'] == '') {
																																												...
																																												$str_prop = 'disabled';
																																													...
																																													echo " " . $strProp3;
																																													echo " " . $strProp4; ?>></td>
							<!--<td><input type="text" class="form-control" id="txtAcido<?php echo $i; ?>" placeholder="Acido" name="txtAcido<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_acido'] == '') {
																																													echo "";
																																													$str_prop = '';
																																												} else {
							...
							<td><input type="text" class="form-control" id="txtTemp<?php echo $i; ?>" placeholder="Temp" name="txtTemp<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_temp'] == '') {
																																												...
																																												$str_prop = 'disabled';
																																													...
																																													echo " " . $strProp3;
																																													echo " " . $strProp4; ?>></td>
							<td align="center" bgcolor="#FF6493" width="100"><?php if ($i < 5) { ?><input type="text" class="form-control" id="txtRedox<?php echo $i; ?>" placeholder="Redox" name="txtRedox<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_redox'] == '') {
																																																													echo "";
																																																													$str_prop = '';
																																																												} else {
