		...
		$("#formFase6b").submit(function(){
			...
			$.ajax({
				...
				success: function(result) {
					...
					$('#formFase6b').each (function(){this.reset();}); 
...
<div class="divProcesos">
	<form id="formFase6b" name="formFase6b">
		...
		<table border="0" cellspacing="5" cellpadding="5">
			<tr class="etiqueta_tbl">
				...
				<td>TEMP</td>
				<td><span style="color: red;font-weight: bold;"> * </span>HR ini llenado</td>
				...
				if($i <= 4 or $bolVal == 'Si' ){
					...
					<tr>
						...
						<td align="center"><?php echo $i; ?><input type="hidden" class="form-control" id="<?php echo "txtRen".$i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen".$i ?>">
							...
							<td <?php if($fltVal >= $reg_fad['pfd6_ce'] and $reg_fad['pfd6_ce'] != ''){?>style="background-color:#66FF66;"<?php }?> align="center"><input type="text" class="form-control" id="<?php echo "txtCe".$i ?>" name="<?php echo "txtCe".$i ?>" value="<?php if($reg_fad['pfd6_ce'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd6_ce']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" style="width:100px;" placeholder="Ce"></td>
