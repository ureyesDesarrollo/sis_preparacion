	...
	$("#formFase5c").submit(function(){
		...
		$.ajax({
			...
			success: function(result) {
				...
				$('#formFase5c').each (function(){this.reset();}); 
...
<form id="formFase5c" name="formFase5c">
	...
	<div class="row" style="margin-bottom: 20px">
		...
		<div class="col-md-1 tiempos">
			<input type="text" class="form-control" id="txtTermina" name="txtTermina" placeholder="Termina" onKeyPress="return isNumberKeyFloat(event, this);" value="<?php if($reg_fa['pfg5_termina'] == ''){echo ""; $str_prop = '';}else{echo $reg_fa['pfg5_termina']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
		</div>
		<label class="col-md-1" >Temp</label>
		<div class="col-md-1 tiempos">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			for($i = 1; $i <=8; $i++){ 
				...
				<tr>
					...
					<td><input type="text" class="form-control" id="<?php echo "txtPhBF".$i ?>" name="<?php echo "txtPhBF".$i ?>" size="5" value="<?php if($reg_fad['pfd5_ph_b'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd5_ph_b']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="ph B"></td>
