...
{  	
	...
	{
		$cad_kg2 = mysqli_query($cnx, "SELECT inv_kg_totales FROM inventario WHERE inv_id = '$cbxKilosID1' ");
		$reg_kg2 = mysqli_fetch_array($cad_kg2);
		
		$txtKilos1 = $reg_kg2['inv_kg_totales'];

		mysqli_query($cnx, "INSERT INTO procesos_materiales (pro_id, inv_id, mat_id, pma_kg, pma_fe_entrada) VALUES('$pro_id', '$cbxKilosID1', '$cbxMaterial1',  '$txtKilos1',  '$txtFecha1')") or die(mysqli_error($cnx)." Error al insertar en [".$i."]");
	...
	if($i == 2 and $cbxKilosID2!='' and $cbxMaterial2!='' and $txtKilos2!='')
	{
		...
		$cad_kg2 = mysqli_query($cnx, "SELECT inv_kg_totales FROM inventario WHERE inv_id = '$cbxKilosID2' ");
		$reg_kg2 = mysqli_fetch_array($cad_kg2);
		
		$txtKilos2 = $reg_kg2['inv_kg_totales'];
		
		mysqli_query($cnx, "INSERT INTO procesos_materiales(pro_id,inv_id,mat_id,pma_kg,pma_fe_entrada) VALUES('$pro_id','$cbxKilosID2', '$cbxMaterial2',  '$txtKilos2',  '$txtFecha2')") or die(mysqli_error($cnx)." Error al insertar en [".$i."]");
	...
	if($i == 3 and $cbxKilosID3!='' and $cbxMaterial3!='' and $txtKilos3!='')
	{
		...
		$cad_kg2 = mysqli_query($cnx, "SELECT inv_kg_totales FROM inventario WHERE inv_id = '$cbxKilosID3' ");
		$reg_kg2 = mysqli_fetch_array($cad_kg2);
		
		$txtKilos3 = $reg_kg2['inv_kg_totales'];
		
		mysqli_query($cnx, "INSERT INTO procesos_materiales(pro_id,inv_id,mat_id,pma_kg,pma_fe_entrada) VALUES('$pro_id','$cbxKilosID3', '$cbxMaterial3',  '$txtKilos3',  '$txtFecha3')") or die(mysqli_error($cnx)." Error al insertar en [".$i."]");
	...
	{
		$cad_kg2 = mysqli_query($cnx, "SELECT inv_kg_totales FROM inventario WHERE inv_id = '$cbxKilosID4' ");
		$reg_kg2 = mysqli_fetch_array($cad_kg2);
		
		$txtKilos4 = $reg_kg2['inv_kg_totales'];
		
		mysqli_query($cnx, "INSERT INTO procesos_materiales(pro_id,inv_id,mat_id,pma_kg,pma_fe_entrada) VALUES('$pro_id','$cbxKilosID4', '$cbxMaterial4',  '$txtKilos4',  '$txtFecha4')") or die(mysqli_error($cnx)." Error al insertar en [".$i."]");
	...
	if($i == 5 and $cbxKilosID5!='' and $cbxMaterial5!='' and $txtKilos5!='')
	{
		...
		$cad_kg2 = mysqli_query($cnx, "SELECT inv_kg_totales FROM inventario WHERE inv_id = '$cbxKilosID5' ");
		$reg_kg2 = mysqli_fetch_array($cad_kg2);
		
		$txtKilos5 = $reg_kg2['inv_kg_totales'];
		
		mysqli_query($cnx, "INSERT INTO procesos_materiales(pro_id,inv_id,mat_id,pma_kg,pma_fe_entrada) VALUES('$pro_id','$cbxKilosID5', '$cbxMaterial5',  '$txtKilos5',  '$txtFecha5')") or die(mysqli_error($cnx)." Error al insertar en [".$i."]");
	...
	{
		mysqli_query($cnx, "INSERT INTO procesos_materiales(pro_id,inv_id,mat_id,pma_kg,pma_fe_entrada) VALUES('$pro_id','$cbxKilosID6', '$cbxMaterial6',  '$txtKilos6',  '$txtFecha6')") or die(mysqli_error($cnx)." Error al insertar en [".$i."]");
	...
	{
		mysqli_query($cnx, "INSERT INTO procesos_materiales(pro_id,inv_id,mat_id,pma_kg,pma_fe_entrada) VALUES('$pro_id','$cbxKilosID7', '$cbxMaterial7',  '$txtKilos7',  '$txtFecha7')") or die(mysqli_error($cnx)." Error al insertar en [".$i."]");
	...
	{
		mysqli_query($cnx, "INSERT INTO procesos_materiales(pro_id,inv_id,mat_id,pma_kg,pma_fe_entrada) VALUES('$pro_id','$cbxKilosID8', '$cbxMaterial8',  '$txtKilos8',  '$txtFecha8')") or die(mysqli_error($cnx)." Error al insertar en [".$i."]");
...
$flt_total = $txtKilos1 + $txtKilos2 + $txtKilos3 + $txtKilos4 + $txtKilos5;
