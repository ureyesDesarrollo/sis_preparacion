...
$sqlf2g = mysqli_query($cnx, "SELECT * FROM procesos_fase_2_g as pf2g INNER JOIN procesos as p  on(pf2g.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro'") or die(mysql_error()."Error: en consultar procesos_fase_2_g ");
$regf2g= mysqli_fetch_assoc($sqlf2g);

$sqlProAux2 = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regf2g[pro_id]' AND pe_id = '2'") or die(mysql_error()."Error: en consultar procesos auxiliar");
$regProAux2 = mysqli_fetch_assoc($sqlProAux2);


$sqlProLib2 = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regf2g[pro_id]' AND pe_id = '2'") or die(mysql_error()."Error: en consultar procesos de liberacion");
    ...
    <table width="100%" style="margin:20px 0px 20px 0px">
      <tr>
        <td><table border="1" style="background: #FCEFF2;font-size: 12px;width: 100%">
          <tr>
            <td height="45" colspan="10">BLANQUEO. Este proceso se puede hacer con aguar recuperada limpia (pila 1) y limpia</td>
          </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td><table width="100%" border="1">
          ...
          <tr style="font-weight: bold;background: #e6e6e6">
            ...
            <td width="20%" style="font-size: small; text-align: center;">Sosa</td>
             <td width="14%" style="font-size: small; text-align: center;">Peróxido</td>
            <td width="14%" style="font-size: small; text-align: center;">Temp</td>
            <td width="13%" style="font-size: small; text-align: center;">Redox</td>
            <td width="14%" style="font-size: small; text-align: center;">Ácido</td>           
      ...
      <td><table border="1" width="100%">
        ...
        <tr>
         ...
         <tr>
          ...
          <td style="border-bottom:1px solid#fff;border-top:1px solid#fff"></td>
           <td>Peroxido</td>
          <td width="15%" colspan="2"><?php echo $regProLib2['prol_peroxido'] ?></td>
        </tr>
        <tr>
