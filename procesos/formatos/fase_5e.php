...
$sqlfg = mysqli_query($cnx, "SELECT * FROM procesos_fase_5b_g as pfg INNER JOIN procesos as p  on(pfg.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro' AND pfg.pe_id = 24") or die(mysql_error()."Error: en consultar procesos_fase_5b_g ");
...
$sqlProAux = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '24'") or die(mysql_error()."Error: en consultar procesos auxiliar");
$regProAux = mysqli_fetch_assoc($sqlProAux);


$sqlProLib = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '24'") or die(mysql_error()."Error: en consultar procesos de liberacion");
...
<div class="divProcesos">
  <table width="100%" style="margin:20px 0px 20px 0px">
    ...
    <tr>
      <td colspan="3"><table width="100%" border="1">
        ...
        <tr>
          ...
          <td><?php echo fnc_formato_val($regfg['pfg5_temp_ag'])?></td>
        ...
        <tr>
          <td><?php echo $regfg['pfg5_temp']?></td>
    ...
    <tr>
      <td width="53%" valign="top"><table width="661" border="1" style="margin-top: 10px">
        ...
        <tr>
          ...
          <td><?php echo fnc_formato_val($regfd['pfd5_acido'])?></td>
      ...
      <td width="11%" rowspan="3" valign="top"><label for="inputPassword3">Mantener PH</label>
      <?php echo fnc_rango_de(24) ?> - <?php echo fnc_rango_a(24) ?></td>
      <td width="36%" rowspan="3" valign="top"><p>
        <?php 
       ...
       ?>
        ...
        <table width="332" border="1">
          <tr>
          <td width="75" rowspan="6" style="font-size:50px">5e</td>
          <td colspan="2" style="background: #e6e6e6;font-weight: bold;"><p><br />
            Nota: La adición de ácido se agrega por los dos lados del lavador y mantener el PH <?php echo fnc_rango_de(24) ?> - <?php echo fnc_rango_a(24) ?> durante todo el proceso de 1er ácido</p></td>
        </tr>
        <tr>
          <td width="169">Adelgazamiento</td>
          <td width="170"><?php echo $regProLib['prol_adelgasamiento'] ?></td>
        </tr>
        <tr>
          <td>Ph promedio</td>
      ...
      <tr>
        <td valign="top"><table border="1" width="666">
          <tr style="font-weight: bold;">
            <td style="background: #e6e6e6">Ph del agua</td>
            <td style="background: #e6e6e6">Ce del agua</td>
            <td style="background: #e6e6e6"><label for="inputPassword2">Cocido del cuero PH(6.0)</label></td>
          ...
          <tr style="font-weight: bold;">
            ...
            <td width="126" rowspan="2" style="background: #e6e6e6">(<?php echo fnc_hora_de(24) ?> a <?php echo fnc_hora_a(24) ?> horas)</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="8"> Para pasar de 1er ácido a los lavados de 1er ácido del tiempo debe ser de (1 A 3 HRS). El agua de este proceso se manda a agua semilimpia (PILA 2)</td>
          </tr>
        </table></td>
    </tr>
    </table>
