...
<div class="divProcesos">
  <table width="100%" style="margin:20px 0px 20px 0px">
    ...
    <tr>
      <td width="50%" valign="top"><table width="630" border="1" style="margin-top: 10px">
      ...
      <td width="37%" rowspan="3" valign="top"><p>&nbsp;</p>
       <?php 
       ...
       <table width="344" border="1" class="liberacion">
        <tr>
          ...
          <td colspan="2" style="background: #e6e6e6;font-weight: bold;"><p><br />
            Nota: La adición de ácido se agrega por los dos lados del lavador y mantener el PH <?php echo fnc_rango_de(13) ?> - <?php echo fnc_rango_a(13) ?> durante todo el proceso de 1er ácido</p></td>
        </tr>
        <tr>
      ...
      <tr>
        <td valign="top"><table border="1" width="630">
