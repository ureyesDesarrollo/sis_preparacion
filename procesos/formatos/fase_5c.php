    ...
    <tr>
      <td colspan="3" valign="top"><table width="100%" border="1">
        ...
        <tr>
          ...
          <td><?php echo $regfg['pfg5_temp2']?></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td width="50%" valign="top"><table width="620" border="1" style="margin-top: 10px">
      ...
      <td width="6%"><label for="inputPassword3">Mantener PH</label>
      <?php echo fnc_rango_de(13) ?> - <?php echo fnc_rango_a(13) ?></td>
      <td width="44%" rowspan="3" valign="top"><p>
        <?php 
       ...
       ?>
        ...
        <table width="312" border="1">
          <tr>
          <td width="75" rowspan="6" style="font-size:50px">5c</td>
          <td colspan="2" style="background: #e6e6e6;font-weight: bold;"><p><br />
            Nota: La adición de ácido se agrega por los dos lados del lavador y mantener el PH <?php echo fnc_rango_de(12) ?> - <?php echo fnc_rango_a(12) ?> durante todo el proceso de 1er ácido</p></td>
        </tr>
        <tr>
      ...
      <tr>
        <td valign="top"><table border="1" width="623">
          <tr style="font-weight: bold;">
            ...
            <td width="116" style="background: #e6e6e6">Usuario</td>
          </tr>
          <tr>
            <td><?php echo fnc_formato_val($regfg['pfg5_ph_agua'])?></td>
            <td><?php echo fnc_formato_val($regfg['pfg5_ce_agua'])?></td>
            <td><?php echo fnc_formato_val($regfg['pfg5_cocido_ph'])?></td>
            <td><?php echo fnc_nom_usu($usu_aux)?></td>
          </tr>
          <tr style="font-weight: bold;">
            <td width="275" style="background: #e6e6e6">Fecha termina 1er acidificación</td>
            <td width="124" style="background: #e6e6e6">Hora termina </td>
            <td width="182" style="background: #e6e6e6">Agua a</td>
            <td width="116" rowspan="2" style="background: #e6e6e6">(<?php echo fnc_hora_de(12) ?> a <?php echo fnc_hora_a(12) ?> horas)</td>
          </tr>
          <tr>
