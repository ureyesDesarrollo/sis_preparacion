...
<div class="divProcesos">
  <table width="100%" style="margin:20px 0px 20px 0px">
    <tr>
      <td colspan="3"><table class="general" width="92%" border="1" style="background: #FCEFF2;font-size: 12px;">
        <tr>
    ...
    <tr>
      <td colspan="2"><table class="general" width="92%" border="1">
        <tr>
    ...
    <tr>
      <td colspan="2">
        <table class="general" width="1093" border="1" style="margin-top: 10px">
      ...
      <tr>
        <td colspan="2"><table class="general" border="1" width="1096">
          ...
          <tr>
            <td colspan="10">En esta parte son 15 minutos de movimiento y 1:45 horas de reposo durante 18 horas</td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="56%" valign="top"><table width="680" border="1" style="margin-top: 10px">
          <tr style="font-weight: bold;background: #e6e6e6">
        ...
        <td width="44%" rowspan="5" valign="top"><table class="liberacion" width="377" border="1">
          <tr>
      ...
      <tr>
        <td valign="top"><table width="680" border="1">
          <tr style="font-weight: bold;background: #e6e6e6">
      ...
      <tr>
        <td valign="top"><table border="1" width="680">
          <tr style="font-weight: bold;">
