...
$sqlfg = mysqli_query($cnx, "SELECT * FROM procesos_fase_4b_g as pfg INNER JOIN procesos as p  on(pfg.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro' AND pfg.pe_id = 23") or die(mysql_error()."Error: en consultar procesos_fase_4b_g ");
...
$sqlProAux = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '23'") or die(mysql_error()."Error: en consultar procesos auxiliar");
$regProAux = mysqli_fetch_assoc($sqlProAux);


$sqlProLib = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regfg[pro_id]'  AND pe_id = '23'") or die(mysql_error()."Error: en consultar procesos de liberacion");
...
<div class="divProcesos">
  ...
  $agua_a = mysqli_query($cnx, "SELECT * FROM tipos_agua_a WHERE taa_id = '$regfd[taa_id]'") or die(mysql_error()."Error: en consultar el tipo de agua a");
      ...
      <td width="2%" rowspan="3" valign="top"><p>
       ...
       ?>
        ...
        <table width="280" border="1">
          <tr>
          <td width="75" rowspan="5" style="font-size:50px">4d</td>
      ...
      <tr>
        <td valign="top"><table border="1" width="782">
          <tr style="font-weight: bold;">
            ...
            <td width="30" colspan="2" style="background: #e6e6e6" rowspan="2">(<?php echo fnc_hora_de(23) ?> a <?php echo fnc_hora_a(23) ?> horas)</td>
