        ...
        <table width="556" border="1" style="height:100%;margin-top:10px">
		 ...
		 $regG = mysqli_fetch_assoc($sqlG);
          ...
          $regProMat= mysqli_fetch_assoc($sqlProMat);
            ?>
            <tr>
              <td style="font-size: small" align="center"><a href="bitacora_consulta.php?idx_pro=<?php echo $registros['pro_id']; ?>" target="_blank"><!--<img src="../iconos/buscar.png" alt="Consulta"> Consulta --><?php echo $registros['pro_id']; ?></a></td>
