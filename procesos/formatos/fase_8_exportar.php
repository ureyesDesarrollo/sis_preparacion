...
$tbHtml8.= '
      ...
      <tr>
        <td><table border="1" width="699">
          <tr style="font-weight: bold;">
            ...
            <td width="143" rowspan="2" style="background: #e6e6e6">('. fnc_hora_de(20).' a '. fnc_hora_a(20).' horas)</td>
            <td width="143" rowspan="2" style="background: #e6e6e6">Para hacer los lavados finales deben tardar de ('. fnc_hora_de(20).' a '. fnc_hora_a(20).' horas)</td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table border="1" width="701">
          <tr style="font-weight: bold;">
            ...
            <td width="124" rowspan="2" style="background: #e6e6e6">('. fnc_hora_de(20).' a '. fnc_hora_a(20).' horas)</td>
          </tr>
          <tr>
            <td>'.$regfg['pfg8_hr_totales'].'</td>
            <td>'.fnc_nom_usu($usu_aux).'</td>
      ...
      <tr>
        <td><table border="1" width="1031">
          <tr style="font-weight: bold;">
              <td width="296" style="background: #e6e6e6">Fecha sale a producción</td>
              <td width="174" style="background: #e6e6e6">Hora </td>
              <td width="161" style="background: #e6e6e6">Usuario</td>
              <td width="120" rowspan="2" style="background: #e6e6e6">('. fnc_hora_de(20).' a '. fnc_hora_a(20).' horas)</td>
              <td width="120" rowspan="5">&nbsp;</td>
              <td width="120" rowspan="5"><table width="384" border="1">
                <tr>
                  <td width="10" rowspan="13" style="font-size:50px">8</td>
                  <td colspan="4" style="background: #e6e6e6;font-weight: bold;">LIBERACION PH LIBERACIÓN (PH '. fnc_rango_de(20).' a '. fnc_rango_a(20).')</td>
                </tr>
                <tr>
                  <td width="10">Fecha</td>
                  <td width="10">'. fnc_formato_fecha($regProLib['prol_fecha']) .'</td>
                  <td width="10">Hora</td>
                  <td width="10">'.$regProLib['prol_hora'] .'</td>
                </tr>
                <tr>
                  <td>Cocido ph</td>
                  <td>Ce</td>
