...
$sqlfg = mysqli_query($cnx, "SELECT * FROM procesos_fase_4_g as pfg INNER JOIN procesos as p  on(pfg.pro_id=p.pro_id) WHERE p.pro_id  = '$idx_pro'") or die(mysql_error()."Error: en consultar procesos_fase_4_g ");
...
$tbHtml4.= '
<table width="239%" style="background:#F5F4F4">
...
<tr>
<td height="45" colspan="8">PRIMER ÁCIDO. Este proceso se puede hacer con agua de depositos de agua acida (Recupera de 2do ácido)</td>
</tr>
</table></td>
</tr>
<tr>
<td colspan="2"><table width="100%" border="1">
  <tr>
    ...
    <td style="font-weight: bold;background: #e6e6e6">Hora de incio</td>
    <td width="12%"  style="font-weight: bold;background: #e6e6e6">Temp agua utilizada</td>
    <td width="12%"  style="font-weight: bold;background: #e6e6e6">Enzima</td>
  ...
  <tr>
    ...
    <td>'.$regfg['pfg4_enzima'].'</td>
    <td>'.fnc_nom_usu($regfg['usu_id']) .'</td>
  </tr>
  <tr>
    <td  style="font-weight: bold;background: #e6e6e6">Temp</td>
    <td width="20%" style="font-weight: bold;background: #e6e6e6">Acido</td>
...
<tr>
<td width="61%"><table width="96%" border="1">
...
<tr>
<td><table width="890" border="1">
  <tr>
    <td>MANTENER PH 3 - 3.5<br /> (2 a 4 hrs. mov.cont)</td>
  </tr>
</table></td>
</tr>
<tr>
...
<td><table border="1" width="96%">
  <tr style="font-weight: bold;">
    ...
    <td width="111" rowspan="5"><p>';
$usu_aux = $regProAux['usu_sup'];
$usu_proLib = $regProLib['usu_id'];
$tbHtml4.= ' </p>
      <table width="396" border="1">
      <tr>
        <td width="75" rowspan="5" style="font-size:50px">4</td>
        <td colspan="2" style="background: #e6e6e6;font-weight: bold;text-align:justify">Nota: la adición de ácido<br />
          se agrega por los dos<br />
          lados del lavador y<br />
          mantener el ph 3.0 a 5<br />
