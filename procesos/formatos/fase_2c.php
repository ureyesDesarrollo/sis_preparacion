...
$sqlProAux2 = mysqli_query($cnx, "SELECT * FROM procesos_auxiliar WHERE pro_id = '$regf2g[pro_id]' AND pe_id = '4'") or die(mysql_error()."Error: en consultar procesos auxiliar");
$regProAux2 = mysqli_fetch_assoc($sqlProAux2);


$sqlProLib2 = mysqli_query($cnx, "SELECT * FROM procesos_liberacion WHERE pro_id = '$regf2g[pro_id]'  AND pe_id = '4'") or die(mysql_error()."Error: en consultar procesos de liberacion");
    ...
    <table width="100%" style="margin:20px 0px 20px 0px">
      <tr>
        <td><table border="1" style="background: #FCEFF2;font-size: 12px;width: 100%">
          <tr>
            <td height="45" colspan="10">BLANQUEO. Este proceso se puede hacer con aguar recuperada limpia (pila 1) y agua limpia</td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td><table width="100%" border="1">
          <tr>
            <td width="17%" style="font-weight: bold;background: #e6e6e6">Fecha inicia lavados</td>
            <td width="9%" ><?php echo fnc_formato_fecha($regProAux2['proa_fe_ini'])?></td>
            <td width="20%" style="font-weight: bold;background: #e6e6e6">Hora inicio</td>
            <td width="12%"><?php echo $regProAux2['proa_hr_ini']?></td>
            <td width="14%" style="font-weight: bold;background: #e6e6e6">Temp agua utilizada</td>
            <td width="11%" ><?php echo $regf2g['pfg2_temp_ag'] ?></td>
            <td width="10%" style="font-weight: bold;background: #e6e6e6"><span>Ph antes de  ajuste</span></td>
            <td width="7%" ><?php echo $regf2g['pfg2_ph_ant'] ?></td>
          </tr>
          <tr>
            ...
            <td style="font-weight: bold;background: #e6e6e6">Peroxido</td>
      ...
      <tr>
        <td><table width="100%" border="1">
         <tr style="font-weight: bold;border-top:1px solid#fff;border-left:1px solid#fff;border-right:1px solid#fff;">
          ...
          <tr style="font-weight: bold;background: #e6e6e6">
            <td width="5%" style="font-size: small; text-align: center;">No.</td>
            <td width="12%" style="font-size: small; text-align: center;">Hora</td>
            <td width="12%" style="font-size: small; text-align: center;">Ph</td>
            <td width="12%" style="font-size: small; text-align: center;">Sosa</td>
            <td width="12%" style="font-size: small; text-align: center;">Ácido</td>
            <td width="12%" style="font-size: small; text-align: center;">Peróxido</td>
            <td width="12%" style="font-size: small; text-align: center;">Temp</td>
            <td width="15%" style="font-size: small; text-align: center;">Redox</td>
            <td width="8%"  style="font-size: small; text-align: center;">Capturo</td>
          </tr>
          <?php 
           $sqlf2d = mysqli_query($cnx, "SELECT * FROM procesos_fase_2_d as pf2d WHERE pf2d.pfg2_id = '$regf2g[pfg2_id]'") or die(mysql_error()."Error: en consultar el tipo de material");
...
do{
            ...
            <tr>
             ...
             <td><?php echo $regf2d['pfd2_peroxido']?></td>
             <td><?php echo $regf2d['pfd2_temp']?></td>
    ...
    <tr>
      <td><table border="1" width="100%">
        ...
        <tr style="font-weight: bold;">
          ...
          <td  style="border:1px solid#fff;background: #e6e6e6"><?php echo fnc_hora_de(4) ?> a <?php echo fnc_hora_a(4) ?></td>
          <td width="7%" style="border-bottom:1px solid#fff;border-top:1px solid#fff"></td>
          <td rowspan="5" width="30" style="font-size:50px">2c</td>
          <td colspan="3" style="background: #e6e6e6;font-weight: bold;">LIBERACION pH <?php echo fnc_rango_de(4) ?> a <?php echo fnc_rango_a(4) ?></td>
        </tr>
        <tr>
          <td height="20"><?php echo fnc_formato_fecha($regProAux2['proa_fe_fin'])?></td>
