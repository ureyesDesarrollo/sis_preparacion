		...
		$("#formFase7c").submit(function(){
			...
			$.ajax({
				...
				success: function(result) {
					...
					$('#formFase7c').each (function(){this.reset();}); 
...
<div class="divProcesos">
	<form id="formFase7c" name="formFase7c">
	...
	<div class="row">
		<div class="form-row">
			<div class="form-group col-md-3">
				...
				<input type="date" class="form-control" id="txtFeTermA" placeholder="" name="txtFeTermA" value="<?php if($reg_fa['pfg7_fe_fin'] == ''){echo date("Y-m-d"); $str_prop = '';}else{echo $reg_fa['pfg7_fe_fin']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp4; echo " ".$strProp3." ".$strProp4; ?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
				<label for="inputPassword4">Hora termina</label>
				<input type="time" class="form-control" id="txtHrTermA" placeholder="" name="txtHrTermA" value="<?php if($reg_fa['pfg7_hr_fin'] == ''){echo date("H:i"); $str_prop = '';}else{echo $reg_fa['pfg7_hr_fin']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp4; echo " ".$strProp3." ".$strProp4; ?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
				<label for="inputPassword4">Horas totales</label>
				<input  type="text" id="txtHrTotales1" class="form-control" placeholder="Horas totales" name="txtHrTotales1" value="<?php if($reg_fa['pfg7_hr_totales'] == ''){ echo ""; $str_prop = '';}else{echo $reg_fa['pfg7_hr_totales']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp4; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
	...
	<div class="row">
		...
		<div class="form-row">
			<div class="form-group col-md-3" style="width: 290px">
				...
				<input  style="width: 120px" type="text" id="txtPhR1" class="form-control" placeholder="PH" name="txtPhR1" value="<?php if($reg_fa['pfg7_agua_ph'] == ''){ echo ""; $str_prop = '';}else{echo $reg_fa['pfg7_agua_ph']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
				<input style="width: 120px;float: right;margin-top: -30px" type="text" class="form-control" id="txtCeR1" name="txtCeR1" placeholder="CE" value="<?php if($reg_fa['pfg7_agua_ce'] == ''){ echo ""; $str_prop = '';}else{echo $reg_fa['pfg7_agua_ce']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-3" style="width: 300px">
				<label for="inputPassword4">Cocido ph (1.7-2.1) buscar rango inferior</label>
				<input style="width: 120px" type="text" id="txtPhR2" class="form-control" placeholder="PH" name="txtPhR2" value="<?php if($reg_fa['pfg7_cocido_ph'] == ''){ echo ""; $str_prop = '';}else{echo $reg_fa['pfg7_cocido_ph']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
				<input style="width: 120px;float: right;margin-top: -30px" type="text" class="form-control" id="txtCeR2" name="txtCeR2" placeholder="CE" value="<?php if($reg_fa['pfg7_agua_ce'] == ''){ echo ""; $str_prop = '';}else{echo $reg_fa['pfg7_agua_ce']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
	</div>
