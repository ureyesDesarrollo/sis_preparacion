      ...
      <div class="modal-content">
        <form id="formModalP" name="formModalP"> 
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel" style="color:#4AB5B9; font-size:18px; font-weight:bold;">Agregar Paleto "Libre"</h5>
          ...
          <div class="modal-body">       
            <div class="col-md-2">
			  ...
			  <input name="txtProp" type="hidden" id="txtProp" value="<?php echo $_POST['prop'] ?>" readonly="true" class="form-control"/>
          </div>
         <div class="col-md-2">
		...
		<div class="col-md-2">
          ...
          <input type="text" class="form-control" id="txtPaleto" name="txtPaleto"  readonly="true" value="<?php echo $_POST['paleto'] ?>">
        </div>
          <div class="col-md-2">
            <label for="recipient-name" class="col-form-label">Paleto:</label>
			<select id="cbxPaleto" class="form-control"  name="cbxPaleto" required>
				...
				$cadena =  mysqli_query($cnx,"SELECT * from preparacion_paletos where le_id = 2");
		  ...
		  <div class="col-md-4">
			...
			<select id="cbxProceso" class="form-control"  name="cbxProceso">
				<option value="">Seleccionar</option>
				<?php 
				$html = '';
				
				$cadena =  mysqli_query($cnx,"SELECT * from preparacion_tipo WHERE pt_estatus = 'A' AND pt_para = 'M' ORDER BY pt_descripcion");
				$registros =  mysqli_fetch_array($cadena);
