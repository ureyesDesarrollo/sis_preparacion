			...
			if(intban == 0)
			{
				...
				$.ajax({
					...
					success: function(result) {
						...
						alertas("#alerta-errorFase8bOpe", 'Listo!', data["mensaje"], 1, true, 5000);
						$('#formFase8b').each (function(){this.reset();}); 
...
<div class="divProcesos">
	<form id="formFase8b" name="formFase8b">
...
<div class="row footerdivProcesos" style="margin-bottom: 10px;">
	...
	<div class="form-group col-md-7">
		<div class="alert alert-info hide" id="alerta-errorFase8bOpe" style="height: 40px;width: 420px;text-align: left;z-index: 10;font-size: 10px;margin-bottom: -10px">
	...
	<?php if($_SESSION['privilegio'] == 4){	?>
		...
		<div class="col-md-1">
			<button type="button" class="btn btn-success" id="editar" onClick="javascript:AbreModalE8b(<?php echo $reg_pro['pro_id'] ?>, 21);"> 
				<img src="../iconos/edit.png" alt="">Editar
			</button>
		</div>
		<div class="col-md-2" style="width: 110px">
			<button type="button" class="btn btn-success" id="permitir" onClick="javascript:AbreModalAgregarR(<?php echo $reg_pro['pro_id'] ?>, 21, <?php echo $valUltRen ?>);"> <img src="../iconos/add.png" alt="">Renglon
			</button>
		</div>
	<?php } ?>
