		...
		$("#formFase5b").submit(function(){
			...
			$.ajax({
				...
				success: function(result) {
					...
					$('#formFase5b').each (function(){this.reset();}); 
...
<form id="formFase5b" name="formFase5b">
...
<!--barra botones-->
	...
	<i><label style="margin-left:20px;color: red"> * Los campos "Tipo Agua" y "HR ini llenado" deben ser capturados juntos</label></i>
		...
		<div class="form-group col-md-3">
			<div class="alert alert-info hide" id="alerta-errorFase5bOpe" style="height: 40px;width: 350px;text-align: left;z-index: 10;font-size: 10px;">
