        ...
        <div class="modal-body" id="cargar_quimicos">
            ...
            <div class="row">
             ...
             <div class="col-md-4">
              <select readonly id="cbx_quimico<?php echo $i  ?>" class="form-control" name="cbx_quimico<?php echo $i; ?>" >
                ...
                <?php 
                $cadena =  mysqli_query($cnx,"SELECT * from quimicos ORDER BY quimico_descripcion");
              ...
              <div class="col-md-3">
                <input readonly type="text" placeholder="Lote" class="form-control"  id="txt_lote_quim<?php echo $i ?>" name="txt_lote_quim<?php echo $i ?>" value="<?php echo $reg_quim['quim_lote'] ?>" >
              </div>

              <div class="col-md-2">
                <input readonly type="text" placeholder="Litro" class="form-control" onKeyPress="return isNumberKey(event, this);" id="txt_litro_quim<?php echo $i ?>" name="txt_litro_quim<?php echo $i ?>" value="<?php echo $reg_quim['quim_litros'] ?>" >
              </div>
            </div>
            <?php 
          ...
          for ($i=1; $i <= $res ; $i++) { ?>
           <div class="row">
            ...
            <div class="col-md-3">
              <input type="text" placeholder="Lote" class="form-control" id="txt_lote_quim<?php echo $i ?>" name="txt_lote_quim<?php echo $i ?>" value="<?php echo $reg_quim['quim_lote'] ?>" >
            </div>

            <div class="col-md-2">
              <input type="text" placeholder="Litro" class="form-control" onKeyPress="return isNumberKey(event, this);" id="txt_litro_quim<?php echo $i ?>" name="txt_litro_quim<?php echo $i ?>" value="<?php echo $reg_quim['quim_litros'] ?>" >
            </div>
          </div>
        <?php }  ?>
      </div>
