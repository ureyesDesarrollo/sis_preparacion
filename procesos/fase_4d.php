		...
		<table border="0" cellspacing="5" cellpadding="5">
			...
			?>
					<tr>
						...
						<td><input type="text" class="form-control" id="<?php echo "txtPpm" . $i ?>" name="<?php echo "txtPpm" . $i ?>" value="<?php if ($reg_fad['pfd4_ppm'] == '') {
																																				echo "";
																																				$str_prop = '';
																																			} else {
		...
		<div class="row">
			...
			<div class="form-row">
				<div class="form-group col-md-2">
					...
					<input type="text" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if ($reg_fa['pfg4_horas_reales'] == '') {
																																		echo "";
																																		$str_prop = '';
																																	} else {
