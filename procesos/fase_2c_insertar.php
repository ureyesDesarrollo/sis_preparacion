...
else
{
	for($i = 1; $i <= 15; $i++)
	{
		...
		{
			mysqli_query($cnx, "INSERT INTO procesos_fase_2_d(pfg2_id, pfd2_ren, pfd2_hr, pfd2_ph, pfd2_sosa, pfd2_acido,pfd2_peroxido, pfd2_temp, pfd2_redox, usu_id, pfd2_fe_hr_sys) VALUES('$hdd_pfg', '$txtRen', '$txtHr', '$txtPh', '$txtSosa', '0', '$txtPeroxido', '$txtTemp', '$txtRedox', '".$_SESSION['idUsu']."', SYSDATE() ) ") or die(mysqli_error($cnx)." Error al insertar ".$i);
