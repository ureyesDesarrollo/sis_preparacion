...
<script>
	...
	{	
		$("#formFase6d").submit(function(){

			var formData = $(this).serialize();
			$.ajax({
				url: "fase_6d_insertar.php",
				type: 'POST',
				data: formData,
				success: function(result) {

					data = JSON.parse(result);
					alertas("#alerta-errorFase6dOpe", 'Listo!', data["mensaje"], 1, true, 5000);
					$('#formFase6d').each (function(){this.reset();}); 
...
<div class="divProcesos">
	<form id="formFase6d" name="formFase6d">
		...
		<table border="0" cellspacing="5" cellpadding="5">
			...
			for($i = 1; $i <=10; $i++){ 
				...
				if($i <= 4 or $bolVal == 'Si' ){
					...
					<tr>
						...
						<td><input type="hidden" class="form-control" id="<?php echo "txtRen".$i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen".$i ?>">
							...
							<select id="cbxTipAg<?php echo $i  ?>" class="form-control" style="width: 170px" name="cbxTipAg<?php echo $i  ?>" <?php if($reg_fad['tpa_id'] == ''){echo ""; $str_prop = '';}else{ $str_prop = 'disabled';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>>
				...
				//mysqli_free_result($registros);
						...
						<td align="center">
							<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 170px" name="cbxAgua<?php echo $i  ?>" <?php if($reg_fad['taa_id'] == ''){echo ""; $str_prop = '';}else{ $str_prop = 'disabled';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3." ".$strProp4; ?> >
								<option value="">Seleccionar</option>
								<?php 
	...
	<div class="row">
		...
		<div class="col-md-2">
			...
			<input type="text" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if($reg_fa['pfg6_horas_reales'] == ''){ echo ""; $str_prop = '';}else{echo $reg_fa['pfg6_horas_reales']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
		</div>
	</div>
	<div class="form-row">
		<div class="form-group col-md-2">
...
<div class="row footerdivProcesos" style="margin-bottom: 10px;">
		<!--<div class="row" style="margin-top: 20px">
			<div class="col-md-6">
				Para pasar de lavados de 1er ácido a 2do ácido el tiempo debe ser de  (1 A 3).
				En agua de este proceso se manda a agua recuperada semilimpia (PILA 2)
			</div>-->
			<!--<div class="col-md-2">
			...
			<div class="form-group col-md-7">
				<div class="alert alert-info hide" id="alerta-errorFase6dOpe" style="height: 40px;width: 270px;text-align: left;z-index: 10;font-size: 10px; margin-bottom: -10px">
			...
			<?php if($_SESSION['privilegio'] == 4){	?>
				...
				<div class="col-md-1">
					<button type="button" class="btn btn-success" id="editar" onClick="javascript:AbreModalE6d(<?php echo $reg_pro['pro_id'] ?>, 25);"> 
						<img src="../iconos/edit.png" alt="">Editar
					</button>
				</div>
				<div class="col-md-2" style="width: 110px">
					<button type="button" class="btn btn-success" id="permitir" onClick="javascript:AbreModalAgregarR(<?php echo $reg_pro['pro_id'] ?>, 25, <?php echo $valUltRen ?>);"> <img src="../iconos/add.png" alt="">Renglon
					</button>
				</div>
			<?php } ?>
