...
<script language="javascript">
	...
	{	
		$("#formFase8cE").submit(function(){
			...
			$.ajax({
				url: "editar/fase_8c_actualizar.php",
				type: 'POST',
				data: formData,
...
<div class="modal-dialog modal-lg" role="document" style="width: 1210px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form id="formFase8cE" name="formFase8cE">
	...
	<div class="row">
		...
		<div class="col-md-3 divEtapas8" style="height: 250px">
			...
			<div class="col-md-2 divEtapasInput8" >
				...
				<input type="text" id="txtSolides" name="txtSolides" class="form-control" placeholder="% de solides" v value="<?php if($reg_lib['prol_solides'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_lib['prol_solides']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?>>
