...
/*	a = 6;
	...
	{
		$("#formFase1bE").submit(function(){

			var formData = $(this).serialize();
			$.ajax({
				url: "editar/fase_1b_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {

					data = JSON.parse(result);
					alertas("#alerta-errorFase1bEOpe", 'Listo!', data["mensaje"], 1, true, 5000);
					$('#formFase1bE').each (function(){this.reset();});  
	...
	//Bloquear boton guardar
		function confirmEnviar5() {
			...
			formFase1bE.btn.disabled = true; 
			formFase1bE.btn.value = "Enviando...";

			setTimeout(function(){
				formFase1bE.btn.disabled = true;
				formFase1bE.btn.value = "Guardar";
			},2000);
...
<div class="modal-dialog modal-lg" role="document" style="width: 1210px">
	...
	<form id="formFase1bE" name="formFase1bE">
		...
		<?php //if($_SESSION['privilegio'] == 3 ){?>
			<div class="row" style="margin-bottom: 10px">
				...
				<div class="col-md-2 tiempos">
					<input type="date" class="form-control" id="txtFeIni" name="txtFeIni" placeholder="__________" value="<?php if($reg_aux['proa_fe_ini'] == ''){ echo date("Y-m-d"); $str_prop = 'disabled';}else{echo $reg_aux['proa_fe_ini']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
				</div>

				<label class="col-md-1" style="width: 110px">Hora inicio</label>
				<div class="col-md-2 tiempos">
					<input type="time" class="form-control" id="txtHrIni" name="txtHrIni" placeholder="__________" value="<?php if($reg_aux['proa_hr_ini'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_aux['proa_hr_ini']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
				</div>

				<!--<label class="col-md-1" style="width: 165px">Temp agua utilizada</label>
				<div class="col-md-2 tiempos">
					<input type="text" class="form-control" id="txtTemp" name="txtTemp" placeholder="TEMP" value="<?php /*if($reg_fa1['pfg1_temp_ag'] == ''){echo ""; $str_prop = '';}else{echo $reg_fa1['pfg1_temp_ag']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;*/ ?> required>
				</div>-->
			...
			<div class="row" style="margin-bottom: 10px">
				...
				<div class="col-md-2 tiempos">
					<input type="text" class="form-control" id="txtAgIni" name="txtAgIni" placeholder="Ph agua inicio" value="<?php if($reg_fa1['pfg1_ph_agua'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa1['pfg1_ph_agua']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?>  required>
				</div>
				<label class="col-md-2" style="width: 150px">Ce agua de inicio</label>
				<div class="col-md-2 tiempos">
					<input type="text" class="form-control" id="txtCeIni" name="txtCeIni" placeholder="Ce agua de inicio" value="<?php if($reg_fa1['pfg1_ce_agua'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa1['pfg1_ce_agua']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
				</div>
			</div>
			<!---->
			...
			<div>
				<table border="0" cellspacing="5" cellpadding="5">
					...
					for($i = 1; $i <=10; $i++){ 
						...
						if($i == 2 and $reg_fad1['pfd1_ce'] == ''){$strVal = '';}/*else{$strVal = 'NO';}*/
						...
						<tr>
							...
							<td><input type="hidden" class="form-control" id="<?php echo "txtRen".$i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen".$i ?>">
								<select id="cbxTipAg<?php echo $i  ?>" class="form-control" style="width: 150px" name="cbxTipAg<?php echo $i  ?>" <?php if($reg_fad1['tpa_id'] == ''){echo ""; $str_prop = 'disabled';}else{ $str_prop = '';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>>
				...
				//mysqli_free_result($registros);
								...
								<td><input type="text" class="form-control" id="<?php echo "txtTemp".$i ?>" name="<?php echo "txtTemp".$i ?>" value="<?php if($reg_fad1['pfd1_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad1['pfd1_temp']; $str_prop = '';} ?>" <?php echo $str_prop;  echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> size="5" placeholder="Temp"></td>
								<td><input type="time" class="form-control" id="<?php echo "txtHraIni".$i ?>" name="<?php echo "txtHraIni".$i ?>" value="<?php if($reg_fad1['pfd1_hr_ini'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad1['pfd1_hr_ini']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> ></td>
								<td><input type="time" class="form-control" id="<?php echo "txtHraFin".$i ?>" name="<?php echo "txtHraFin".$i ?>" value="<?php if($reg_fad1['pfd1_hr_fin'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad1['pfd1_hr_fin']; $str_prop = '';} ?>" <?php echo $str_prop;  echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4;?>></td>
								<td><input type="time" class="form-control" id="<?php echo "txtHraIniMov".$i ?>" name="<?php echo "txtHraIniMov".$i ?>" value="<?php if($reg_fad1['pfd1_hr_ini_mov'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad1['pfd1_hr_ini_mov']; $str_prop = '';} ?>" <?php echo " ".$str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?>></td>
								<td><input type="time" class="form-control" id="<?php echo "txtHraFinMov".$i ?>" name="<?php echo "txtHraFinMov".$i ?>" value="<?php if($reg_fad1['pfd1_hr_fin_mov'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad1['pfd1_hr_fin_mov']; $str_prop = '';} ?>" <?php echo " ".$str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?>></td>
								<td><input type="text" class="form-control" id="<?php echo "txtPh".$i ?>" name="<?php echo "txtPh".$i ?>" value="<?php if($reg_fad1['pfd1_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad1['pfd1_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="pH"></td>
								<td align="center"><input <?php if($fltVal >= $reg_fad1['pfd1_ce'] and $reg_fad1['pfd1_ce'] != ''){?>style="background-color:#66FF66;"<?php }?>	type="text" class="form-control" id="<?php echo "txtCe".$i ?>" name="<?php echo "txtCe".$i ?>" value="<?php if($reg_fad1['pfd1_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad1['pfd1_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" style="width:50px;" placeholder="Ce"></td> 
								<td align="center">
										<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 150px" name="cbxAgua<?php echo $i  ?>" <?php if($reg_fad1['tpa_id'] == ''){echo ""; $str_prop = 'disabled';}else{ $str_prop = '';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>>
												<option value="">Seleccionar</option>
												<?php 
				...
				//mysqli_free_result($registros);
								...
								<td><input type="text" class="form-control" id="<?php echo "txtObs".$i ?>" name="<?php echo "txtObs".$i ?>" value="<?php if($reg_fad1['pfd1_observaciones'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad1['pfd1_observaciones']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="Observaciones"></td>
							</tr>
						<?php 
						$valUltRen = $i;
						}//termina if
...
<!--barra botones-->
			<div class="row footerdivProcesos" style="margin-bottom: 10px">
				...
				<div class="form-group col-md-6">
					<div class="alert alert-info hide" id="alerta-errorFase1bEOpe" style="height: 40px;width: 270px;text-align: left;z-index: 10;font-size: 10px;margin-bottom: -10px">
		...
		<?php /*if($_SESSION['privilegio'] == 4){	?>
			...
			<img src="../iconos/add.png" alt=""> Agregar material</button><?php }?>
				...
				<div class="col-md-2" style="width: 110px">
					<button type="button" class="btn btn-success" id="permitir" onClick="javascript:AbreModalAgregarR(<?php echo $reg_pro['pro_id'] ?>, 1, <?php echo $valUltRen ?>);"> <img src="../iconos/add.png" alt="">Renglon
					</button>
				</div>
			<?php } */?>
