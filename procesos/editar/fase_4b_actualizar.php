...
for($i = 1; $i <= 8; $i++)
{
	...
	{
		mysqli_query($cnx, "UPDATE procesos_fase_4_d SET pfd4_acido = '$txtAcidoF', pfd4_ph = '$txtPhF', pfd4_temp = '$txtTempF' WHERE pfg4_id = '$hdd_pfg' AND pfd4_ren = '$txtRen' ") or die(mysqli_error($cnx)." Error al actualizar el renglon ".$i);
	}
}
