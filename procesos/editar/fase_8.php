...
<script language="javascript">
	...
	{
		$("#formFase8E").submit(function(){

			var formData = $(this).serialize();
			$.ajax({
				url: "editar/fase_8_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {

					data = JSON.parse(result);
					alertas("#alerta-errorFase8EOpe", 'Listo!', data["mensaje"], 1, true, 5000);
					$('#formFase8E').each (function(){this.reset();});  
...
function confirmEnviar5() {
	...
	formFase8E.btn.disabled = true; 
	formFase8E.btn.value = "Enviando...";

	setTimeout(function(){
		formFase8E.btn.disabled = true;
		formFase8E.btn.value = "Guardar";
	},2000);
...
<div class="modal-dialog modal-lg" role="document" style="width: 1210px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form id="formFase8E" name="formFase8E">
						...
						if($i <= 4 or $bolVal == 'Si' ){
							...
							<tr>
								...
								<td>
									...
									<td><input type="text" class="form-control" id="<?php echo "txtMov".$i ?>" name="<?php echo "txtMov".$i ?>" size="7" placeholder="Mov" value="<?php if($reg_fad['pfd8_mov'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd8_mov']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
									<td>MIN</td>
									...
									<td><input type="text" name="txtPh<?php echo $i; ?>" id="txtPh<?php echo $i; ?>" class="form-control" placeholder="PH"  value="<?php if($reg_fad['pfd8_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd8_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /> </td>
									<td><input type="text" name="txtCe<?php echo $i; ?>" id="txtCe<?php echo $i; ?>" class="form-control" placeholder="CE" value="<?php if($reg_fad['pfd8_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd8_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /></td>
									<td><input type="text" name="txtTemp<?php echo $i; ?>" id="txtTemp<?php echo $i; ?>" class="form-control" placeholder="TEMP" value="<?php if($reg_fad['pfd8_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd8_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /></td>
									<td align="center">
				...
				//mysqli_free_result($registros);
									...
									<td><input type="text" class="form-control" id="<?php echo "txtObs".$i ?>" name="<?php echo "txtObs".$i ?>" value="<?php if($reg_fad['pfd8_observaciones'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd8_observaciones']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="Observaciones"></td>
								</tr>
								<?php
								$valUltRen = $i;
   }//termina if
...
<div class="col-md-12">
	...
	<div class="col-md-1 tiempos" style="margin-left: 20px;width: 130px">
		...
		<input  type="text" id="txtHrTotales1" class="form-control" placeholder="Horas totales" name="txtHrTotales1" value="<?php if($reg_fa['pfg8_hr_totales'] == 'disabled'){ echo ""; $str_prop = '';}else{echo $reg_fa['pfg8_hr_totales']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp3;?>>
	</div>
...
<div class="col-md-8" style="border: 1px solid#e6e6e6;border-radius: 5px;background: #e6e6e6;margin-left: 20px;margin-top: 10px;margin-bottom: 10px">
	<div class="col-md-4 tiempos" style="margin-left: -25px;">
		...
		<input  type="text" id="txtHrasTotales" class="form-control" placeholder="Horas totales" name="txtHrasTotales" value="<?php if($reg_fa['pfg8_hr_totales2'] == ''){ echo fnc_horas($strFech, date("Y-m-d"), $strHr, date("H:i")); $str_prop = 'disabled';}else{echo $reg_fa['pfg8_hr_totales2']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp3;?>>
	</div>
	<div class="col-md-2 tiempos" style="margin-left: 20px">
		<label>Revisó</label>
	...
	<div class="col-md-12">
		<div class="col-md-2 tiempos" style="margin-left: -10px;width: 220px">
			...
			<input type="date" class="form-control" id="txtFeLibProd" name="txtFeLibProd" placeholder="" value="<?php if($reg_fa['pfg8_fe_lib_prod'] == ''){echo date("Y-m-d"); $str_prop = 'disabled';}else{echo $reg_fa['pfg8_fe_lib_prod']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp3; ?>>
		</div>
		<div class="col-md-2 tiempos" style="margin-left: 20px;">
			<label>Hora</label>
	...
	<div class="row">
		...
		<div class="col-md-3 divEtapas8" style="height: 250px">
			<div class="col-md-1 etapa" style="height: 250px">
				<p class="numEtapa">8</p>
			</div>
			<div class="col-md-2 divEtapasInput8" >
				<label class="etiquetaEtapa">COCIDO LIBERACIÓN ( PH <?php echo fnc_rango_de(20) ?> - <?php echo fnc_rango_a(20) ?>)</label>
				...
				<select  type="text" id="cbxColor"   name="cbxColor" class="form-control" placeholder="Colores"value="<?php if($reg_lib['prol_color'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_lib['prol_color']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?> >
	...
	<div class="row footerdivProcesos"  style="margin-bottom: 10px;">
		...
		<div class="form-group col-md-7">
			<div class="alert alert-info hide" id="alerta-errorFase8EOpe" style="height: 40px;width: 270px;text-align: left;z-index: 10;font-size: 10px;margin-bottom: -10px">
