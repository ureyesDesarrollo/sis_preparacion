...
<script>
	...
	$(document).ready(function()
	{
		$("#formFase4bE").submit(function(){
			...
			$.ajax({
				url: "editar/fase_4b_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {
					...
					$('#formFase4bE').each (function(){this.reset();}); 
...
<form id="formFase4bE" name="formFase4bE">
	...
	<input name="hdd_pfg" type="hidden" id="hdd_pfg" value="<?php echo $reg_fa['pfg4_id']; ?>"/>
		...
		<div class="row" style="margin-bottom: 30px">
			...
			<div class="col-md-2">
				...
				<select  type="text" id="cbxAcidoF" class="form-control" placeholder="Acido" name="cbxAcidoF" <?php if($reg_fa['pfg4_acido_fuerte'] == ''){ echo ""; $str_prop = 'disabled';}else{$str_prop = '';} ?> <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;?> required>
