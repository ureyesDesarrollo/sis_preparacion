...
<script>
	...
	$(document).ready(function()
	{
		$("#formFase5bE").submit(function(){
			...
			$.ajax({
				url: "editar/fase_5b_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {
					...
					$('#formFase5bE').each (function(){this.reset();}); 
...
<div class="modal-dialog modal-lg" role="document" style="width: 1100px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form id="formFase5bE" name="formFase5bE">
							...
							if($i <= 4 or $bolVal == 'Si' ){
								...
								<tr>
									...
									<td align="center"><input 
										...
										type="text" class="form-control" id="<?php echo "txtCe".$i ?>" name="<?php echo "txtCe".$i ?>" value="<?php if($reg_fad['pfd5_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd5_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" style="width:50px;" placeholder="Ce"></td>
	...
	<div class="row">
		...
		<div class="form-row">
			<!--<div class="form-group col-md-1">
				...
				<select id="cbxTipAg" class="form-control" style="width: 250px" name="cbxTipAg" <?php if($reg_fa['taa_id'] == ''){echo ""; $str_prop = 'disabled';}else{ $str_prop = '';} echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?> >
					<option value="">Seleccionar</option>
					<?php 
