...
/*	a = 6;
	...
	$(document).ready(function()
	{
		$("#formFase6bE").submit(function(){
			...
			$.ajax({
				url: "editar/fase_6b_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {
					...
					$('#formFase6bE').each (function(){this.reset();});  
...
<div class="modal-dialog modal-lg" role="document" style="width: 1100px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form id="formFase6bE" name="formFase6bE">
						...
						if($i <= 4 or $bolVal == 'Si' ){
							...
							<tr>
								...
								<td>
									...
									<td <?php if($fltVal >= $reg_fad['pfd6_ce'] and $reg_fad['pfd6_ce'] != ''){?>style="background-color:#66FF66;"<?php }?> width="150" align="center"><input type="text" class="form-control" id="<?php echo "txtCe".$i ?>" name="<?php echo "txtCe".$i ?>" value="<?php if($reg_fad['pfd6_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" style="width:100px;" placeholder="Ce"></td>
