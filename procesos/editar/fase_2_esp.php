...
<script>
	...
	function agregarCampoFase2(){
		...
		document.getElementById('camposFase2').appendChild(div);document.getElementById('camposFase2').appendChild(div);
	}*/
	...
	$(document).ready(function()
	{
		$("#formFase2E").submit(function(){
			...
			$.ajax({
				url: "editar/fase_2_insertar_esp.php",
				type: 'POST',
				data: formData,
				success: function(result) {
					...
					$('#formFase2E').each (function(){this.reset();});  
...
<form id="formFase2E" name="formFase2E">
	...
	<?php //if($_SESSION['privilegio'] == 3 ){?>
	 	<div class="row" style="margin-bottom: 10px">
			...
			<div class="col-md-2 tiempos">
				<input type="text" class="form-control" id="txtTemp" placeholder="TEMP" name="txtTemp" value="<?php echo $reg_fa['pfg2_temp_ag']; ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
	</div>	
	...
	<div class="row" style="margin-bottom: 30px">
			...
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPhAnt" placeholder="PH" name="txtPhAnt" value="<?php echo $reg_fa['pfg2_ph_ant'];?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			
			<label class="col-md-1" style="width: 40px">CE</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtCe" placeholder="CE" name="txtCe" value="<?php echo $reg_fa['pfg2_ce']; ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			
			<label class="col-md-1" style="width: 160px">Ajuste con SOSA</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtAjSosa" placeholder="SOSA"  name="txtAjSosa" value="<?php echo $reg_fa['pfg2_sosa']; ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			<!--<label>LTS</label>-->
			
			<label class="col-md-1" style="width: 210px">pH ajustado (11 A 11.3)</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPhAj" placeholder="PH" name="txtPhAj" value="<?php echo $reg_fa['pfg2_ph_aju']; ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			
			<label class="col-md-1" style="width: 90px">Peroxido</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPeroxido" placeholder="Peroxido" name="txtPeroxido" value="<?php echo $reg_fa['pfg2_peroxido']; ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
...
if($i <= 5 or $bolVal == 'Si' ){
  ...
  <tr>
    ...
    <td><input type="time" readonly class="form-control" id="txtHr<?php echo $i; ?>" placeholder="" name="txtHr<?php echo $i; ?>" value="<?php if($reg_fad['pfd2_hr'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad['pfd2_hr']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    <td><input type="text" readonly class="form-control" id="txtPh<?php echo $i; ?>" placeholder="Ph" name="txtPh<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> <?php if($fltVal >= $reg_fad['pfd2_ph'] and $reg_fad['pfd2_ph'] != ''){?>style="background-color:#66FF66;"<?php }?>></td>
    <td><input type="text" readonly class="form-control" id="txtSosa<?php echo $i; ?>" placeholder="Sosa" name="txtSosa<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_sosa'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_sosa']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    <td><input type="text" readonly class="form-control" id="txtPeroxido<?php echo $i; ?>" placeholder="Temp" name="txtPeroxido<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_peroxido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_peroxido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    <td><input type="text" readonly class="form-control" id="txtTemp<?php echo $i; ?>" placeholder="Temp" name="txtTemp<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    <td align="center" bgcolor="#FF6493" width="100"><input type="text" readonly class="form-control" id="txtRedox<?php echo $i; ?>" placeholder="Redox" name="txtRedox<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_redox'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_redox']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    <td><input type="text" readonly class="form-control" id="txtAcidoX<?php echo $i; ?>" placeholder="Acido" name="txtAcidoX<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_acido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_acido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    </tr>
  <?php $valUltRen = $i;
  }//termina if
		...
		<?php //if($_SESSION['privilegio'] == 6 ){?>
			<div class="col-md-3 divEtapas" style="height: 170px">
				...
				<div class="col-md-2 divEtapasInput">
					...
					<select  type="text" id="cbxColor" class="form-control" placeholder="Colores" name="cbxColor" <?php if($reg_lib['prol_color'] == ''){ echo ""; $str_prop = 'disabled';}else{echo "<option value='$reg_lib[prol_color]'>$reg_lib[prol_color]</option>"; $str_prop = '';} ?> <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?>>
					...
					<input  type="text" id="txtPhLib" class="form-control" placeholder="Ph liberacion" name="txtPhLib" value="<?php if($reg_lib['prol_ph'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_lib['prol_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?>>
					...
					<input  type="text" id="txtPeroxidoL" class="form-control" placeholder="Peroxido" name="txtPeroxidoL" value="<?php if($reg_lib['prol_peroxido'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_lib['prol_peroxido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?>>
	...
	<div class="row" style="margin-top: 20px">
			...
			<div class="form-row">
				<div class="form-group col-md-2">
					...
					<input type="date" readonly class="form-control" id="txtFeTerm" placeholder="" name="txtFeTerm" value="<?php if($reg_aux['proa_fe_fin'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_aux['proa_fe_fin']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-2">
					<label for="inputPassword4">Hora termina</label>
					<input type="time" readonly class="form-control" id="txtHrTerm" placeholder="" name="txtHrTerm" value="<?php if($reg_aux['proa_hr_fin'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_aux['proa_hr_fin']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
				</div>
			</div>
