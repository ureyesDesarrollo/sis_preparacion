	...
	*/
	$(document).ready(function()
	{
		$("#formFase1E").submit(function(){
			...
			$.ajax({
				url: "editar/fase_1_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {
					...
					$('#formFase1E').each (function(){this.reset();});  
...
<div class="modal-dialog modal-lg" role="document" style="width: 1210px">
	<div class="modal-content">
		<div class="divProcesos1">
			<form id="formFase1E" name="formFase1E">
				...
				<?php //if($_SESSION['privilegio'] == 3 ){?>
					<div class="row" style="margin-bottom: 10px">
						...
						<div class="col-md-2 tiempos">
							<input type="text" class="form-control" id="txtTemp" name="txtTemp" placeholder="TEMP" value="<?php if($reg_fa1['pfg1_temp_ag'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa1['pfg1_temp_ag']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
						</div>
								...
								if($i <= 6 or $bolVal == 'Si' ){
									...
									<tr>
										...
										<td><input type="hidden" class="form-control" id="<?php echo "txtRen".$i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen".$i ?>">
											<!--<input type="text" class="form-control" id="<?php /*echo "txtLavTipAgua".$i ?>" name="<?php echo "txtLavTipAgua".$i ?>"  value="<?php if($reg_fad1['pfd1_tipo_ag'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad1['pfd1_tipo_ag']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo $strProp4;*/ ?> size="5">-->
				...
				//mysqli_free_result($registros);
										...
										<td align="center"><input 
											<?php if($fltVal >= $reg_fad1['pfd1_ce'] and $reg_fad1['pfd1_ce'] != ''){?>style="background-color:#66FF66;"<?php }?>
											type="text" class="form-control" id="<?php echo "txtCe".$i ?>" name="<?php echo "txtCe".$i ?>" value="<?php if($reg_fad1['pfd1_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad1['pfd1_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" style="width:50px;" placeholder="Ce"></td>
											<!--agregado cc 11-08-2021-->
									<td align="center">
										<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 150px" name="cbxAgua<?php echo $i  ?>" <?php if($reg_fad1['taa_id'] == ''){echo ""; $str_prop = 'disabled';}else{ $str_prop = '';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>>
...
<!--				<div class="col-md-4">
		...
		<div class="col-md-2" style="float: right;margin-top: -40px;margin-right:80px">
			<input type="button" class="btn btn-success" id="permitir" value="+ Renglon" onClick="javascript:AbreModalAgregarR(<?php echo $reg_pro['pro_id'] ?>, 1, <?php echo $valUltRen ?>);"/> 
		</div>
	<?php }*/ ?>
