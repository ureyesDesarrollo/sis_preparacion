...
{	
	$("#formFase5eE").submit(function(){

		var formData = $(this).serialize();
		$.ajax({
			url: "editar/fase_5e_actualizar.php",
			type: 'POST',
			data: formData,
			success: function(result) {

				data = JSON.parse(result);
				alertas("#alerta-errorFase5eEOpe", 'Listo!', data["mensaje"], 1, true, 5000);
				$('#formFase5eE').each (function(){this.reset();}); 
	...
	//Bloquear boton guardar
		function confirmEnviar5() {
			...
			formFase5eE.btn.disabled = true; 
			formFase5eE.btn.value = "Enviando...";

			setTimeout(function(){
				formFase5eE.btn.disabled = true;
				formFase5eE.btn.value = "Guardar";
			},2000);
...
<form id="formFase5eE" name="formFase5eE">
	...
	<div class="row" style="margin-bottom: 20px">
		...
		<label class="col-md-2" style="width: 170px">SOL ACIDA FUERTE</label>
			<div class="col-md-2">
				...
				<select  type="text" id="cbxAcidoF" class="form-control" placeholder="Acido" name="cbxAcidoF" <?php if($reg_fa['pfg5_acido_fuerte'] == ''){ echo ""; $str_prop = 'disabled';}else{$str_prop = '';} ?> <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;?> required>
	...
	<!--<div class="row">
		...
		<div class="col-md-3 divEtapas" style="height: 250px;">
			...
			<div class="col-md-2 divEtapasInput" style="width: 200px">
				...
				<select  type="text" id="cbxAdel" class="form-control" placeholder="Adelgasamiento" name="cbxAdel" <?php if($reg_lib['prol_adelgasamiento'] == ''){ echo ""; $str_prop = 'disabled';}else{$str_prop = '';} ?> <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?>>
	...
	<div class="row">
		...
		<div class="form-row">
			<div class="form-group col-md-2">
				...
				<input type="text" class="form-control" id="txtCeG" placeholder="Ce" name="txtCeG" value="<?php if($reg_fa['pfg5_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-3">
	...
	<div class="row">
		...
		<div class="col-md-2">
			...
			<input type="text" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if($reg_fa['pfg5_hr_reales'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_hr_reales']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
		</div>
	</div>
	<!---->
...
<!--barra botones-->	
	<div class="row footerdivProcesos" style="margin-bottom: 10px">
		...
		<div class="form-group col-md-4">
			<div class="alert alert-info hide" id="alerta-errorFase5eEOpe" style="height: 40px;width: 270px;text-align: left;z-index: 10;font-size: 10px;">
