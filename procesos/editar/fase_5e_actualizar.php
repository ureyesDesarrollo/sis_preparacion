...
mysqli_query($cnx, "UPDATE procesos_fase_5b_g SET pfg5_temp_ag = '$txtTemp', pfg5_temp = '$txtTemp2', pfg5_acido = '$txtAcido', pfg5_termina = '$txtTermina', pfg5_temp2 = '$txtTemp3', pfg5_acido_fuerte = '$cbxAcidoF', pfg5_cocido_ph = '$txtCocido', taa_id = '$cbxAgua', pfg5_ce_agua = '$txtCeAgua', pfg5_ph_agua = '$txtPhAgua', pfg5_ce = '$txtCeG', pfg5_hr_reales = '$txtHrsReales' WHERE pro_id = '$hdd_pro_id' AND pe_id = '$hdd_pe_id' ") or die(mysqli_error($cnx)." Error al actualizar 2");
