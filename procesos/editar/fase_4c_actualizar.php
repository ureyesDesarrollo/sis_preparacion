...
mysqli_query($cnx, "UPDATE procesos_fase_4b_g SET pfg4_temp_ag = '$txtTemp' WHERE pro_id = '$hdd_pro_id' AND pe_id = '$hdd_pe_id' ") or die(mysqli_error($cnx)." Error al actualizar 2");
