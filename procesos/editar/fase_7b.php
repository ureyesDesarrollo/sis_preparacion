...
<script language="javascript">
		...
		$("#formFase7bE").submit(function(){
			...
			$.ajax({
				...
				success: function(result) {
					...
					alertas("#alerta-errorFase7bEOpe", 'Listo!', data["mensaje"], 1, true, 5000);
					$('#formFase7bE').each (function(){this.reset();});  
	...
	//Bloquear boton guardar
		function confirmEnviar5() {
			...
			formFase7bE.btn.disabled = true; 
			formFase7bE.btn.value = "Enviando...";

			setTimeout(function(){
				formFase7bE.btn.disabled = true;
				formFase7bE.btn.value = "Guardar";
			},2000);
...
<form id="formFase7bE" name="formFase7bE">
	...
	<!---->
			...
			for($i = 1; $i <=8; $i++){ 
				...
				<tr>
					...
					<td align="center" bgcolor="#FFCF00"><input type="text" class="form-control" id="<?php echo "txtPhF".$i ?>" name="<?php echo "txtPhF".$i ?>" size="5" value="<?php if($reg_fad['pfd7_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd7_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="pH"></td>
	...
	<div class="row">
		<div class="form-row">
			<div class="form-group col-md-3">
				...
				<input type="date" class="form-control" id="txtFeTermA" placeholder="" name="txtFeTermA" value="<?php if($reg_fa['pfg7_fe_fin'] == ''){echo date("Y-m-d"); $str_prop = 'disabled';}else{echo $reg_fa['pfg7_fe_fin']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
				<label for="inputPassword4">Hora termina</label>
				<input type="time" class="form-control" id="txtHrTermA" placeholder="" name="txtHrTermA" value="<?php if($reg_fa['pfg7_hr_fin'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fa['pfg7_hr_fin']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
				<label for="inputPassword4">Horas totales</label>
				<input  type="text" id="txtHrTotales1" class="form-control" placeholder="Horas totales" name="txtHrTotales1" value="<?php if($reg_fa['pfg7_hr_totales'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg7_hr_totales']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
  ...
  <?php }?>
	...
	<div class="row">
		...
		<div class="form-row">
			<div class="form-group col-md-3" style="width: 290px">
				...
				<input  type="text" id="txtPhR1" class="form-control" placeholder="PH" name="txtPhR1" value="<?php if($reg_fa['pfg7_agua_ph'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg7_agua_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-3" style="width: 300px">
				<label for="inputPassword4">Cocido ph (1.7-2.1) buscar rango inferior</label>
				<input  type="text" id="txtPhR2" class="form-control" placeholder="PH" name="txtPhR2" value="<?php if($reg_fa['pfg7_cocido_ph'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg7_cocido_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;;?>>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="form-row">
			<div class="form-group col-md-2">
				<label for="inputPassword4">Hora termina</label>
				<input type="time" class="form-control" id="txtHrTerm" placeholder="" name="txtHrTerm" value="<?php if($reg_aux['proa_hr_fin'] == ''){echo ""; $str_prop = '';}else{echo $reg_aux['proa_hr_fin']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
...
<!--barra botones-->
	<div class="row footerdivProcesos" style="margin-bottom: 10px">
		...
		<div class="form-group col-md-4">
			<div class="alert alert-info hide" id="alerta-errorFase7bEOpe" style="height: 40px; width: 270px; text-align: left; z-index: 10; font-size: 10px;">
