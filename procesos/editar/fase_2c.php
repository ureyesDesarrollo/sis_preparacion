...
/*	function AbreModalE2c(proceso, etapa){
		...
		$(document).ready(function()
	{
		$("#formFase2cE").submit(function(){
			...
			var formData = $(this).serialize();
			$.ajax({
				url: "editar/fase_2c_actualizar.php",
				type: 'POST',
				data: formData,
				success: function(result) {
					...
					$('#formFase2cE').each (function(){this.reset();});  
					//setTimeout(location.reload(), 23000);
					setTimeout("location.reload()", 2000);	 
				}
			});
...
<form id="formFase2cE" name="formFase2cE">
	...
	<div class="row" style="margin-bottom: 30px">
			...
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPhAnt" placeholder="" name="txtPhAnt" value="<?php if($reg_fa['pfg2_ph_ant'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_ph_ant']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			
			<label class="col-md-1" style="width: 40px">CE</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtCe" placeholder="" name="txtCe" value="<?php if($reg_fa['pfg2_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			
			<label class="col-md-1" style="width: 160px">Ajuste con SOSA</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtAjSosa" placeholder=""  name="txtAjSosa" value="<?php if($reg_fa['pfg2_temp_ag'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_temp_ag']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			<!--<label>LTS</label>-->
			
			<label class="col-md-1" style="width: 210px">pH ajustado (11.5 A 12.5)</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPhAj" placeholder="" name="txtPhAj" value="<?php if($reg_fa['pfg2_ph_aju'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_ph_aju']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
...
if($i <= 10 or $bolVal == 'Si' ){
  ...
  <tr>
    ...
    <td><input type="text" class="form-control" id="txtPh<?php echo $i; ?>" placeholder="pH" name="txtPh<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
	...
	<!--<td><input type="text" class="form-control" id="txtAcido<?php echo $i; ?>" placeholder="Acido" name="txtAcido<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_acido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_acido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>-->
    ...
    <td align="center" bgcolor="#FF6493" width="100"><?php if($i < 5){?><input type="text" class="form-control" id="txtRedox<?php echo $i; ?>" placeholder="Redox" name="txtRedox<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_redox'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_redox']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>><?php }?></td>
    <td>&nbsp;</td>
    </tr>
  <?php $valUltRen = $i+1;
  }//termina if
