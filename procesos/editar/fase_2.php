...
<script>
	...
	$(document).ready(function()
	{
		$("#formFase2E").submit(function(){
			...
			$.ajax({
				url: "editar/fase_2_actualizar.php",
				type: 'POST',
				data: formData,
...
<form id="formFase2E" name="formFase2E">
	...
	<?php //if($_SESSION['privilegio'] == 3 ){?>
	 	<div class="row" style="margin-bottom: 10px">
			...
			<div class="col-md-2 tiempos">
				<input type="text" class="form-control" id="txtTemp" placeholder="TEMP" name="txtTemp" value="<?php if($reg_fa['pfg2_temp_ag'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_temp_ag']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
	</div>	
	...
	<div class="row" style="margin-bottom: 30px">
			...
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPhAnt" placeholder="PH" name="txtPhAnt" value="<?php if($reg_fa['pfg2_ph_ant'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_ph_ant']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			
			<label class="col-md-1" style="width: 40px">CE</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtCe" placeholder="CE" name="txtCe" value="<?php if($reg_fa['pfg2_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			
			<label class="col-md-1" style="width: 160px">Ajuste con SOSA</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtAjSosa" placeholder="SOSA"  name="txtAjSosa" value="<?php if($reg_fa['pfg2_temp_ag'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_temp_ag']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			<!--<label>LTS</label>-->
			
			<label class="col-md-1" style="width: 210px">pH ajustado (11 A 11.3)</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPhAj" placeholder="PH" name="txtPhAj" value="<?php if($reg_fa['pfg2_ph_aju'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_ph_aju']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			
			<label class="col-md-1" style="width: 90px">Peroxido</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPeroxido" placeholder="Peroxido" name="txtPeroxido" value="<?php if($reg_fa['pfg2_peroxido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg2_peroxido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
...
if($i <= 5 or $bolVal == 'Si' ){
  ...
  <tr>
    ...
    <td><input type="time" class="form-control" id="txtHr<?php echo $i; ?>" placeholder="" name="txtHr<?php echo $i; ?>" value="<?php if($reg_fad['pfd2_hr'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fad['pfd2_hr']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    ...
    <td><input type="text" class="form-control" id="txtSosa<?php echo $i; ?>" placeholder="Sosa" name="txtSosa<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_sosa'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_sosa']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    <td><input type="text" class="form-control" id="txtPeroxido<?php echo $i; ?>" placeholder="Temp" name="txtPeroxido<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_peroxido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_peroxido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    <td><input type="text" class="form-control" id="txtTemp<?php echo $i; ?>" placeholder="Temp" name="txtTemp<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
    ...
    <!--<td><input type="text" class="form-control" id="txtAcidoX<?php echo $i; ?>" placeholder="Acido" name="txtAcidoX<?php echo $i; ?>" size="5" value="<?php if($reg_fad['pfd2_acido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd2_acido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>-->
    </tr>
  <?php $valUltRen = $i;
  }//termina if
