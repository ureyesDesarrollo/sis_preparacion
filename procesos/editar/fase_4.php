...
<script>
	...
	function agregarCampo4(){
		...
		document.getElementById('camposFase4').appendChild(div);document.getElementById('camposFase4').appendChild(div);
	}
	
$(document).ready(function()
{	
	$("#formFase4E").submit(function(){

		var formData = $(this).serialize();
		$.ajax({
			url: "editar/fase_4_actualizar.php",
			type: 'POST',
			data: formData,
			success: function(result) {

				data = JSON.parse(result);
				alertas("#alerta-errorFase4EOpe", 'Listo!', data["mensaje"], 1, true, 5000);
				$('#formFase4E').each (function(){this.reset();}); 
	...
	//Bloquear boton guardar
		function confirmEnviar5() {
			...
			formFase4E.btn.disabled = true; 
			formFase4E.btn.value = "Enviando...";

			setTimeout(function(){
				formFase4E.btn.disabled = true;
				formFase4E.btn.value = "Guardar";
			},2000);
...
<form id="formFase4E" name="formFase4E">
	...
	<input name="hdd_pfg" type="hidden" id="hdd_pfg" value="<?php echo $reg_fa['pfg4_id']; ?>"/>
		...
		<div class="row" style="margin-bottom: 10px">
			...
			<div class="col-md-2 tiempos">
				<input type="text" class="form-control" id="txtTemp" name="txtTemp" placeholder="TEMP" value="<?php if($reg_fa['pfg4_temp_ag'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg4_temp_ag']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			<label class="col-md-1" style="width: 110px">ENZIMA</label>
			<div class="col-md-1 tiempos">
				<input type="text" class="form-control" id="txtEnzima" name="txtEnzima" placeholder="ENZIMA" value="<?php if($reg_fa['pfg4_enzima'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg4_enzima']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
		</div>
		<!---->
		...
		<div class="row" style="margin-bottom: 30px">
			...
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtTemp2" name="txtTemp2" placeholder="TEMP" value="<?php if($reg_fa['pfg4_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg4_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			<label class="col-md-1" style="width: 50px">ACIDO</label>
			<div class="col-md-1" style="margin-right: -25px">
				<input type="text" class="form-control" id="txtAcido" name="txtAcido" placeholder="ACIDO" value="<?php if($reg_fa['pfg4_acido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg4_acido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			...
			<div class="col-md-2">
				...
				<select  type="text" id="cbxAcidoF" class="form-control" placeholder="Acido" name="cbxAcidoF" <?php if($reg_fa['pfg4_acido_fuerte'] == ''){ echo ""; $str_prop = 'disabled';}else{$str_prop = '';} ?> <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;?>>
					    <?php if($reg_fa['pfg4_acido_fuerte'] != ''){echo "<option value='$reg_fa[pfg4_acido_fuerte]'>$reg_fa[pfg4_acido_fuerte]</option>"; } ?>
			...
			<div class="col-md-2">
				<input type="text" class="form-control" id="txtTermina" name="txtTermina" placeholder="TERMINA" value="<?php if($reg_fa['pfg4_termina'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg4_termina']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
			<label class="col-md-1" style="width: 50px">TEMP</label>
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtTemp3" name="txtTemp3" placeholder="TEMP" value="<?php if($reg_fa['pfg4_temp2'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg4_temp2']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
			</div>
		</div>
		<div class="col-md-6">
		<!---->
		<table border="0" cellspacing="0" cellpadding="0">
			...
			for($i = 1; $i <=8; $i++){ 
				...
				<tr>
					...
					<td><input type="text" class="form-control" id="<?php echo "txtAcidoF".$i ?>" name="<?php echo "txtAcidoF".$i ?>" size="5" value="<?php if($reg_fad['pfd4_acido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd4_acido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="Acido"></td>
					<td>LTS</td>
					<td><input type="text" class="form-control" id="<?php echo "txtPhF".$i ?>" name="<?php echo "txtPhF".$i ?>" size="5" value="<?php if($reg_fad['pfd4_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd4_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="pH"></td>
					<td><input type="text" class="form-control" id="<?php echo "txtPhBF".$i ?>" name="<?php echo "txtPhBF".$i ?>" size="5" value="<?php if($reg_fad['pfd4_ph_b'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd4_ph_b']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="pH B"></td>
					<td><input type="text" class="form-control" id="<?php echo "txtTempF".$i ?>" name="<?php echo "txtTempF".$i ?>" size="5" value="<?php if($reg_fad['pfd4_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd4_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="Temp"></td>
		...
		<div class="col-md-12">
			<div class="form-row">
				<div class="form-group col-md-2">
					...
					<input type="text" class="form-control" id="txtCocido" placeholder="Cocido" name="txtCocido" value="<?php if($reg_fa['pfg4_cocido_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg4_cocido_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-2">
					<label for="inputPassword4">Ce</label>
					<input type="text" class="form-control" id="txtCeG" placeholder="Ce" name="txtCeG" value="<?php if($reg_fa['pfg4_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg4_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-2">
...
<!--barra botones-->
	<div class="row footerdivProcesos" style="margin-bottom: 10px">
		<div class="form-group col-md-9">
			<div class="alert alert-info hide" id="alerta-errorFase4EOpe" style="height: 40px;width: 270px;text-align: left;z-index: 10;font-size: 10px;">
