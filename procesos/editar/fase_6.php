...
/*	a = 6;
	...
	{	
		$("#formFase6E").submit(function(){
			...
			$.ajax({
				url: "editar/fase_6_actualizar.php",
				type: 'POST',
				data: formData,
...
<div class="modal-dialog modal-lg" role="document" style="width: 1100px">
	<div class="modal-content">
		<div class="divProcesos">
			<form id="formFase6E" name="formFase6E">
				...
				<div class="row" style="margin-bottom: 10px">
					...
					<div class="col-md-1 tiempos">
						<input type="text" class="form-control" id="txtTemp" name="txtTemp" placeholder="TEMP" value="<?php if($reg_fa['pfg6_temp_ag'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_temp_ag']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
					</div>
					<label class="col-md-1" style="width: 120px">Ácido diluido</label>
					<div class="col-md-2">
						<select  type="text"  id="cbxDiluido" class="form-control" placeholder="Ácido fuerte" name="cbxDiluido" <?php if($reg_fa['pfg6_acido_diluido'] == ''){ echo ""; $str_prop = 'disabled';}else{$str_prop = '';} ?> <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;?> required>
				...
				<div class="row" style="margin-bottom: 30px">
					...
					<div class="col-md-1">
						<input type="text" class="form-control" id="txtTemp2" name="txtTemp2" placeholder="TEMP" value="<?php if($reg_fa['pfg6_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
					</div>

					<label class="col-md-1" style="width: 50px">ACIDO</label>
					<div class="col-md-1">
						<input type="text" class="form-control" id="txtAcido" name="txtAcido" placeholder="Acido" value="<?php if($reg_fa['pfg6_acido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_acido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
					</div>
					<label class="col-md-1">LTS</label>
					<label class="col-md-1" style="width: 50px">PH</label>
					<div class="col-md-1">
						<input type="text" class="form-control" id="txtPh" name="txtPh" placeholder="PH" value="<?php if($reg_fa['pfg6_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
					</div>
					<!--<label>LTS</label>-->

					<label class="col-md-1" style="width: 50px">TEMP</label>
					<div class="col-md-1">
						<input type="text" class="form-control" id="txtTemp3" name="txtTemp3" placeholder="TEMP" value="<?php if($reg_fa['pfg6_temp2'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_temp2']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
					</div>
					<label class="col-md-1">NORMALIDAD</label>
					<div class="col-md-1">
						<input type="text" class="form-control" id="txtNorm" name="txtNorm" placeholder="Norm" value="<?php if($reg_fa['pfg6_norm'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_norm']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
					</div>
				...
				<table border="0" cellspacing="5" cellpadding="5">
					...
					for($i = 1; $i <=8; $i++){ 
						...
						<tr>
							...
							<td><input type="text" class="form-control" id="<?php echo "txtAcidoF".$i ?>" name="<?php echo "txtAcidoF".$i ?>" size="5" value="<?php if($reg_fad['pfd6_acido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_acido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="Acido"></td>
							<td>LTS</td>
							<td><input type="text" class="form-control" id="<?php echo "txtTempF".$i ?>" name="<?php echo "txtTempF".$i ?>" size="5" value="<?php if($reg_fad['pfd6_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="Temp"></td>
							<td align="center" bgcolor="#FFCF00"><input type="text" class="form-control" id="<?php echo "txtPhF".$i ?>" name="<?php echo "txtPhF".$i ?>" size="5" value="<?php if($reg_fad['pfd6_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="pH"></td>
							<td><input type="text" class="form-control" id="<?php echo "txtCeF".$i ?>" name="<?php echo "txtCeF".$i ?>" size="5" value="<?php if($reg_fad['pfd6_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="Ce"></td>
							<td><input type="text" class="form-control" id="<?php echo "txtNormF".$i ?>" name="<?php echo "txtNormF".$i ?>" size="5" value="<?php if($reg_fad['pfd6_norm'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_norm']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="Norm"></td>
						</tr>
					<?php }?>
				</table>
	...
	<div class="row">
		<div class="form-row">
			<div class="form-group col-md-3">
				...
				<input type="date" class="form-control" id="txtFeTermS" placeholder="" name="txtFeTermS" value="<?php if($reg_fa['pfg6_fe_fin'] == ''){echo date("Y-m-d"); $str_prop = 'disabled';}else{echo $reg_fa['pfg6_fe_fin']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
				<label for="inputPassword4">Hora termina</label>
				<input type="time" class="form-control" id="txtHrTermS" placeholder="" name="txtHrTermS" value="<?php if($reg_fa['pfg6_hr_fin'] == ''){echo date("H:i"); $str_prop = 'disabled';}else{echo $reg_fa['pfg6_hr_fin']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
				<label for="inputPassword4">Hora totales</label>
				<input type="text" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if($reg_fa['pfg6_hr_totales'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_hr_totales']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-3">
	...
	<table border="0" cellspacing="5" cellpadding="5">
		...
		for($i = 1; $i <=6; $i++){
			...
			<tr>
				...
				<td><input type="time" id="txtIniMovD<?php echo $i; ?>" name="txtIniMovD<?php echo $i; ?>" class="form-control" value="<?php if($reg_fad['pfd6_ini_mov'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_ini_mov']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /> </td>
				<td>HRS</td>
				<td><input type="time" id="txtIniRepD<?php echo $i; ?>" name="txtIniRepD<?php echo $i; ?>" class="form-control" value="<?php if($reg_fad['pfd6_ini_reposo'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_ini_reposo']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>/></td>
				<td>HRS</td>
				<?php if($i <= 3){ ?>
					<td><input type="text" name="txtPhD<?php echo $i; ?>" id="txtPhD<?php echo $i; ?>" class="form-control" placeholder="PH"  value="<?php if($reg_fad['pfd6_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /> </td>
					<td><input type="text" name="txtCeD<?php echo $i; ?>" id="txtCeD<?php echo $i; ?>" class="form-control" placeholder="CE" value="<?php if($reg_fad['pfd6_ce'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_ce']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /></td>
					<td><input type="text" name="txtNormD<?php echo $i; ?>" id="txtNormD<?php echo $i; ?>" class="form-control" placeholder="NORM" value="<?php if($reg_fad['pfd6_norm'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_norm']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /></td>
					<td><input type="text" name="txtTempD<?php echo $i; ?>" id="txtTempD<?php echo $i; ?>" class="form-control" placeholder="TEMP" value="<?php if($reg_fad['pfd6_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd6_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /></td>
				<?php }else{ ?>
					<td colspan="4">&nbsp;</td>
				<?php }?>
			</tr>
		...
		<div class="row" style="margin-bottom: 50px">
			<div class="col-md-12">
				...
				<div class="col-md-2 tiempos" style="width: 150px">
					<input type="time" class="form-control" id="txtHrIniCo" name="txtHrIniCo" placeholder="Hrs inicia" value="<?php if($reg_fa['pfg6_hr_cocido'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_hr_cocido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
				</div>
			</div>
			<div class="col-md-12">
				<div class="col-md-5 tiempos" style="margin-left: -10px">
			...
			<div class="col-md-12">
				...
				<div class="col-md-1 tiempos">aqui
					<input type="text" class="form-control" id="txtPh2F" name="txtPh2F" placeholder="Ph" value="<?php if($reg_fa['pfg6_ph2'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_ph2']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
				</div>
				<div class="col-md-1" style="width: 60px">
					<label>CE</label>
				</div>
				<div class="col-md-1 tiempos">
					<input type="text" class="form-control" id="txtCe2F" name="txtCe2F" placeholder="Ce" value="<?php if($reg_fa['pfg6_ce2'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_ce2']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
				</div>
				<div class="col-md-1" style="width: 60px;margin-left: 220px">
					<label>PH</label>
				</div>
				<div class="col-md-1 tiempos">
					<input type="text" class="form-control" id="txtPh3F" name="txtPh3F" placeholder="Ph" value="<?php if($reg_fa['pfg6_ph3'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_ph3']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
				</div>
				<div class="col-md-1" style="width: 60px">
					<label>CE</label>
				</div>
				<div class="col-md-1 tiempos">
					<input type="text" class="form-control" id="txtCe3F" name="txtCe3F" placeholder="Ce" value="<?php if($reg_fa['pfg6_ce3'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_ce3']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
				</div>
			</div>
		</div>
		<!---->
