...
mysqli_query($cnx, "UPDATE procesos_fase_3b_g SET pfg3_temp_ag = '$txtTemp', pfg3_lts = '$txtSosa', pfg3_ph = '$txtPh', pfg3_norm = '$txtNorm', pfg3_temp = '$txtTemp', pfg3_hr_totales = '$txtHrasTot' WHERE pro_id = '$hdd_pro_id' ") or die(mysqli_error($cnx)." Error al actualizar 2");
