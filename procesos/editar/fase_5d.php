...
{	
	$("#formFase5dE").submit(function(){
		...
		$.ajax({
			url: "editar/fase_5c_actualizar.php",
			type: 'POST',
			data: formData,
...
<form id="formFase5dE" name="formFase5dE">
	...
	<div class="row" style="margin-bottom: 20px">
		...
		<div class="col-md-2 tiempos">
			<input type="text" class="form-control" id="txtTemp" name="txtTemp" placeholder="TEMP" value="<?php if($reg_fa['pfg5_temp_ag'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_temp_ag']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
		</div>
	</div>
	<div class="row" style="margin-bottom: 20px">
		...
		<div class="col-md-1 tiempos">
			<input type="text" class="form-control" id="txtTemp2" name="txtTemp2" placeholder="TEMP" value="<?php if($reg_fa['pfg5_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
		</div>
		<label class="col-md-1" >Ácido</label>
		<div class="col-md-1 tiempos">
			<input type="text" class="form-control" id="txtAcido" name="txtAcido" placeholder="Acido" value="<?php if($reg_fa['pfg5_acido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_acido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
		</div>
		<label class="col-md-1" >Lts</label>
		<label class="col-md-1" >Termina</label>
		<div class="col-md-1 tiempos">
			<input type="text" class="form-control" id="txtTermina" name="txtTermina" placeholder="Termina" value="<?php if($reg_fa['pfg5_termina'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_termina']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
		</div>
		<label class="col-md-1" >Temp</label>
		<div class="col-md-1 tiempos">
			<input type="text" class="form-control" id="txtTemp3" name="txtTemp3" placeholder="TEMP" value="<?php if($reg_fa['pfg5_temp2'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_temp2']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; ?> required>
		</div>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			...
			for($i = 1; $i <=8; $i++){ 
				...
				<tr>
					...
					<td><input type="text" class="form-control" id="<?php echo "txtAcidoF".$i ?>" name="<?php echo "txtAcidoF".$i ?>" size="5" value="<?php if($reg_fad['pfd5_acido'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd5_acido']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="Acido"></td>
					<td>LTS</td>
					<td><input type="text" class="form-control" id="<?php echo "txtPhF".$i ?>" name="<?php echo "txtPhF".$i ?>" size="5" value="<?php if($reg_fad['pfd5_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd5_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="pH"></td>
					<td><input type="text" class="form-control" id="<?php echo "txtPhBF".$i ?>" name="<?php echo "txtPhBF".$i ?>" size="5" value="<?php if($reg_fad['pfd5_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd5_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="pH B"></td>
					<td><input type="text" class="form-control" id="<?php echo "txtTempF".$i ?>" name="<?php echo "txtTempF".$i ?>" size="5" value="<?php if($reg_fad['pfd5_temp'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fad['pfd5_temp']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> placeholder="Temp"></td>
				</tr>
			<?php }?>
		</table>
</div>
	...
	<div class="row">
		<div class="form-row">
			<div class="form-group col-md-2">
				...
				<input type="text" class="form-control" id="txtPhAgua" name="txtPhAgua" placeholder="Ph Agua" value="<?php if($reg_fa['pfg5_ph_agua'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_ph_agua']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
				<label for="inputPassword4">CE del agua</label>
				<input type="text" class="form-control" id="txtCeAgua" name="txtCeAgua" placeholder="Ce Agua" value="<?php if($reg_fa['pfg5_ce_agua'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_ce_agua']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-3">
				<label for="inputPassword4">Cocido del cuero PH(5.0)</label>
				<input type="text" class="form-control" id="txtCocido" placeholder="Cocido" name="txtCocido" value="<?php if($reg_fa['pfg5_cocido_ph'] == ''){echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg5_cocido_ph']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4; ?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-3">
