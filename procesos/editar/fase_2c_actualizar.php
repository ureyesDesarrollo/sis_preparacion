...
for($i = 1; $i <= 15; $i++)
{
	...
	{
		mysqli_query($cnx, "UPDATE procesos_fase_2_d SET pfd2_hr = '$txtHr', pfd2_ph = '$txtPh', pfd2_sosa = '$txtSosa', pfd2_acido = '0',pfd2_peroxido = '$txtPeroxido', pfd2_temp = '$txtTemp', pfd2_redox = '$txtRedox' WHERE pfg2_id = '$hdd_pfg' AND pfd2_ren = '$txtRen' ") or die(mysqli_error($cnx)." Error al actualizar el renglon ".$i);
	}
}
