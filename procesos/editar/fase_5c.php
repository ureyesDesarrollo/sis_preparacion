...
/*	a = 6;
		...
		$("#formFase5cE").submit(function(){
			...
			$.ajax({
				...
				success: function(result) {
					...
					alertas("#alerta-errorFase5cEOpe", 'Listo!', data["mensaje"], 1, true, 5000);
					$('#formFase5cE').each (function(){this.reset();});  
	...
	//Bloquear boton guardar
		function confirmEnviar5() {
			...
			formFase5cE.btn.disabled = true; 
			formFase5cE.btn.value = "Enviando...";

			setTimeout(function(){
				formFase5cE.btn.disabled = true;
				formFase5cE.btn.value = "Guardar";
			},2000);
...
<form id="formFase5cE" name="formFase5cE">
...
<!--barra botones-->
	...
	<div class="form-group col-md-3">
			<div class="alert alert-info hide" id="alerta-errorFase5cEOpe" style="height: 40px;width: 270px;text-align: left;z-index: 10;font-size: 10px;">
