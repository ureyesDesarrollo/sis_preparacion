...
{	
	$("#formFase6dE").submit(function(){
		...
		$.ajax({
			url: "editar/fase_6d_actualizar.php",
			type: 'POST',
			data: formData,
			success: function(result) {
				...
				$('#formFase6dE').each (function(){this.reset();}); 
...
<form id="formFase6dE" name="formFase6dE">
	...
	<div class="row">
		...
		<div class="form-row">
			...
			<div class="col-md-2">
				...
				<input type="text" class="form-control" id="txtHrsReales" name="txtHrsReales" placeholder="Hrs reales" value="<?php if($reg_fa['pfg6_horas_reales'] == ''){ echo ""; $str_prop = 'disabled';}else{echo $reg_fa['pfg6_horas_reales']; $str_prop = '';} ?>" <?php echo $str_prop; echo " ".$strProp6; echo " ".$strProp3." ".$strProp4;?>>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-2">
