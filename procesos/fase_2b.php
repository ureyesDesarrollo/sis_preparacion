...
<script>
	...
	function quimicos_2b(proceso, etapa) {
		...
		$.ajax({
			type: 'post',
			url: '../procesos/quimicos/modal_quimicos.php',
			data: datos,
			success: function(result) {
...
<div class="divProcesos">
	<form id="formFase2b" name="formFase2b">
		...
		<div class="row" style="margin-bottom: 20px">
			...
			<div class="col-md-1 tiempos">
				<input type="text" class="form-control" id="txtEnzima" placeholder="Kg" name="txtEnzima" value="<?php if ($reg_fa['pfg2_enzima'] == '') {
																													echo "";
																													$str_prop = '';
																												} else {
			...
			<div class="col-md-1 tiempos">
				<input type="text" class="form-control" id="txtTemp" placeholder="" name="txtTemp" value="<?php if ($reg_fa['pfg2_temp_ag'] == '') {
																												echo "";
																												$str_prop = '';
																											} else {
		...
		<div class="row">
				...
				<table border="0" cellspacing="5" cellpadding="5">
					...
					?>
						<tr>
							...
							<td><input type="time" class="form-control" id="<?php echo "txtHoraD" . $i ?>" name="<?php echo "txtHoraD" . $i ?>" value="<?php if ($reg_fad['pfd2_hr'] == '') {
																																						echo date("H:i");
																																						$str_prop = '';
																																					} else {
																																						...
																																						$str_prop = 'disabled';
																																																																						...
																																																																						echo " " . $strProp3;
																																																																						echo " " . $strProp4; ?>></td>
							<td><input style="width: 70px" type="text" class="form-control" id="<?php echo "txtPhD" . $i ?>" name="<?php echo "txtPhD" . $i ?>" value="<?php if ($reg_fad['pfd2_ph'] == '') {
																																										echo "";
																																										$str_prop = '';
																																									} else {
							...
							<td><input type="text" class="form-control" id="<?php echo "txtSosaD" . $i ?>" name="<?php echo "txtSosaD" . $i ?>" value="<?php if ($reg_fad['pfd2_sosa'] == '') {
																																						echo "";
																																						$str_prop = '';
																																					} else {
																																						...
																																						$str_prop = 'disabled';
																																																																				...
																																																																				echo " " . $strProp2;
																																																																				echo " " . $strProp3;
																																																																				echo " " . $strProp4; ?> size="5" placeholder="Sosa"></td>
							<td><input type="text" class="form-control" id="txtAcidoD<?php echo $i; ?>" name="txtAcidoD<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_acido'] == '') {
																																								echo "";
																																								$str_prop = '';
																																							} else {
			...
			<div class="col-md-7">
				<div style="height: 30px; border-radius: 5px; border:1px solid #e6e6e6; margin-bottom: 3px; font-weight:bold; background-color:#CCCCCC;width: 320px;text-align: center;width: 630px">
				...
				<div class="form-group col-md-2">
					<input type="text" class="form-control" id="txtPhS1" name="txtPhS1" value="<?php if ($reg_fa['pfg2_ph1'] == '') {
																									echo "";
																									$str_prop = '';
																								} else {
																									...
																									$str_prop = 'disabled';
																																																							...
																																																							echo " " . $strProp1;
																																																							echo " " . $strProp2; ?>>
					<input type="text" class="form-control" id="txtPhS2" name="txtPhS2" value="<?php if ($reg_fa['pfg2_ph2'] == '') {
																									echo "";
																									$str_prop = '';
																								} else {
																									echo $reg_fa['pfg2_ph2'];
																									$str_prop = 'disabled';
																								} ?>" <?php echo $str_prop;
																																																							echo " " . $strProp1;
																																																							echo " " . $strProp2; ?>>
				...
				<div class="form-group col-md-2">
					<input type="text" class="form-control" style="margin-bottom: 5px" id="txtHoraS1" name="txtHoraS1" value="<?php if ($reg_fa['pfg2_hr1'] == '') {
																																	echo "";
																																	$str_prop = '';
																																} else {
																																	echo $reg_fa['pfg2_hr1'];
																																	$str_prop = 'disabled';
																																} ?>" <?php echo $str_prop;
																																																														echo " " . $strProp1;
																																																														echo " " . $strProp2; ?>>
					<input type="text" class="form-control" style="margin-bottom: 10px" id="txtHoraS2" name="txtHoraS2" value="<?php if ($reg_fa['pfg2_hr2'] == '') {
																																	echo "";
																																	$str_prop = '';
																																} else {
																																	echo $reg_fa['pfg2_hr2'];
																																	$str_prop = 'disabled';
																																} ?>" <?php echo $str_prop;
																																																															echo " " . $strProp1;
																																																															echo " " . $strProp2; ?>>
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					?>
						<tr>
							...
							<td><input type="time" class="form-control" id="<?php echo "txtHora2" . $i ?>" name="<?php echo "txtHora2" . $i ?>" value="<?php if ($reg_fad['pfd22_hr'] == '') {
																																						echo date("H:i");
																																						$str_prop = '';
																																					} else {
																																						echo $reg_fad['pfd22_hr'];
																																						$str_prop = 'disabled';
																																					} ?>" <?php echo $str_prop;
																																																																						echo " " . $strProp2;
																																																																						echo " " . $strProp3;
																																																																						echo " " . $strProp4; ?>></td>
							<td><input type="text" class="form-control" id="<?php echo "txtMinMov" . $i ?>" name="<?php echo "txtMinMov" . $i ?>" size="7" value="<?php if ($reg_fad['pfd22_min'] == '') {
																																									echo "";
																																									$str_prop = '';
																																								} else {
																																									echo $reg_fad['pfd22_min'];
																																									$str_prop = 'disabled';
																																								} ?>" <?php echo $str_prop;
																																																																							echo " " . $strProp2;
																																																																							echo " " . $strProp3;
																																																																							echo " " . $strProp4; ?> placeholder="Mov"></td>
							<td><input type="text" class="form-control" id="<?php echo "txtReposo" . $i ?>" name="<?php echo "txtReposo" . $i ?>" size="7" value="<?php if ($reg_fad['pfd22_reposo'] == '') {
																																									echo "";
																																									$str_prop = '';
																																								} else {
																																									echo $reg_fad['pfd22_reposo'];
																																									$str_prop = 'disabled';
																																								} ?>" <?php echo $str_prop;
																																																																									echo " " . $strProp2;
																																																																									echo " " . $strProp3;
																																																																									echo " " . $strProp4; ?> placeholder="Reposo"></td>
							<td><input type="text" class="form-control" id="<?php echo "txtPh2" . $i ?>" name="<?php echo "txtPh2" . $i ?>" size="7" value="<?php if ($reg_fad['pfd22_ph'] == '') {
																																							echo "";
																																							$str_prop = '';
																																						} else {
																																							echo $reg_fad['pfd22_ph'];
																																							$str_prop = 'disabled';
																																						} ?>" <?php echo $str_prop;
																																																																					echo " " . $strProp2;
																																																																					echo " " . $strProp3;
																																																																					echo " " . $strProp4; ?> placeholder="pH"></td>
							<td><input type="text" class="form-control" id="<?php echo "txtTemp2" . $i ?>" name="<?php echo "txtTemp2" . $i ?>" size="7" value="<?php if ($reg_fad['pfd22_temp'] == '') {
																																								echo "";
																																								$str_prop = '';
																																							} else {
																																								echo $reg_fad['pfd22_temp'];
																																								$str_prop = 'disabled';
																																							} ?>" <?php echo $str_prop;
																																																																							echo " " . $strProp2;
																																																																							echo " " . $strProp3;
																																																																							echo " " . $strProp4; ?> placeholder="Temp"></td>
							<td><input type="text" class="form-control" id="<?php echo "txtSosaT" . $i ?>" name="<?php echo "txtSosaT" . $i ?>" value="<?php if ($reg_fad['pfd22_sosa'] == '') {
																																						echo "";
																																						$str_prop = '';
																																					} else {
																																						echo $reg_fad['pfd22_sosa'];
																																						$str_prop = 'disabled';
																																					} ?>" <?php echo $str_prop;
																																																																					echo " " . $strProp2;
																																																																					echo " " . $strProp3;
																																																																					echo " " . $strProp4; ?> size="5" placeholder="Sosa"></td>
							<td><input type="text" class="form-control" id="txtAcidoT<?php echo $i; ?>" name="txtAcidoT<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd22_acido'] == '') {
																																								echo "";
																																								$str_prop = '';
																																							} else {
																																								echo $reg_fad['pfd22_acido'];
																																								$str_prop = 'disabled';
																																							} ?>" <?php echo $str_prop;
																																																																							echo " " . $strProp2;
																																																																							echo " " . $strProp3;
		...
		<div class="row">
			...
			<div class="form-row">
				<div class="form-group col-md-2">
					...
					<input type="text" class="form-control" id="txtHrasTot" name="txtHrasTot" placeholder="" value="<?php if ($reg_fa['pfg2_hr_totales'] == '') {
																														echo "";
																														$str_prop = '';
																													} else {
		...
		<div class="row footerdivProcesos" style="margin-bottom: 10px">
			...
			<div class="form-group col-md-4">
				<div class="alert alert-info hide" id="alerta-errorFase2bOpe" style="height: 40px;width: 300px;text-align: left;z-index: 10;font-size: 10px;">
