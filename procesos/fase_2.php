...
<div class="divProcesos">
	<form id="formFase2" name="formFase2">
		...
		<div class="row" style="margin-bottom: 10px">
			...
			<div class="col-md-2 tiempos">
				<input type="text" class="form-control" id="txtTempB" placeholder="TEMP" name="txtTempB" onKeyPress="return isNumberKeyFloat(event, this);" value="<?php if ($reg_fa['pfg2_temp_ag'] == '') {
																																										echo "";
																																										$str_prop = '';
																																									} else {
		...
		<div class="row" style="margin-bottom: 30px">
			...
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPhAnt" placeholder="PH" name="txtPhAnt" onKeyPress="return isNumberKeyFloat(event, this);" value="<?php if ($reg_fa['pfg2_ph_ant'] == '') {
																																										echo "";
																																										$str_prop = '';
																																									} else {
			...
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtCe" placeholder="CE" name="txtCe" onKeyPress="return isNumberKeyFloat(event, this);" value="<?php if ($reg_fa['pfg2_ce'] == '') {
																																								echo "";
																																								$str_prop = '';
																																							} else {
																																								echo $reg_fa['pfg2_ce'];
			...
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtAjSosa" placeholder="SOSA" onKeyPress="return isNumberKeyFloat(event, this);" name="txtAjSosa" value="<?php if ($reg_fa['pfg2_sosa'] == '') {
																																											echo "";
																																											$str_prop = '';
																																										} else {
																																											echo $reg_fa['pfg2_temp_ag'];
			...
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPhAj" placeholder="PH" name="txtPhAj" onKeyPress="return isNumberKeyFloat(event, this);" value="<?php if ($reg_fa['pfg2_ph_aju'] == '') {
																																									echo "";
																																									$str_prop = '';
																																								} else {
			...
			<div class="col-md-1">
				<input type="text" class="form-control" id="txtPeroxido" placeholder="PEROXIDO" name="txtPeroxido" onKeyPress="return isNumberKeyFloat(event, this);" value="<?php if ($reg_fa['pfg2_peroxido'] == '') {
																																													echo "";
																																													$str_prop = '';
																																												} else {
									...
									<tr>
										...
										<td><input type="time" class="form-control" id="txtHr<?php echo $i; ?>" placeholder="" name="txtHr<?php echo $i; ?>" value="<?php if ($reg_fad['pfd2_hr'] == '') {
																																										...
																																										$str_prop = 'disabled';
																																											...
																																											echo " " . $strProp3;
																																											echo " " . $strProp4; ?>></td>
										<td><input type="text" class="form-control" id="txtPh<?php echo $i; ?>" placeholder="Ph" name="txtPh<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_ph'] == '') {
																																													echo "";
																																													$str_prop = '';
																																												} else {
										...
										<td><input type="text" class="form-control" id="txtSosa<?php echo $i; ?>" placeholder="Sosa" name="txtSosa<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_sosa'] == '') {
																																															echo "";
																																															$str_prop = '';
																																														} else {
																																															...
																																															$str_prop = 'disabled';
																																																...
																																																echo " " . $strProp3;
																																																echo " " . $strProp4; ?>></td>
										<td><input type="text" class="form-control" id="txtPeroxido<?php echo $i; ?>" placeholder="Peroxido" name="txtPeroxido<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_peroxido'] == '') {
																																																		echo "";
																																																		$str_prop = '';
																																																	} else {
																																																		...
																																																		$str_prop = 'disabled';
																																																			...
																																																			echo " " . $strProp3;
																																																			echo " " . $strProp4; ?>></td>
										<td><input type="text" class="form-control" id="txtTemp<?php echo $i; ?>" placeholder="Temp" name="txtTemp<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_temp'] == '') {
																																															echo "";
																																															$str_prop = '';
																																														} else {
																																															...
																																															$str_prop = 'disabled';
																																																...
																																																echo " " . $strProp3;
																																																echo " " . $strProp4; ?>></td>
										<td align="center" bgcolor="#FF6493" width="100"><input type="text" class="form-control" id="txtRedox<?php echo $i; ?>" placeholder="Redox" name="txtRedox<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_redox'] == '') {
																																																											echo "";
																																																											$str_prop = '';
																																																										} else {
																																																											...
																																																											$str_prop = 'disabled';
																																																												...
																																																												echo " " . $strProp3;
																																																												echo " " . $strProp4; ?>></td>
										<!--<td><input type="text" class="form-control" id="txtAcidoX<?php echo $i; ?>" placeholder="Acido" name="txtAcidoX<?php echo $i; ?>" size="5" value="<?php if ($reg_fad['pfd2_acido'] == '') {
																																																	echo "";
																																																	$str_prop = '';
																																																} else {
...
--><?php //}
	?>
		...
		<div class="row footerdivProcesos" style="margin-bottom: 10px">
			...
			<div class="col-md-6" style="text-align: right;margin-left:  -40px">
