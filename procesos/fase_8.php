...
<script language="javascript">
			...
			if(intban == 0)
			{
				...
				$.ajax({
					...
					success: function(result) {
						...
						$('#formFase8').each (function(){this.reset();}); 
	...
	function AbreModalPaletoB(proceso, lavador){
		...
		$.ajax({
			...
			//data: {nombre:n},
			success: function(result){
				$("#modalPaleto8").html(result);
				$('#modalPaleto8').modal('show')
			}	
		});
		return false;
	}
...
<div class="divProcesos">
	<form id="formFase8" name="formFase8">
		...
		<table border="0" cellspacing="5" cellpadding="5">
			<tr class="etiqueta_tbl">
				<td width="15">&nbsp;</td>
				<td></td>
				<td width="100"><span style="color: red;font-weight: bold;"> * </span> Tipo agua</td>
				...
				<td>Agua a</td>
				<td>Observaciones</td>
				<td rowspan="5">Para hacer los lavados finales deben de tardar de (6 a 19 hrs)</td>
			</tr>
			<?php 
			for($i = 1; $i <=10; $i++){
				...
				if($i <= 4 or $bolVal == 'Si' ){
					...
					<tr>
						...
						<td><?php echo $i; ?><input type="hidden" class="form-control" id="<?php echo "txtRen".$i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen".$i ?>">
							...
							<td><select id="cbxTipAg<?php echo $i  ?>" class="form-control" style="width: 150px" name="cbxTipAg<?php echo $i  ?>" <?php if($reg_fad['tpa_id'] == ''){echo ""; $str_prop = '';}else{ $str_prop = 'disabled';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>>
							...
							<td align="center">
								<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 150px" name="cbxAgua<?php echo $i  ?>" <?php if($reg_fad['taa_id'] == ''){echo ""; $str_prop = '';}else{ $str_prop = 'disabled';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3." ".$strProp4; ?> >
									<option value="">Seleccionar</option>
									<?php 
...
<!--	<div class="row">
		...
		<label style="width: 110px;text-align: justify;" for="inputPassword3">Para hacer los lavados finales deben de tardar de (6 a 19 hrs)</label>  	
	</div>
-->
...
<div class="col-md-8">
	...
	<div class="col-md-12">
		<label style="font-weight:bold;margin-top: 20px">El agua de este proceso se manda a (Pila 1) agua recuperada limpia</label>
	</div>	
	...
	<div class="col-md-12">
		<div class="col-md-2 tiempos" style="margin-left: -10px;width: 220px">
			...
			<input type="date" class="form-control" id="txtFeLibProd" name="txtFeLibProd" placeholder="" value="<?php if($reg_fa['pfg8_fe_lib_prod'] == ''){echo date("Y-m-d"); $str_prop = '';$str_estilo = "style='background-color:#FFFF99;'";}else{echo $reg_fa['pfg8_fe_lib_prod']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp3;  echo " ".$str_estilo;?>>
		</div>
		<div class="col-md-2 tiempos" style="margin-left: 20px;">
			<label>Hora</label>
	...
	<div class="col-md-12 textareaObservaciones" style="margin-top: 20px">
...
<div class="col-md-4 divEtapas7_mod">
	...
	<div class="col-md-12 divEtapasInput7_mod" >
		<label class="etiquetaEtapa_mod">COCIDO LIBERACIÓN ( PH <?php echo fnc_rango_de(20) ?> - <?php echo fnc_rango_a(20) ?>)</label>
	...
	<div class="row footerdivProcesos"  style="margin-bottom: 10px;">
		...
		<div class="form-group col-md-7">
			<div class="alert alert-info hide" id="alerta-errorFase8Ope" style="height: 40px;width: 420px;text-align: left;z-index: 10;font-size: 10px;margin-bottom: -10px">
