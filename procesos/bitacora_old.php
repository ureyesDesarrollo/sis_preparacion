...
if($_SESSION['privilegio'] == 4 and  $id_super == 0 ){ include "encabezado_1.php"; }else if($_SESSION['privilegio'] == 4){include "formatos/encabezado.php";}//Supervisor

if($_SESSION['privilegio'] == 3 and ($id_oper == 0 or $id_oper == '')){ include "encabezado_2.php"; }else if($_SESSION['privilegio'] == 3){include "formatos/encabezado.php";} //Operador

if($_SESSION['privilegio'] == 6){include "formatos/encabezado.php";} //Laboratorio
