...
$cad_pro = mysqli_query($cnx, "SELECT p.pro_id  
	...
	//echo "SELECT * FROM procesos_fase_8_g WHERE pro_id = '$reg_pro[pro_id]' and pe_id = 26 <br>";
			...
			if(intban == 0)
			{
				...
				$.ajax({
					...
					success: function(result) {
						...
						$('#formFase8c').each (function(){this.reset();}); 
...
<div class="divProcesos">
	<form id="formFase8c" name="formFase8c">
		...
		<table border="0" cellspacing="5" cellpadding="5">
			...
			<?php 
			for($i = 1; $i <=10; $i++){
				//echo "SELECT * FROM procesos_fase_8_d WHERE pfg8_id = '$reg_fa[pfg8_id]' and pfd8_ren = '$i' <br>";
				...
				if($i <= 4 or $bolVal == 'Si' ){
					...
					<tr>
						...
						<td><?php echo $i; ?><input type="hidden" class="form-control" id="<?php echo "txtRen".$i ?>" value="<?php echo $i ?>" name="<?php echo "txtRen".$i ?>">
							<input type="hidden" class="form-control" id="<?php echo "hddRen".$i ?>" name="<?php echo "hddRen".$i ?>" value="<?php echo $reg_fad['pfd8_id'];?>" /></td>
							<td><select id="cbxTipAg<?php echo $i  ?>" class="form-control" style="width: 140px" name="cbxTipAg<?php echo $i  ?>" <?php if($reg_fad['tpa_id'] == ''){echo ""; $str_prop = '';}else{ $str_prop = 'disabled';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>>
							...
							<td><input type="text" class="form-control" id="<?php echo "txtMov".$i ?>" name="<?php echo "txtMov".$i ?>" size="7" placeholder="Mov" value="<?php if($reg_fad['pfd8_mov'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd8_mov']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>></td>
							<td>MIN</td>
							<td><input type="time" id="txtIniLlen<?php echo $i; ?>" name="txtIniLlen<?php echo $i; ?>" class="form-control" value="<?php if($reg_fad['pfd8_ini_llenado'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd8_ini_llenado']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /> </td>

							<td><input type="time" id="txtFinLlen<?php echo $i; ?>" name="txtFinLlen<?php echo $i; ?>" class="form-control" value="<?php if($reg_fad['pfd8_fin_llenado'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd8_fin_llenado']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>/></td>
							<td><input type="time" id="txtIniDren<?php echo $i; ?>" name="txtIniDren<?php echo $i; ?>" class="form-control" value="<?php if($reg_fad['pfd8_ini_dren'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd8_ini_dren']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /> </td>
							<td><input type="time" id="txtFinDren<?php echo $i; ?>" name="txtFinDren<?php echo $i; ?>" class="form-control" value="<?php if($reg_fad['pfd8_fin_dren'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd8_fin_dren']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?>/></td>
							<td><input type="text" name="txtPh<?php echo $i; ?>" id="txtPh<?php echo $i; ?>" class="form-control" placeholder="PH"  value="<?php if($reg_fad['pfd8_ph'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd8_ph']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /> </td>
							<td><input type="text" name="txtCe<?php echo $i; ?>" id="txtCe<?php echo $i; ?>" class="form-control" placeholder="CE" value="<?php if($reg_fad['pfd8_ce'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd8_ce']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /></td>
							<td><input type="text" name="txtTemp<?php echo $i; ?>" id="txtTemp<?php echo $i; ?>" class="form-control" placeholder="TEMP" value="<?php if($reg_fad['pfd8_temp'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd8_temp']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3; echo " ".$strProp4; ?> /></td>
							<td align="center">
								<select id="cbxAgua<?php echo $i  ?>" class="form-control" style="width: 140px" name="cbxAgua<?php echo $i  ?>" <?php if($reg_fad['taa_id'] == ''){echo ""; $str_prop = '';}else{ $str_prop = 'disabled';} echo $str_prop; echo " ".$strProp2; echo " ".$strProp3." ".$strProp4; ?> >
									<option value="">Seleccionar</option>
									<?php 
							...
							<td><input type="text" class="form-control" id="<?php echo "txtObs".$i ?>" name="<?php echo "txtObs".$i ?>" value="<?php if($reg_fad['pfd8_observaciones'] == ''){echo ""; $str_prop = '';}else{echo $reg_fad['pfd8_observaciones']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp2; echo " ".$strProp3;  echo " ".$strProp4;?> size="5" placeholder="Observaciones"></td>
						</tr>
						<?php 
						$valUltRen = $i;
  }//termina if
...
<?php /*	<div class="row">
		...
		<div class="col-md-8">
			...
			<div class="col-md-2">
				...
				<input  type="text" id="txtHrTotales1" class="form-control" placeholder="Horas totales" name="txtHrTotales1" value="<?php if($reg_fa['pfg8_hr_totales'] == ''){ echo ""; $str_prop = '';$str_estilo = "style='background-color:#FFFF99;'";}else{echo $reg_fa['pfg8_hr_totales']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp3; echo " ".$str_estilo;?>>
			</div>
			<div class="col-md-2">
				<label>Realizó</label>
			...
			<div class="col-md-11" style="border: 1px solid#e6e6e6;border-radius: 5px;background: #e6e6e6;margin-left: 20px;margin-top: 10px;margin-bottom: 10px">
				<div class="col-md-5 tiempos" style="margin-left: -25px;">
					...
					<input  type="text" id="txtHrasTotales" class="form-control" placeholder="Horas totales" name="txtHrasTotales" value="<?php if($reg_fa['pfg8_hr_totales2'] == ''){ echo fnc_horas($strFech, date("Y-m-d"), $strHr, date("H:i"));; $str_prop = '';$str_estilo = "style='background-color:#FFFF99;'";}else{echo $reg_fa['pfg8_hr_totales2']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp3;echo " ".$str_estilo;?>>
				</div>
	...
	<div class="col-md-12">
		<div class="col-md-2 tiempos" style="margin-left: -10px;width: 220px">
			...
			<input type="date" class="form-control" id="txtFeLibProd" name="txtFeLibProd" placeholder="" value="<?php if($reg_fa['pfg8_fe_lib_prod'] == ''){echo date("Y-m-d"); $str_prop = '';$str_estilo = "style='background-color:#FFFF99;'";}else{echo $reg_fa['pfg8_fe_lib_prod']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp3; echo " ".$str_estilo;?>><?php //echo "x".$reg_fa['pfg8_fe_lib_prod']; ?>
		</div>
		<div class="col-md-2 tiempos" style="margin-left: 20px;">
			<label>Hora</label>
			<input type="time" class="form-control" id="txtHrLibProd" name="txtHrLibProd" placeholder="" value="<?php if($reg_fa['pfg8_hr_lib_prod'] == ''){echo date("H:i"); $str_prop = '';$str_estilo = "style='background-color:#FFFF99;'";}else{echo $reg_fa['pfg8_hr_lib_prod']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp3; echo " ".$str_estilo;?> />
		</div>
	</div>
	<!---->
...
<div class="col-md-4 divEtapas7_mod">
	...
	<div class="col-md-12 divEtapasInput7_mod" >
		...
		for($i = 1; $i <=5; $i++){ ?>
			...
			<input onkeypress="return isNumberKey(event, this);" type="tex" class="form-control col-md-1" style="width: 100px" id="<?php echo "txtPhLibc".$i ?>" name="<?php echo "txtPhLibc".$i ?>" placeholder="(<?php echo "L".$i ?>) Cocido ph"  value="<?php if($reg_lib['prol_cocido_ph1'] == ''){ echo ""; $str_prop = '';}else{echo $reg_lib['prol_cocido_ph1']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?> />
			<input onkeypress="return isNumberKey(event, this);" type="text" class="form-control col-md-1" style="width: 55px" id="<?php echo "txtCeLibc".$i ?>" name="<?php echo "txtCeLibc".$i ?>" placeholder="Ce"  value="<?php if($reg_lib['prol_ce1'] == ''){ echo ""; $str_prop = '';}else{echo $reg_lib['prol_ce1']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?>>
			<input onkeypress="return isNumberKey(event, this);" type="text" class="form-control col-md-1" style="width: 75px" id="<?php echo "txtCue_sobc".$i ?>" name="<?php echo "txtCue_sobc".$i ?>" placeholder="Cuero sob"  value="<?php if($reg_lib['prol_cu1'] == ''){ echo ""; $str_prop = '';}else{echo $reg_lib['prol_cu1']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?>>
			<input onkeypress="return isNumberKey(event, this);" type="text" class="form-control col-md-1" style="width: 50px" id="<?php echo "txtpor_extc".$i ?>" name="<?php echo "txtpor_extc".$i ?>" placeholder="% ext"  value="<?php if($reg_lib['prol_ext1'] == ''){ echo ""; $str_prop = '';}else{echo $reg_lib['prol_ext1']; $str_prop = 'disabled';} ?>" <?php echo $str_prop; echo " ".$strProp1; echo " ".$strProp2;?>>
...
<div class="row footerdivProcesos" style="margin-bottom: 10px;">
	...
	<div class="form-group col-md-7">
		<div class="alert alert-info hide" id="alerta-errorFase8cOpe" style="height: 40px;width: 420px;text-align: left;z-index: 10;font-size: 10px; margin-bottom: -10px">
