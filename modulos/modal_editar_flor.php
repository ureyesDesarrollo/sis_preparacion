    ...
    <div class="modal-content">
        <form name="formE" id="formE">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="color:#4AB5B9; font-size:18px; font-weight:bold;">Recibir inventario extranjero con flor</h5>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <select class="form-control" name="cbxProveedor" id="cbxProveedor" require>
                            ...
                            $cad_maquila = mysqli_query($cnx, "SELECT * FROM proveedores order by prv_nombre asc");
                    ...
                    <div class="col-md-3">
                        ...
                        <input onchange="" onkeyup="fnc_calculaTotalEM();" name="txtKgEntradaMaq" type="text" class="form-control" id="txtKgEntradaMaq" placeholder="KG entrada maquila" required>
                    </div>
