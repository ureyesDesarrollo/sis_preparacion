...
<?php
do {
    $cad_material = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
 ...
 $total_inv_ext = 0;
                ...
                ?>
                        <tr style="<?php echo $color . ''; ?>">
                            ...
                            <td><?php echo $reg_material['prv_nombre'] ?></td>
...
/*echo "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
FROM inventario as i
INNER JOIN proveedores AS p ON (i.prv_id = p.prv_id)
INNER JOIN materiales AS m ON (i.mat_id = m.mat_id)
WHERE  $inv_fe_recibe and i.inv_enviado = 2 AND p.prv_ban = '0'";*/
...
$cadena_ext_bodega = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
 FROM inventario as i
 INNER JOIN proveedores AS p ON (i.prv_id = p.prv_id)
 INNER JOIN materiales AS m ON (i.mat_id = m.mat_id)
    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $reg_ext_bodega['prv_nombre'] ?></td>
...
$cad_ext_maquila = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
FROM inventario as i
INNER JOIN proveedores AS p ON (i.prv_id = p.prv_id)
INNER JOIN materiales AS m ON (i.mat_id = m.mat_id)
    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $reg_ext_maquila['prv_nombre'] ?></td>
