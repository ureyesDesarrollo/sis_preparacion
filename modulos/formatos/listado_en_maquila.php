...
$cadena = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_ncorto,p.prv_tipo, m.mat_nombre
 ...
 WHERE p.prv_tipo = 'E' and inv_enviado = 1") or die(mysqli_error($cnx) . "Error: en consultar el inventario 1");
        ...
        <table style="border: 1px solid #fff">
          <tr style="border: 1px solid #fff">
            ...
            <td style="border: 1px solid #fff">
              <h1>Inventario en maquila al día <?php echo fnc_formato_fecha(date("Y-m-d")); ?></h1>
            </td>
          </tr>
          <tr></tr>
        </table>
