...
$cadena = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre,p.prv_ncorto
	...
	WHERE inv_no_factura is not null and inv_enviado = 0 and p.prv_tipo = 'E'  ORDER BY prv_tipo") or die(mysqli_error($cnx) . "Error: en consultar el inventario");
	...
	<div class="col-sm-12 col-md-4 ">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Historial Inventario Extranjero</li>
			</ol>
		</nav>
	</div>

	<div class="col-sm-12 col-md-8" style="text-align:right">
		<a class="iconos" href="formatos/listado_historial_extranjero.php" target="_blank"><i class="fa-solid fa-print fa-2xl"></i>
			Imprimir</a>
		<a class="iconos" href="exportar/historial_extranjero.php" target="_blank"><i class="fa-solid fa-file-excel fa-2xl"></i>
			Exp.excel</a>
	</div>
</div>
...
<div class="container" style="border: 1px solid #cccccc; padding: 0px;border-radius: 10px;padding-top: 10px;margin-bottom: 50px;width: 100%">
	<table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_inventarioH">
		<thead>
			<tr align="center">
