...
$cad_carnaza = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
 ...
 WHERE inv_fecha = '$fechaIni' AND prv_tipo = 'L' AND mt_id IN(1,6,9) ") or die(mysql_error()."Error: en consultar el inventario 2");
...
$cad_cerdo = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
 ...
 INNER JOIN proveedores AS p ON (i.prv_id = p.prv_id)
 INNER JOIN materiales AS m ON (i.mat_id = m.mat_id)
 WHERE inv_fecha = '$fechaIni' AND prv_tipo = 'L' AND mt_id = '2'") or die(mysql_error()."Error: en consultar el inventario 2");
...
$cad_dep_maq = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
 ...
 INNER JOIN proveedores AS p ON (i.prv_id = p.prv_id)
 INNER JOIN materiales AS m ON (i.mat_id = m.mat_id)
 WHERE substring(inv_fe_recibe,1,10) = '$fechaIni' and i.inv_enviado = 2 AND p.prv_ban = '0'" ) or die(mysql_error()."Error: en consultar el inventario 2");
...
$cad_dep_loc = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
 ...
 INNER JOIN proveedores AS p ON (i.prv_id = p.prv_id)
 INNER JOIN materiales AS m ON (i.mat_id = m.mat_id)
 WHERE substring(inv_fe_recibe,1,10) = '$fechaIni' and i.inv_enviado = 2 AND p.prv_ban = '1'") or die(mysql_error()."Error: en consultar el inventario 2");
...
$cadena = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
 ...
 INNER JOIN proveedores AS p ON (i.prv_id = p.prv_id)
 INNER JOIN materiales AS m ON (i.mat_id = m.mat_id)
 WHERE inv_fecha = '$fechaIni' AND prv_tipo = 'E' AND inv_id_key is NULL") or die(mysql_error()."Error: en consultar el inventario 1");
...
$cad_di_maq = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre
 ...
 INNER JOIN proveedores AS p ON (i.prv_id = p.prv_id)
 INNER JOIN materiales AS m ON (i.mat_id = m.mat_id)
 WHERE inv_fecha = '$fechaIni' AND prv_tipo = 'L' AND prv_ban = '1' ") or die(mysql_error()."Error: en consultar el inventario 1");
...
$inv_obj = mysqli_query($cnx, "SELECT mto_kilos as res
      ...
      //Obtiene el objetivo por tipo de material por semana
