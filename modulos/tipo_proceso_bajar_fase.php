...
$respuesta = array('mensaje' => "Fase Bajada");
...
mysqli_query($cnx, "UPDATE preparacion_tipo_etapas SET pte_orden = '$ord_aba' where pte_id = '$reg2[pte_id]' ");

//Modifica el orden del orden seleccioado
mysqli_query($cnx, "UPDATE preparacion_tipo_etapas SET pte_orden = '$ord_arr' where pte_id = '$reg1[pte_id]'");	
