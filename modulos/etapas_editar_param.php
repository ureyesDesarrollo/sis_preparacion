...
$cadena = mysqli_query($cnx, "SELECT *
             ...
             WHERE pep_id = '".$_POST['hdd_id']."'") or die(mysql_error()."Error: en consultar las etapas");
...
{
  $("#formEtapasEditarP").submit(function(){
    //alert('editar');
    var formData = $(this).serialize();
    $.ajax({
      url: "etapas_actualizar_param.php",
      type: 'POST',
      data: formData,
...
<div class="modal-dialog modal-lg" role="document" style="height: 200px">
    <div class="modal-content">
      <form id="formEtapasEditarP"> 
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="color:#4AB5B9; font-size:18px; font-weight:bold;">Editar Etapa otros parametros</h5>
      ...
      <div class="modal-body">  
          ...
          <div class="col-md-4">
            ...
            <input name="txtEtapaDesc" type="text" class="form-control" id="txtEtapaDesc" disabled placeholder="" value="<?php echo $registros['pep_descripcion'] ?>">
		   ...
		   <div class="col-md-4">
            ...
            <input name="txtNombre" type="text" class="form-control" id="txtNombre" required placeholder="" value="<?php echo $registros['pep_nombre'] ?>">
		...
		<div class="row">
            ...
            <select name="cbxTipo" class="form-control" id="cbxTipo" disabled>
					 <?php 
			/*if ($registros['pep_tipo'] == 'C') 
			{
				$var_est = "Ce";
			  }
		  
		  if ($registros['pep_tipo'] == 'H') 
			{
				$var_est = "Hr";
			  }
		  if ($registros['pep_tipo'] == 'P') 
			{
				$var_est = "Ph";
			  }*/
		   ?>
              <option value="<?php echo $registros['pep_tipo']; ?>"><?php echo mb_convert_encoding($registros['pep_tipo'], "UTF-8");?></option>
		  ...
		  <div class="col-md-2">
            ...
            <input name="txtInicio" type="text" class="form-control" id="txtInicio" placeholder="Inicio" value="<?php echo $registros['pep_inicio'] ?>"onkeypress="return isNumberKey(event, this);"  required>
          </div>
		  
		  <div class="col-md-2">
            <label for="recipient-name" class="col-form-label"><span style="color:#FF0000; font-weight:bold;">*</span> Rango Fin:</label>
            <input name="txtFin" type="text" class="form-control" id="txtFin" placeholder="Fin" value="<?php echo $registros['pep_fin'] ?>" onkeypress="return isNumberKey(event, this);" required>
          </div>
		</div>
		...
		<div class="row">
			<div class="col-md-3">
				...
				<?php 
					if ($registros['pep_control_lib'] == '1') 
					{
						$var_lib = "Si";
					}
					else
			   ...
			   ?>
					<option value="<?php echo $registros['pep_control_lib']; ?>" selected><?php echo mb_convert_encoding($var_lib, "UTF-8");?></option>
			...
			<div class="col-md-2">
				...
				<?php 
					if ($registros['pep_control_renglon'] == '1') 
					{
						$var_lib = "Si";
					}
					else
			   ...
			   ?>
					<option value="<?php echo $registros['pep_control_renglon']; ?>" selected><?php echo mb_convert_encoding($var_lib, "UTF-8");?></option>
					<option value="1">Si</option>
					<option value="0">No</option>
				</select>
            </div>
			<div class="col-md-3">
				...
				<?php 
					if ($registros['pep_control_material'] == '1') 
					{
						$var_lib = "Si";
					}
					else
			   ...
			   ?>
					<option value="<?php echo $registros['pep_control_material']; ?>" selected><?php echo mb_convert_encoding($var_lib, "UTF-8");?></option>
					<option value="1">Si</option>
					<option value="0">No</option>
				</select>
            </div>
			<div class="col-md-2">
				...
				<?php 
					if ($registros['pep_enviar_email'] == '1') 
					{
						$var_email = "Si";
					}
					else
			   ...
			   ?>
					<option value="<?php echo $registros['pep_enviar_email']; ?>" selected><?php echo mb_convert_encoding($var_email, "UTF-8");?></option>
					<option value="1">Si</option>
					<option value="0">No</option>
				</select>
            </div>
