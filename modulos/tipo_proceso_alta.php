  ...
  <div class="modal-dialog modal-lg" role="document" style="height: 200px">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="color:#4AB5B9; font-size:18px; font-weight:bold;">Alta tipo proceso </h5>
      ...
      <div class="modal-body">
          ...
          <div class="col-md-3">
            ...
            <input name="txtRevision" type="text" class="form-control" id="txtRevision" maxlength="20" required placeholder="Revision">
          </div>
		  <div class="col-md-3">
