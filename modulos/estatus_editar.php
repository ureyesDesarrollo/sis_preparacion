...
$cadena = mysqli_query($cnx, "SELECT p.*, l.le_estatus
             ...
             WHERE p.pl_id = '".$_POST['hdd_id']."'") or die(mysql_error()."Error: en consultar las etapas");
...
<div class="modal-dialog modal-lg" role="document" style="height: 200px">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="color:#4AB5B9; font-size:18px; font-weight:bold;">Editar Estatus Lavador</h5>
      ...
      <div class="modal-body"> 
          ...
          <div class="col-md-4">
           ...
           <select name="cbxEstatus" class="form-control is-valid" id="cbxEstatus" placeholder="" required>
             ...
             <?php 
             $cad_est = mysqli_query($cnx,"select * from listado_estatus WHERE le_aplica = 'L' order by le_estatus asc");
