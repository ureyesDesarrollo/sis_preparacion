...
$cadenaT = mysqli_query($cnx, "SELECT i.*, p.prv_nombre,p.prv_tipo, m.mat_nombre,prv_recibe,p.prv_ncorto
						 ...
						 WHERE inv_no_factura is not null and (inv_enviado = 1 or inv_enviado = 5 or inv_enviado = 6) and inv_tomado = 0  and p.prv_ban = 0 ORDER BY prv_tipo") or die(mysqli_error($cnx) . "Error: en consultar el inventario");
